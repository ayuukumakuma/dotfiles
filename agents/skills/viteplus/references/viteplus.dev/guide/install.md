---
title: "Installing Dependencies | The Unified Toolchain for the Web"
source_url: "https://viteplus.dev/guide/install"
fetched_at: "2026-03-31T02:50:28.336963+00:00"
---



# Installing Dependencies [​](https://viteplus.dev/guide/install.html#installing-dependencies)

`vp install` installs dependencies using the current workspace's package manager.

## Overview [​](https://viteplus.dev/guide/install.html#overview)
...
## Usage [​](https://viteplus.dev/guide/install.html#usage)
...
## Global Packages [​](https://viteplus.dev/guide/install.html#global-packages)
...
## Managing Dependencies [​](https://viteplus.dev/guide/install.html#managing-dependencies)
...
### Command Guide [​](https://viteplus.dev/guide/install.html#command-guide)

#### Install [​](https://viteplus.dev/guide/install.html#install)
...
#### Global Install [​](https://viteplus.dev/guide/install.html#global-install)
...
#### Add and Remove [​](https://viteplus.dev/guide/install.html#add-and-remove)
...
#### Update, Dedupe, and Outdated [​](https://viteplus.dev/guide/install.html#update-dedupe-and-outdated)
...
#### Inspect [​](https://viteplus.dev/guide/install.html#inspect)
...
#### Advanced [​](https://viteplus.dev/guide/install.html#advanced)
