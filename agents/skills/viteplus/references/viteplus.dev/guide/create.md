---
title: "Creating a Project | The Unified Toolchain for the Web"
source_url: "https://viteplus.dev/guide/create"
fetched_at: "2026-03-31T02:50:28.336963+00:00"
---



# Creating a Project [​](https://viteplus.dev/guide/create.html#creating-a-project)

`vp create` interactively scaffolds new Vite+ projects, monorepos, and apps inside existing workspaces.

## Overview [​](https://viteplus.dev/guide/create.html#overview)
...
## Usage [​](https://viteplus.dev/guide/create.html#usage)
...
## Built-in Templates [​](https://viteplus.dev/guide/create.html#built-in-templates)
...
## Template Sources [​](https://viteplus.dev/guide/create.html#template-sources)
...
## Options [​](https://viteplus.dev/guide/create.html#options)
...
## Template Options [​](https://viteplus.dev/guide/create.html#template-options)
...
## Examples [​](https://viteplus.dev/guide/create.html#examples)
