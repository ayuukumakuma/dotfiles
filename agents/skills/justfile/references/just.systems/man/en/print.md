...
source_url: "https://just.systems/man/en/print"
...
## [Installation](https://just.systems/man/en/print.html#installation)

### [Prerequisites](https://just.systems/man/en/print.html#prerequisites)

`just` should run on any system with a reasonable `sh`, including Linux, MacOS,
and the BSDs.

#### [Windows](https://just.systems/man/en/print.html#windows)
...
### [Packages](https://just.systems/man/en/print.html#packages)

#### [Cross-platform](https://just.systems/man/en/print.html#cross-platform)
...
#### [BSD](https://just.systems/man/en/print.html#bsd)
...
#### [Linux](https://just.systems/man/en/print.html#linux)
...
#### [Windows](https://just.systems/man/en/print.html#windows-1)
...
#### [macOS](https://just.systems/man/en/print.html#macos)
...
### [Pre-Built Binaries](https://just.systems/man/en/print.html#pre-built-binaries)
...
### [GitHub Actions](https://just.systems/man/en/print.html#github-actions)
...
### [Docker](https://just.systems/man/en/print.html#docker)
...
### [Release RSS Feed](https://just.systems/man/en/print.html#release-rss-feed)

An [RSS feed](https://en.wikipedia.org/wiki/RSS) of `just` releases is available [here](https://github.com/casey/just/releases.atom).

### [Node.js Installation](https://just.systems/man/en/print.html#nodejs-installation)
...
## [Backwards Compatibility](https://just.systems/man/en/print.html#backwards-compatibility)
...
## [Editor Support](https://just.systems/man/en/print.html#editor-support)

`justfile` syntax is close enough to `make` that you may want to tell your
editor to use `make` syntax highlighting for `just`.

### [Vim and Neovim](https://just.systems/man/en/print.html#vim-and-neovim)
...
#### [`vim-just`](https://just.systems/man/en/print.html#vim-just)
...
#### [`tree-sitter-just`](https://just.systems/man/en/print.html#tree-sitter-just)

[tree-sitter-just](https://github.com/IndianBoy42/tree-sitter-just) is an
[Nvim Treesitter](https://github.com/nvim-treesitter/nvim-treesitter) plugin
for Neovim.

#### [Makefile Syntax Highlighting](https://just.systems/man/en/print.html#makefile-syntax-highlighting)
...
### [Emacs](https://just.systems/man/en/print.html#emacs)
...
### [Visual Studio Code](https://just.systems/man/en/print.html#visual-studio-code)
...
### [JetBrains IDEs](https://just.systems/man/en/print.html#jetbrains-ides)

A plugin for JetBrains IDEs by [linux\_china](https://github.com/linux-china) is
[available here](https://plugins.jetbrains.com/plugin/18658-just).

### [Kakoune](https://just.systems/man/en/print.html#kakoune)

Kakoune supports `justfile` syntax highlighting out of the box, thanks to
TeddyDD.

### [Helix](https://just.systems/man/en/print.html#helix)

[Helix](https://helix-editor.com/) supports `justfile` syntax highlighting
out-of-the-box since version 23.05.

### [Sublime Text](https://just.systems/man/en/print.html#sublime-text)
...
### [Micro](https://just.systems/man/en/print.html#micro)
...
### [Zed](https://just.systems/man/en/print.html#zed)
...
### [Other Editors](https://just.systems/man/en/print.html#other-editors)
...
### [Language Server Protocol](https://just.systems/man/en/print.html#language-server-protocol)
...
### [Model Context Protocol](https://just.systems/man/en/print.html#model-context-protocol)
...
## [Quick Start](https://just.systems/man/en/print.html#quick-start)
...
## [Examples](https://just.systems/man/en/print.html#examples)
...
## [Features](https://just.systems/man/en/print.html#features)

### [The Default Recipe](https://just.systems/man/en/print.html#the-default-recipe)
...
### [Listing Available Recipes](https://just.systems/man/en/print.html#listing-available-recipes)
...
Recipes in [submodules](https://just.systems/man/en/modules.html) can be listed with `just --list PATH`, where
...
### [Invoking Multiple Recipes](https://just.systems/man/en/print.html#invoking-multiple-recipes)
...
### [Working Directory](https://just.systems/man/en/print.html#working-directory)
...
### [Aliases](https://just.systems/man/en/print.html#aliases)
...
### [Settings](https://just.systems/man/en/print.html#settings)
...
#### [Table of Settings](https://just.systems/man/en/print.html#table-of-settings)
...
#### [Allow Duplicate Recipes](https://just.systems/man/en/print.html#allow-duplicate-recipes)
...
#### [Allow Duplicate Variables](https://just.systems/man/en/print.html#allow-duplicate-variables)
...
#### [Dotenv Settings](https://just.systems/man/en/print.html#dotenv-settings)
...
#### [Export](https://just.systems/man/en/print.html#export)
...
#### [Lazy](https://just.systems/man/en/print.html#lazy)
...
#### [Positional Arguments](https://just.systems/man/en/print.html#positional-arguments)
...
#### [Shell](https://just.systems/man/en/print.html#shell)
...
##### [Windows Shell](https://just.systems/man/en/print.html#windows-shell)
...
##### [Windows PowerShell](https://just.systems/man/en/print.html#windows-powershell)
...
##### [Python 3](https://just.systems/man/en/print.html#python-3)

```
set shell := ["python3", "-c"]
```

##### [Bash](https://just.systems/man/en/print.html#bash)

```
set shell := ["bash", "-uc"]
```

##### [Z Shell](https://just.systems/man/en/print.html#z-shell)

```
set shell := ["zsh", "-uc"]
```

##### [Fish](https://just.systems/man/en/print.html#fish)

```
set shell := ["fish", "-c"]
```

##### [Nushell](https://just.systems/man/en/print.html#nushell)
...
### [Documentation Comments](https://just.systems/man/en/print.html#documentation-comments)
...
### [Expressions and Substitutions](https://just.systems/man/en/print.html#expressions-and-substitutions)
...
#### [Concatenation](https://just.systems/man/en/print.html#concatenation)
...
#### [Logical Operators](https://just.systems/man/en/print.html#logical-operators)
...
#### [Joining Paths](https://just.systems/man/en/print.html#joining-paths)
...
#### [Escaping `{{`](https://just.systems/man/en/print.html#escaping-)
...
### [Strings](https://just.systems/man/en/print.html#strings)
...
#### [Shell-expanded strings](https://just.systems/man/en/print.html#shell-expanded-strings)
...
#### [Format strings](https://just.systems/man/en/print.html#format-strings)
...
### [Sigils](https://just.systems/man/en/print.html#sigils)
...
### [Functions](https://just.systems/man/en/print.html#functions)
...
#### [System Information](https://just.systems/man/en/print.html#system-information)
...
#### [External Commands](https://just.systems/man/en/print.html#external-commands)
...
#### [Environment Variables](https://just.systems/man/en/print.html#environment-variables)
...
#### [Executables](https://just.systems/man/en/print.html#executables)
...
#### [Invocation Information](https://just.systems/man/en/print.html#invocation-information)
...
#### [Invocation Directory](https://just.systems/man/en/print.html#invocation-directory)
...
#### [Justfile and Justfile Directory](https://just.systems/man/en/print.html#justfile-and-justfile-directory)
...
#### [Source and Source Directory](https://just.systems/man/en/print.html#source-and-source-directory)
...
#### [Just Executable](https://just.systems/man/en/print.html#just-executable)
...
#### [Just Process ID](https://just.systems/man/en/print.html#just-process-id)
...
#### [String Manipulation](https://just.systems/man/en/print.html#string-manipulation)
...
#### [Case Conversion](https://just.systems/man/en/print.html#case-conversion)
...
#### [Path Manipulation](https://just.systems/man/en/print.html#path-manipulation)

##### [Fallible](https://just.systems/man/en/print.html#fallible)
...
##### [Infallible](https://just.systems/man/en/print.html#infallible)
...
#### [Filesystem Access](https://just.systems/man/en/print.html#filesystem-access)
...
##### [Error Reporting](https://just.systems/man/en/print.html#error-reporting)

* `error(message)` - Abort execution and report error `message` to user.

#### [UUID and Hash Generation](https://just.systems/man/en/print.html#uuid-and-hash-generation)
...
#### [Random](https://just.systems/man/en/print.html#random)
...
#### [Datetime](https://just.systems/man/en/print.html#datetime)
...
#### [Semantic Versions](https://just.systems/man/en/print.html#semantic-versions)
...
#### [Style](https://just.systems/man/en/print.html#style)
...
##### [User Directories](https://just.systems/man/en/print.html#user-directories)

These functions1.23.0 return paths to user-specific directories for
...
### [Constants](https://just.systems/man/en/print.html#constants)
...
### [Attributes](https://just.systems/man/en/print.html#attributes)
...
#### [Enabling and Disabling Recipes](https://just.systems/man/en/print.html#enabling-and-disabling-recipes)
...
#### [Disabling Changing Directory](https://just.systems/man/en/print.html#disabling-changing-directory)
...
#### [Requiring Confirmation for Recipes](https://just.systems/man/en/print.html#requiring-confirmation-for-recipes)
...
#### [Custom Confirmation Prompt](https://just.systems/man/en/print.html#custom-confirmation-prompt)
...
#### [Metadata](https://just.systems/man/en/print.html#metadata)
...
### [Groups](https://just.systems/man/en/print.html#groups)
...
### [Command Evaluation Using Backticks](https://just.systems/man/en/print.html#command-evaluation-using-backticks)
...
### [Conditional Expressions](https://just.systems/man/en/print.html#conditional-expressions)
...
### [Stopping execution with error](https://just.systems/man/en/print.html#stopping-execution-with-error)
...
### [Setting Variables from the Command Line](https://just.systems/man/en/print.html#setting-variables-from-the-command-line)
...
### [Getting and Setting Environment Variables](https://just.systems/man/en/print.html#getting-and-setting-environment-variables)

#### [Exporting `just` Variables](https://just.systems/man/en/print.html#exporting-just-variables)
...
#### [Unexporting Environment Variables](https://just.systems/man/en/print.html#unexporting-environment-variables)
...
#### [Getting Environment Variables from the environment](https://just.systems/man/en/print.html#getting-environment-variables-from-the-environment)
...
#### [Setting `just` Variables from Environment Variables](https://just.systems/man/en/print.html#setting-just-variables-from-environment-variables)
...
### [Recipe Parameters](https://just.systems/man/en/print.html#recipe-parameters)
...
#### [Recipe Flags and Options](https://just.systems/man/en/print.html#recipe-flags-and-options)
...
### [Dependencies](https://just.systems/man/en/print.html#dependencies)
...
#### [Running Recipes at the End of a Recipe](https://just.systems/man/en/print.html#running-recipes-at-the-end-of-a-recipe)
...
#### [Running Recipes in the Middle of a Recipe](https://just.systems/man/en/print.html#running-recipes-in-the-middle-of-a-recipe)
...
### [Shebang Recipes](https://just.systems/man/en/print.html#shebang-recipes)
...
### [Script Recipes](https://just.systems/man/en/print.html#script-recipes)
...
### [Script and Shebang Recipe Temporary Files](https://just.systems/man/en/print.html#script-and-shebang-recipe-temporary-files)
...
### [Python Recipes with `uv`](https://just.systems/man/en/print.html#python-recipes-with-uv)
...
### [Safer Bash Shebang Recipes](https://just.systems/man/en/print.html#safer-bash-shebang-recipes)
...
#### [Shebang Recipe Execution on Windows](https://just.systems/man/en/print.html#shebang-recipe-execution-on-windows)
...
### [Setting Variables in a Recipe](https://just.systems/man/en/print.html#setting-variables-in-a-recipe)
...
### [Sharing Environment Variables Between Recipes](https://just.systems/man/en/print.html#sharing-environment-variables-between-recipes)
...
#### [Using Python Virtual Environments](https://just.systems/man/en/print.html#using-python-virtual-environments)
...
### [Changing the Working Directory in a Recipe](https://just.systems/man/en/print.html#changing-the-working-directory-in-a-recipe)
...
### [Indentation](https://just.systems/man/en/print.html#indentation)
...
### [Multi-Line Constructs](https://just.systems/man/en/print.html#multi-line-constructs)
...
#### [`if` statements](https://just.systems/man/en/print.html#if-statements)
...
#### [`for` loops](https://just.systems/man/en/print.html#for-loops)
...
#### [`while` loops](https://just.systems/man/en/print.html#while-loops)
...
#### [Outside Recipe Bodies](https://just.systems/man/en/print.html#outside-recipe-bodies)
...
### [Command-line Options](https://just.systems/man/en/print.html#command-line-options)
...
#### [Setting Command-line Options with Environment Variables](https://just.systems/man/en/print.html#setting-command-line-options-with-environment-variables)
...
### [Private Recipes](https://just.systems/man/en/print.html#private-recipes)
...
### [Quiet Recipes](https://just.systems/man/en/print.html#quiet-recipes)
...
### [Selecting Recipes to Run With an Interactive Chooser](https://just.systems/man/en/print.html#selecting-recipes-to-run-with-an-interactive-chooser)
...
### [Invoking `justfile`s in Other Directories](https://just.systems/man/en/print.html#invoking-justfiles-in-other-directories)
...
### [Imports](https://just.systems/man/en/print.html#imports)
...
### [Modules](https://just.systems/man/en/print.html#modules)
...
### [Hiding `justfile`s](https://just.systems/man/en/print.html#hiding-justfiles)

`just` looks for `justfile`s named `justfile` and `.justfile`, which can be
used to keep a `justfile` hidden.

### [Just Scripts](https://just.systems/man/en/print.html#just-scripts)
...
### [Formatting and dumping `justfile`s](https://just.systems/man/en/print.html#formatting-and-dumping-justfiles)
...
### [Fallback to parent `justfile`s](https://just.systems/man/en/print.html#fallback-to-parent-justfiles)
...
### [Avoiding Argument Splitting](https://just.systems/man/en/print.html#avoiding-argument-splitting)
...
#### [Quoting](https://just.systems/man/en/print.html#quoting)
...
#### [Positional Arguments](https://just.systems/man/en/print.html#positional-arguments-1)
...
#### [Exported Arguments](https://just.systems/man/en/print.html#exported-arguments)
...
### [Configuring the Shell](https://just.systems/man/en/print.html#configuring-the-shell)
...
### [Timestamps](https://just.systems/man/en/print.html#timestamps)
...
### [Signal Handling](https://just.systems/man/en/print.html#signal-handling)
...
#### [Fatal Signals](https://just.systems/man/en/print.html#fatal-signals)
...
#### [`SIGINFO`](https://just.systems/man/en/print.html#siginfo)
...
#### [Windows](https://just.systems/man/en/print.html#windows-2)

On Windows, `just` behaves as if it had received `SIGINT` when the user types
`ctrl-c`. Other signals are unsupported.

## [Changelog](https://just.systems/man/en/print.html#changelog)
...
## [Miscellanea](https://just.systems/man/en/print.html#miscellanea)

### [Re-running recipes when files change](https://just.systems/man/en/print.html#re-running-recipes-when-files-change)
...
### [Parallelism](https://just.systems/man/en/print.html#parallelism)
...
### [Shell Alias](https://just.systems/man/en/print.html#shell-alias)

For lightning-fast command running, put `alias j=just` in your shell’s
configuration file.

### [Shell Completion Scripts](https://just.systems/man/en/print.html#shell-completion-scripts)
...
#### [Bash](https://just.systems/man/en/print.html#bash-1)
...
#### [Elvish](https://just.systems/man/en/print.html#elvish)
...
#### [Fish](https://just.systems/man/en/print.html#fish-1)
...
#### [Nushell](https://just.systems/man/en/print.html#nushell-1)
...
#### [PowerShell](https://just.systems/man/en/print.html#powershell)
...
#### [Zsh](https://just.systems/man/en/print.html#zsh)
...
### [Man Page](https://just.systems/man/en/print.html#man-page)
...
### [Global and User `justfile`s](https://just.systems/man/en/print.html#global-and-user-justfiles)

If you want some recipes to be available everywhere, you have a few options.

#### [Global Justfile](https://just.systems/man/en/print.html#global-justfile)
...
#### [User justfile tips](https://just.systems/man/en/print.html#user-justfile-tips)
...
##### [Recipe Aliases](https://just.systems/man/en/print.html#recipe-aliases)
...
##### [Forwarding Alias](https://just.systems/man/en/print.html#forwarding-alias)
...
##### [Customization](https://just.systems/man/en/print.html#customization)
...
### [Node.js `package.json` Script Compatibility](https://just.systems/man/en/print.html#nodejs-packagejson-script-compatibility)
...
### [Paths on Windows](https://just.systems/man/en/print.html#paths-on-windows)
...
### [Remote Justfiles](https://just.systems/man/en/print.html#remote-justfiles)
...
### [Printing Complex Strings](https://just.systems/man/en/print.html#printing-complex-strings)
...
### [Alternatives and Prior Art](https://just.systems/man/en/print.html#alternatives-and-prior-art)
...
## [Contributing](https://just.systems/man/en/print.html#contributing)
...
### [Getting Started](https://just.systems/man/en/print.html#getting-started)
...
### [Contribution Workflow](https://just.systems/man/en/print.html#contribution-workflow)
...
### [Hints](https://just.systems/man/en/print.html#hints)
...
#### [Adding a New Attribute](https://just.systems/man/en/print.html#adding-a-new-attribute)
...
### [Janus](https://just.systems/man/en/print.html#janus)
...
### [Minimum Supported Rust Version](https://just.systems/man/en/print.html#minimum-supported-rust-version)
...
### [New Releases](https://just.systems/man/en/print.html#new-releases)
...
## [Frequently Asked Questions](https://just.systems/man/en/print.html#frequently-asked-questions)

### [What are the idiosyncrasies of Make that Just avoids?](https://just.systems/man/en/print.html#what-are-the-idiosyncrasies-of-make-that-just-avoids)
...
### [What’s the relationship between Just and Cargo build scripts?](https://just.systems/man/en/print.html#whats-the-relationship-between-just-and-cargo-build-scripts)
...
## [Further Ramblings](https://just.systems/man/en/print.html#further-ramblings)
...
[🔼 Back to the top!](https://just.systems/man/en/further-ramblings.html#just)
