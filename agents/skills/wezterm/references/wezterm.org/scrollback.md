---
title: "Scrollback - Wez's Terminal Emulator"
source_url: "https://wezterm.org/scrollback"
...
* [WezTerm](https://wezterm.org/index.html)
  ...
  + Scrollback
    ...
    Table of contents
    - [Controlling the scrollback size](https://wezterm.org/scrollback.html#controlling-the-scrollback-size)
    - [Clearing the scrollback buffer](https://wezterm.org/scrollback.html#clearing-the-scrollback-buffer)
    - [Enable/Disable scrollbar](https://wezterm.org/scrollback.html#enabledisable-scrollbar)
    - [Scrolling without a scrollbar](https://wezterm.org/scrollback.html#scrolling-without-a-scrollbar)
    - [Searching the scrollback](https://wezterm.org/scrollback.html#searching-the-scrollback)

      * [Configurable search mode key assignments](https://wezterm.org/scrollback.html#configurable-search-mode-key-assignments)
    - [Configuring Saved Searches](https://wezterm.org/scrollback.html#configuring-saved-searches)
...
docs](https://wezterm.org/config/files.html) to learn how to change your settings!

### Controlling the scrollback size[¶](https://wezterm.org/scrollback.html#controlling-the-scrollback-size "Permanent link")
...
### Clearing the scrollback buffer[¶](https://wezterm.org/scrollback.html#clearing-the-scrollback-buffer "Permanent link")
...
See the [ClearScrollback](https://wezterm.org/config/lua/keyassignment/ClearScrollback.html) docs for information
on rebinding this key.

### Enable/Disable scrollbar[¶](https://wezterm.org/scrollback.html#enabledisable-scrollbar "Permanent link")
...
You may [change the color of the scrollbar](https://wezterm.org/config/appearance.html#defining-your-own-colors) if you wish!

### Scrolling without a scrollbar[¶](https://wezterm.org/scrollback.html#scrolling-without-a-scrollbar "Permanent link")

By default, `SHIFT-PageUp` and `SHIFT-PageDown` will adjust the viewport scrollback position
by one full screen for each press.

See the [ScrollByPage](https://wezterm.org/config/lua/keyassignment/ScrollByPage.html) docs for more information
on this key binding assignment.

### Searching the scrollback[¶](https://wezterm.org/scrollback.html#searching-the-scrollback "Permanent link")
...
#### Configurable search mode key assignments[¶](https://wezterm.org/scrollback.html#configurable-search-mode-key-assignments "Permanent link")

*Since: Version 20220624-141144-bd1b7c5d*

*The functionality described in this section requires version 20220624-141144-bd1b7c5d of wezterm,
or a more recent version.*

The key assignments for search mode are specified by the `search_mode` [Key Table](https://wezterm.org/config/key-tables.html).

You may use
[wezterm.gui.default\_key\_tables](https://wezterm.org/config/lua/wezterm.gui/default_key_tables.html)
...
(Those assignments reference `CopyMode` because search mode is a facet of [Copy Mode](https://wezterm.org/copymode.html)).

### Configuring Saved Searches[¶](https://wezterm.org/scrollback.html#configuring-saved-searches "Permanent link")

*Since: Version 20200607-144723-74889cd4*

*The functionality described in this section requires version 20200607-144723-74889cd4 of wezterm,
or a more recent version.*
...
See [the Search action docs](https://wezterm.org/config/lua/keyassignment/Search.html) for more information on
