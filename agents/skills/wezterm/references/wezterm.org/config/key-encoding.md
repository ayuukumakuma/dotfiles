---
title: "Keyboard Encoding - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/key-encoding"
...
* Configuration
  ...
  + Keyboard Encoding
    ...
    Table of contents
    - [xterm modifyOtherKeys](https://wezterm.org/config/key-encoding.html#xterm-modifyotherkeys)
    - [CSI-u/fixterms/libtickit](https://wezterm.org/config/key-encoding.html#csi-ufixtermslibtickit)
    - [Kitty Keyboard Protocol](https://wezterm.org/config/key-encoding.html#kitty-keyboard-protocol)
    - [Windows](https://wezterm.org/config/key-encoding.html#windows)
...
# Keyboard Encoding[¶](https://wezterm.org/config/key-encoding.html#keyboard-encoding "Permanent link")
...
## xterm `modifyOtherKeys`[¶](https://wezterm.org/config/key-encoding.html#xterm-modifyotherkeys "Permanent link")
...
Note that [enable\_csi\_u\_key\_encoding](https://wezterm.org/config/lua/config/enable_csi_u_key_encoding.html)
and [allow\_win32\_input\_mode](https://wezterm.org/config/lua/config/allow_win32_input_mode.html) both take
precedence over this behavior.

## CSI-u/fixterms/libtickit[¶](https://wezterm.org/config/key-encoding.html#csi-ufixtermslibtickit "Permanent link")
...
See also: [enable\_csi\_u\_key\_encoding](https://wezterm.org/config/lua/config/enable_csi_u_key_encoding.html).

Note that [allow\_win32\_input\_mode](https://wezterm.org/config/lua/config/allow_win32_input_mode.html) takes
precedence over this option.

## Kitty Keyboard Protocol[¶](https://wezterm.org/config/key-encoding.html#kitty-keyboard-protocol "Permanent link")
...
[enable\_kitty\_keyboard](https://wezterm.org/config/lua/config/enable_kitty_keyboard.html) controls whether
wezterm will honor the application requests to modify the keyboard encoding.

## Windows[¶](https://wezterm.org/config/key-encoding.html#windows "Permanent link")

On Windows, [allow\_win32\_input\_mode](https://wezterm.org/config/lua/config/allow_win32_input_mode.html)
