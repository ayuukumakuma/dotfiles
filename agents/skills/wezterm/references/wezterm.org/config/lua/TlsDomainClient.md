---
title: "object: TlsDomainClient - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/TlsDomainClient"
...
# TlsDomainClient[¶](https://wezterm.org/config/lua/TlsDomainClient.html#tlsdomainclient "Permanent link")

The `TlsDomainClient` struct specifies information about how to connect
to a [TLS Domain](https://wezterm.org/multiplexing.html#tls-domains).
