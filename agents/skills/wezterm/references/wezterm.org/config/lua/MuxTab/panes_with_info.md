---
title: "panes_with_info - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/panes_with_info"
...
# `tab:panes_with_info()`[¶](https://wezterm.org/config/lua/MuxTab/panes_with_info.html#tabpanes_with_info "Permanent link")
...
* `pane` - The [Pane](https://wezterm.org/config/lua/pane/index.html) object
