...
source_url: "https://wezterm.org/config/lua/MuxTab/window"
...
# `tab:window()`[¶](https://wezterm.org/config/lua/MuxTab/window.html#tabwindow "Permanent link")
...
Returns the [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) object that contains this tab.
