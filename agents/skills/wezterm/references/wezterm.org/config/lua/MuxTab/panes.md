---
title: "panes - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/panes"
...
# `tab:panes()`[¶](https://wezterm.org/config/lua/MuxTab/panes.html#tabpanes "Permanent link")
...
Returns an array table containing the set of [Pane](https://wezterm.org/config/lua/pane/index.html) objects
