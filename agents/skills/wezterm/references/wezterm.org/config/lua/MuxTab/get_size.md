---
title: "get_size - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/get_size"
...
# `tab:get_size()`[¶](https://wezterm.org/config/lua/MuxTab/get_size.html#tabget_size "Permanent link")
