...
source_url: "https://wezterm.org/config/lua/MuxTab/active_pane"
...
# `tab:active_pane()`[¶](https://wezterm.org/config/lua/MuxTab/active_pane.html#tabactive_pane "Permanent link")
