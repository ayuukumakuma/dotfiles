---
title: "Full Config & Lua Reference - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/general"
...
* Full Config & Lua Reference
  ...
  + Full Config & Lua Reference
    ...
    Table of contents
    - [Full List of Configuration Options](https://wezterm.org/config/lua/general.html#full-list-of-configuration-options)
...
# Lua Reference[¶](https://wezterm.org/config/lua/general.html#lua-reference "Permanent link")
...
## Full List of Configuration Options[¶](https://wezterm.org/config/lua/general.html#full-list-of-configuration-options "Permanent link")

[Config Options](https://wezterm.org/config/lua/config/index.html) has a list of the main configuration options.
