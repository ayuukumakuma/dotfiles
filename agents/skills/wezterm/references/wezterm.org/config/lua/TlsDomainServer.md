---
title: "object: TlsDomainServer - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/TlsDomainServer"
...
# TlsDomainServer[¶](https://wezterm.org/config/lua/TlsDomainServer.html#tlsdomainserver "Permanent link")

The `TlsDomainServer` struct specifies information about how to define
the server side of a [TLS Domain](https://wezterm.org/multiplexing.html#tls-domains).
