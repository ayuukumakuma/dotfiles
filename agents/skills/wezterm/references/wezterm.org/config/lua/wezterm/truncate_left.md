---
title: "wezterm.truncate_left - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/truncate_left"
...
# wezterm.truncate\_left(string, max\_width)[¶](https://wezterm.org/config/lua/wezterm/truncate_left.html#weztermtruncate_leftstring-max_width "Permanent link")
...
See also: [wezterm.truncate\_right](https://wezterm.org/config/lua/wezterm/truncate_right.html), [wezterm.pad\_right](https://wezterm.org/config/lua/wezterm/pad_right.html).
