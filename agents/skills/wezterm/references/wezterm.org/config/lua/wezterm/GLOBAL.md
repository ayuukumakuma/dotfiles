---
title: "wezterm.GLOBAL - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/GLOBAL"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm](https://wezterm.org/config/lua/wezterm/index.html)
    ...
    - GLOBAL
      ...
      Table of contents
      * [Note about referencing table values](https://wezterm.org/config/lua/wezterm/GLOBAL.html#note-about-referencing-table-values)
...
# `wezterm.GLOBAL`[¶](https://wezterm.org/config/lua/wezterm/GLOBAL.html#weztermglobal "Permanent link")
...
[ReloadConfiguration](https://wezterm.org/config/lua/keyassignment/ReloadConfiguration.html) key assignment
(`CTRL-SHIFT-R`):
...
## Note about referencing table values[¶](https://wezterm.org/config/lua/wezterm/GLOBAL.html#note-about-referencing-table-values "Permanent link")
