---
title: "wezterm.log_warn - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/log_warn"
...
# `wezterm.log_warn(arg, ..)`[¶](https://wezterm.org/config/lua/wezterm/log_warn.html#weztermlog_warnarg "Permanent link")
...
at 'WARN' level, which can be displayed via [ShowDebugOverlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) action. If you started wezterm from a terminal that text will print
...
See also [log\_info](https://wezterm.org/config/lua/wezterm/log_info.html) and [log\_error](https://wezterm.org/config/lua/wezterm/log_error.html).
