---
title: "wezterm.action - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/action"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm](https://wezterm.org/config/lua/wezterm/index.html)
    ...
    - action
      ...
      Table of contents
      * [Constructor Syntax](https://wezterm.org/config/lua/wezterm/action.html#constructor-syntax)
      * [Older versions](https://wezterm.org/config/lua/wezterm/action.html#older-versions)
...
# `wezterm.action`[¶](https://wezterm.org/config/lua/wezterm/action.html#weztermaction "Permanent link")
...
## Constructor Syntax[¶](https://wezterm.org/config/lua/wezterm/action.html#constructor-syntax "Permanent link")
...
[KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html) name will act as a constructor for
...
is a constructor for [QuickSelectArgs](https://wezterm.org/config/lua/keyassignment/QuickSelectArgs.html).

If the key assignment type is a *unit variant* (has no parameters) such as
[Copy](https://wezterm.org/config/lua/keyassignment/Copy.html), or can be constructed with default values
such as [QuickSelectArgs](https://wezterm.org/config/lua/keyassignment/QuickSelectArgs.html) then you can
...
such as [ActivatePaneByIndex](https://wezterm.org/config/lua/keyassignment/ActivatePaneByIndex.html), then
...
## Older versions[¶](https://wezterm.org/config/lua/wezterm/action.html#older-versions "Permanent link")
...
[You can find the reference for available KeyAssignment values here](https://wezterm.org/config/lua/keyassignment/index.html).
