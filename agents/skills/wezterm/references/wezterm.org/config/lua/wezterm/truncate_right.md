---
title: "wezterm.truncate_right - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/truncate_right"
...
# wezterm.truncate\_right(string, max\_width)[¶](https://wezterm.org/config/lua/wezterm/truncate_right.html#weztermtruncate_rightstring-max_width "Permanent link")
...
(as measured by [wezterm.column\_width](https://wezterm.org/config/lua/wezterm/column_width.html)).
...
See also: [wezterm.truncate\_left](https://wezterm.org/config/lua/wezterm/truncate_left.html), [wezterm.pad\_left](https://wezterm.org/config/lua/wezterm/pad_left.html).
