---
title: "wezterm.default_wsl_domains - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/default_wsl_domains"
...
# wezterm.default\_wsl\_domains()[¶](https://wezterm.org/config/lua/wezterm/default_wsl_domains.html#weztermdefault_wsl_domains "Permanent link")
...
Computes a list of [WslDomain](https://wezterm.org/config/lua/WslDomain.html) objects, each one
...
[wsl\_domains](https://wezterm.org/config/lua/config/wsl_domains.html) configuration option, which is to make
