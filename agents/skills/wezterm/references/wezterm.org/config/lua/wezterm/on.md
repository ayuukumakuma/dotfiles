---
title: "wezterm.on - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/on"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm](https://wezterm.org/config/lua/wezterm/index.html)
    ...
    - on
      ...
      Table of contents
      * [Predefined Events](https://wezterm.org/config/lua/wezterm/on.html#predefined-events)
      * [Custom Events](https://wezterm.org/config/lua/wezterm/on.html#custom-events)
...
# `wezterm.on(event_name, callback)`[¶](https://wezterm.org/config/lua/wezterm/on.html#weztermonevent_name-callback "Permanent link")
...
- a [`window` object](https://wezterm.org/config/lua/window/index.html) that represents the active gui window.
- a [`pane` object](https://wezterm.org/config/lua/pane/index.html) that represents the active pane.
...
See [wezterm.action\_callback](https://wezterm.org/config/lua/wezterm/action_callback.html) for a helper to define a custom action callback.

## Predefined Events[¶](https://wezterm.org/config/lua/wezterm/on.html#predefined-events "Permanent link")

See [Window Events](https://wezterm.org/config/lua/window-events/index.html) for a list of pre-defined
events.

## Custom Events[¶](https://wezterm.org/config/lua/wezterm/on.html#custom-events "Permanent link")
...
The [wezterm.emit](https://wezterm.org/config/lua/wezterm/emit.html) function and the [EmitEvent](https://wezterm.org/config/lua/keyassignment/EmitEvent.html) key assignment can be used to
emit events.

# Example: opening whole scrollback in vim[¶](https://wezterm.org/config/lua/wezterm/on.html#example-opening-whole-scrollback-in-vim "Permanent link")
