---
title: "wezterm.strftime - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/strftime"
...
# `wezterm.strftime(format)`[¶](https://wezterm.org/config/lua/wezterm/strftime.html#weztermstrftimeformat "Permanent link")
...
See also [strftime\_utc](https://wezterm.org/config/lua/wezterm/strftime_utc.html) and [wezterm.time](https://wezterm.org/config/lua/wezterm.time/index.html).
