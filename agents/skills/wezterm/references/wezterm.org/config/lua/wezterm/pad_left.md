---
title: "wezterm.pad_left - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/pad_left"
...
# wezterm.pad\_left(string, min\_width)[¶](https://wezterm.org/config/lua/wezterm/pad_left.html#weztermpad_leftstring-min_width "Permanent link")
...
See also: [wezterm.truncate\_left](https://wezterm.org/config/lua/wezterm/truncate_left.html), [wezterm.pad\_right](https://wezterm.org/config/lua/wezterm/pad_right.html).
