---
title: "wezterm.emit - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/emit"
...
# `wezterm.emit(event_name, args...)`[¶](https://wezterm.org/config/lua/wezterm/emit.html#weztermemitevent_name-args "Permanent link")
...
See [wezterm.on](https://wezterm.org/config/lua/wezterm/on.html) for more information about event handling.
