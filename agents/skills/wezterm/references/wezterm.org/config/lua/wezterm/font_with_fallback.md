---
title: "wezterm.font_with_fallback - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/font_with_fallback"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm](https://wezterm.org/config/lua/wezterm/index.html)
    ...
    - font\_with\_fallback

      [font\_with\_fallback](https://wezterm.org/config/lua/wezterm/font_with_fallback.html)

      Table of contents
      * [Dealing with different fallback font heights](https://wezterm.org/config/lua/wezterm/font_with_fallback.html#dealing-with-different-fallback-font-heights)

        + [Manual fallback scaling](https://wezterm.org/config/lua/wezterm/font_with_fallback.html#manual-fallback-scaling)
...
# `wezterm.font_with_fallback(families [, attributes])`[¶](https://wezterm.org/config/lua/wezterm/font_with_fallback.html#weztermfont_with_fallbackfamilies-attributes "Permanent link")
...
The *attributes* parameter behaves the same as that of [wezterm.font](https://wezterm.org/config/lua/wezterm/font.html)
in that it allows you to specify font weight and style attributes that you
want to match.

*Since: Version 20210502-130208-bff6815d*

*The functionality described in this section requires version 20210502-130208-bff6815d of wezterm,
...
* [harfbuzz\_features](https://wezterm.org/config/font-shaping.html)
* [freetype\_load\_target](https://wezterm.org/config/lua/config/freetype_load_target.html)
* [freetype\_render\_target](https://wezterm.org/config/lua/config/freetype_render_target.html)
* [freetype\_load\_flags](https://wezterm.org/config/lua/config/freetype_load_flags.html)
* `assume_emoji_presentation = true` or `assume_emoji_presentation = false` to control whether a font is considered to have emoji (rather than text) presentation glyphs for emoji. (*Since: Version 20220807-113146-c2fee766*)

## Dealing with different fallback font heights[¶](https://wezterm.org/config/lua/wezterm/font_with_fallback.html#dealing-with-different-fallback-font-heights "Permanent link")
...
### Manual fallback scaling[¶](https://wezterm.org/config/lua/wezterm/font_with_fallback.html#manual-fallback-scaling "Permanent link")
...
[line\_height](https://wezterm.org/config/lua/config/line_height.html) to produce a more pleasing display.
