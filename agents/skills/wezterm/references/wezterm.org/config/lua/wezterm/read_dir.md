---
title: "wezterm.read_dir - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/read_dir"
...
# `wezterm.read_dir(path)`[¶](https://wezterm.org/config/lua/wezterm/read_dir.html#weztermread_dirpath "Permanent link")
