---
title: "wezterm.column_width - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/column_width"
...
# wezterm.column\_width(string)[¶](https://wezterm.org/config/lua/wezterm/column_width.html#weztermcolumn_widthstring "Permanent link")
...
[format-tab-title](https://wezterm.org/config/lua/window-events/format-tab-title.html) and
[update-right-status](https://wezterm.org/config/lua/window-events/update-right-status.html) to
