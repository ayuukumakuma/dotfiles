---
title: "wezterm.gradient_colors - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/gradient_colors"
...
# `wezterm.gradient_colors(gradient, num_colors)`[¶](https://wezterm.org/config/lua/wezterm/gradient_colors.html#weztermgradient_colorsgradient-num_colors "Permanent link")
...
[window\_background\_gradient](https://wezterm.org/config/lua/config/window_background_gradient.html) option.

This example is what you'd see if you opened up the [debug overlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) to try this out in the repl:
...
[wezterm.color.gradient](https://wezterm.org/config/lua/wezterm.color/gradient.html) and that name
should be used instead of this name.

In addition, the returned colors are now [Color
objects](https://wezterm.org/config/lua/color/index.html).
