---
title: "wezterm.log_error - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/log_error"
...
# `wezterm.log_error(arg, ..)`[¶](https://wezterm.org/config/lua/wezterm/log_error.html#weztermlog_errorarg "Permanent link")

This function logs the provided message string through wezterm's logging layer
at 'ERROR' level, which can be displayed via [ShowDebugOverlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) action. If you started wezterm from a terminal that text will print
...
See also [log\_info](https://wezterm.org/config/lua/wezterm/log_info.html) and [log\_warn](https://wezterm.org/config/lua/wezterm/log_warn.html).
