---
title: "wezterm.font - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/font"
...
# `wezterm.font(family [, attributes])`[¶](https://wezterm.org/config/lua/wezterm/font.html#weztermfontfamily-attributes "Permanent link")
...
When resolving fonts from [font\_dirs](https://wezterm.org/config/lua/config/font_dirs.html), wezterm follows CSS Fonts
...
[wezterm.font\_with\_fallback](https://wezterm.org/config/lua/wezterm/font_with_fallback.html) when you want to specify precise
