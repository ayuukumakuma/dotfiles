---
title: "wezterm.enumerate_ssh_hosts - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/enumerate_ssh_hosts"
...
# wezterm.enumerate\_ssh\_hosts([ssh\_config\_file\_name, ...])[¶](https://wezterm.org/config/lua/wezterm/enumerate_ssh_hosts.html#weztermenumerate_ssh_hostsssh_config_file_name "Permanent link")
...
list as though
[wezterm.add\_to\_config\_reload\_watch\_list()](https://wezterm.org/config/lua/wezterm/add_to_config_reload_watch_list.html)
...
This shows the structure of the returned data, by evaluating the function in the [debug overlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) (`CTRL-SHIFT-L`):
