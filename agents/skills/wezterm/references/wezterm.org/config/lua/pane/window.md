---
title: "window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/window"
...
# `pane:window()`[¶](https://wezterm.org/config/lua/pane/window.html#panewindow "Permanent link")
...
Returns the [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) that contains the tab that contains this pane.
