---
title: "get_tty_name - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_tty_name"
...
# `pane:get_tty_name()`[¶](https://wezterm.org/config/lua/pane/get_tty_name.html#paneget_tty_name "Permanent link")
