---
title: "inject_output - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/inject_output"
...
# `pane:inject_output(text)`[¶](https://wezterm.org/config/lua/pane/inject_output.html#paneinject_outputtext "Permanent link")
