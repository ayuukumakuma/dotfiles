---
title: "get_progress - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_progress"
...
# `pane:get_progress()`[¶](https://wezterm.org/config/lua/pane/get_progress.html#paneget_progress "Permanent link")
...
[format-tab-title](https://wezterm.org/config/lua/window-events/format-tab-title.html) to trigger.
