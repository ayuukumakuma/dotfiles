---
title: "get_semantic_zone_at - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_semantic_zone_at"
...
# `pane:get_semantic_zone_at(x, y)`[¶](https://wezterm.org/config/lua/pane/get_semantic_zone_at.html#paneget_semantic_zone_atx-y "Permanent link")
...
Use [pane:get\_dimensions()](https://wezterm.org/config/lua/pane/get_dimensions.html) to
