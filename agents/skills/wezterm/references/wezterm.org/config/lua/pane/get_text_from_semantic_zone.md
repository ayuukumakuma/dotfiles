---
title: "get_text_from_semantic_zone - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_text_from_semantic_zone"
...
# `pane:get_text_from_semantic_zone(zone)`[¶](https://wezterm.org/config/lua/pane/get_text_from_semantic_zone.html#paneget_text_from_semantic_zonezone "Permanent link")
...
This is a convenience method that calls [pane:get\_text\_from\_region()](https://wezterm.org/config/lua/pane/get_text_from_region.html) on the supplied *zone* parameter.

Use [pane:get\_semantic\_zone\_at()](https://wezterm.org/config/lua/pane/get_semantic_zone_at.html) or
[pane:get\_semantic\_zones()](https://wezterm.org/config/lua/pane/get_semantic_zones.html) to obtain a *zone*.

See [Shell Integration](https://wezterm.org/shell-integration.html) for more information
