---
title: "get_text_from_region - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_text_from_region"
...
# `pane:get_text_from_region(start_x, start_y, end_x, end_y)`[¶](https://wezterm.org/config/lua/pane/get_text_from_region.html#paneget_text_from_regionstart_x-start_y-end_x-end_y "Permanent link")
...
* `start_y` and `end_y` are the starting and ending row, expressed as a stable
  row index. Use [pane:get\_dimensions()](https://wezterm.org/config/lua/pane/get_dimensions.html) to retrieve the
