---
title: "format-tab-title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/format-tab-title"
...
# `format-tab-title`[¶](https://wezterm.org/config/lua/window-events/format-tab-title.html#format-tab-title "Permanent link")
...
[wezterm.run\_child\_process](https://wezterm.org/config/lua/wezterm/run_child_process.html)) are not possible
...
already configuration for this in [tab\_bar\_style](https://wezterm.org/config/lua/config/tab_bar_style.html),
...
* `tab` - the [TabInformation](https://wezterm.org/config/lua/TabInformation.html) for the active tab
* `tabs` - an array containing [TabInformation](https://wezterm.org/config/lua/TabInformation.html) for each of the tabs in the window
* `panes` - an array containing [PaneInformation](https://wezterm.org/config/lua/PaneInformation.html) for each of the panes in the active tab
...
* a table holding `FormatItem`s as used in the [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html) function. This allows formatting style and color information for individual elements within the tab.
...
to [tab\_max\_width](https://wezterm.org/config/lua/config/tab_max_width.html). WezTerm will then compute
