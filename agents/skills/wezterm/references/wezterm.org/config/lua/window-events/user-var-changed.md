---
title: "user-var-changed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/user-var-changed"
...
# `user-var-changed`[¶](https://wezterm.org/config/lua/window-events/user-var-changed.html#user-var-changed "Permanent link")
...
See also [pane:get\_user\_vars()](https://wezterm.org/config/lua/pane/get_user_vars.html).
