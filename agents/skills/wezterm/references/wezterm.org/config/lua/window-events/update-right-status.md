---
title: "update-right-status - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/update-right-status"
...
# `update-right-status`[¶](https://wezterm.org/config/lua/window-events/update-right-status.html#update-right-status "Permanent link")
...
interval specified by the [status\_update\_interval](https://wezterm.org/config/lua/config/status_update_interval.html)
configuration value).
...
[window:set\_right\_status](https://wezterm.org/config/lua/window/set_right_status.html).

The first event parameter is a [`window` object](https://wezterm.org/config/lua/window/index.html) that
represents the gui window.

The second event parameter is a [`pane` object](https://wezterm.org/config/lua/pane/index.html) that
...
[status\_update\_interval](https://wezterm.org/config/lua/config/status_update_interval.html) to complete,
...
to using [update-status](https://wezterm.org/config/lua/window-events/update-status.html), which behaves the
