---
title: "window-focus-changed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/window-focus-changed"
...
# `window-focus-changed`[¶](https://wezterm.org/config/lua/window-events/window-focus-changed.html#window-focus-changed "Permanent link")
