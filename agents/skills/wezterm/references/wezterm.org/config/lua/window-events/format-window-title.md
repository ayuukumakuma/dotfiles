---
title: "format-window-title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/format-window-title"
...
# `format-window-title`[¶](https://wezterm.org/config/lua/window-events/format-window-title.html#format-window-title "Permanent link")
...
* `pane` - the [PaneInformation](https://wezterm.org/config/lua/PaneInformation.html) for the active pane
