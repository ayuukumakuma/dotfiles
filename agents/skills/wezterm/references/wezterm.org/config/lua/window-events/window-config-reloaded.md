---
title: "window-config-reloaded - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/window-config-reloaded"
...
# `window-config-reloaded`[¶](https://wezterm.org/config/lua/window-events/window-config-reloaded.html#window-config-reloaded "Permanent link")
...
[automatically\_reload\_config](https://wezterm.org/config/lua/config/automatically_reload_config.html) is
enabled), when the configuration is explicitly reloaded via the
[ReloadConfiguration](https://wezterm.org/config/lua/keyassignment/ReloadConfiguration.html) key action, and
when [window:set\_config\_overrides](https://wezterm.org/config/lua/window/set_config_overrides.html) is called
for the window.
