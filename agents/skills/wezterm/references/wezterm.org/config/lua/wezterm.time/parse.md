...
source_url: "https://wezterm.org/config/lua/wezterm.time/parse"
...
# `wezterm.time.parse(str, format)`[¶](https://wezterm.org/config/lua/wezterm.time/parse.html#weztermtimeparsestr-format "Permanent link")
