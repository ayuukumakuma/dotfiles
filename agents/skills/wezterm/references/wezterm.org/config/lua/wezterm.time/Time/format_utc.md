---
title: "format_utc - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.time/Time/format_utc"
...
# `Time:format_utc(format)`[¶](https://wezterm.org/config/lua/wezterm.time/Time/format_utc.html#timeformat_utcformat "Permanent link")
...
See also [Time:format()](https://wezterm.org/config/lua/wezterm.time/Time/format.html).
