---
title: "saturate - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/saturate"
...
# `color:saturate(factor)`[¶](https://wezterm.org/config/lua/color/saturate.html#colorsaturatefactor "Permanent link")
