---
title: "saturate_fixed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/saturate_fixed"
...
# `color:saturate_fixed(amount)`[¶](https://wezterm.org/config/lua/color/saturate_fixed.html#colorsaturate_fixedamount "Permanent link")
