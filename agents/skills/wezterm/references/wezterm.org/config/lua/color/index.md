---
title: "object: Color - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/index"
...
* [Available methods](https://wezterm.org/config/lua/color/index.html#available-methods)

# `Color` object[¶](https://wezterm.org/config/lua/color/index.html#color-object "Permanent link")

Color objects can be created by calling
[wezterm.color.parse()](https://wezterm.org/config/lua/wezterm.color/parse.html) and may also be
...
## Available methods[¶](https://wezterm.org/config/lua/color/index.html#available-methods "Permanent link")
