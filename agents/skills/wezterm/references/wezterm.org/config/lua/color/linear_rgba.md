---
title: "linear_rgba - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/linear_rgba"
...
# `color:linear_rgba()`[¶](https://wezterm.org/config/lua/color/linear_rgba.html#colorlinear_rgba "Permanent link")
