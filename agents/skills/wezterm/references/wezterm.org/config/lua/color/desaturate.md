---
title: "desaturate - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/desaturate"
...
# `color:desaturate(factor)`[¶](https://wezterm.org/config/lua/color/desaturate.html#colordesaturatefactor "Permanent link")
