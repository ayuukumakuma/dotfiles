---
title: "lighten - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/lighten"
...
# `color:lighten(factor)`[¶](https://wezterm.org/config/lua/color/lighten.html#colorlightenfactor "Permanent link")
