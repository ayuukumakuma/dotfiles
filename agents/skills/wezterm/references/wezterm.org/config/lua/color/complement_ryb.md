---
title: "complement_ryb - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/complement_ryb"
...
# `color:complement_ryb()`[¶](https://wezterm.org/config/lua/color/complement_ryb.html#colorcomplement_ryb "Permanent link")
...
See also: [color:complement()](https://wezterm.org/config/lua/color/complement.html).
