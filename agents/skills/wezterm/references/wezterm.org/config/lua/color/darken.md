---
title: "darken - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/darken"
...
# `color:darken(factor)`[¶](https://wezterm.org/config/lua/color/darken.html#colordarkenfactor "Permanent link")
