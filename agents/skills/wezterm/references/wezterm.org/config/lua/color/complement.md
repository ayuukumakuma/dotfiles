---
title: "complement - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/complement"
...
# `color:complement()`[¶](https://wezterm.org/config/lua/color/complement.html#colorcomplement "Permanent link")
...
See also: [color:complement\_ryb()](https://wezterm.org/config/lua/color/complement_ryb.html).
