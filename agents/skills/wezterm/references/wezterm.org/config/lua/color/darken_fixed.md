---
title: "darken_fixed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/darken_fixed"
...
# `color:darken_fixed(amount)`[¶](https://wezterm.org/config/lua/color/darken_fixed.html#colordarken_fixedamount "Permanent link")
