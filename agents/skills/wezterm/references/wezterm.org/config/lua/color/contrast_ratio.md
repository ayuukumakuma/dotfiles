---
title: "contrast_ratio - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/contrast_ratio"
...
# `color:contrast_ratio(color)`[¶](https://wezterm.org/config/lua/color/contrast_ratio.html#colorcontrast_ratiocolor "Permanent link")
