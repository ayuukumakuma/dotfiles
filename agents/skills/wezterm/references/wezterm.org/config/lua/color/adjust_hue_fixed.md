---
title: "adjust_hue_fixed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/adjust_hue_fixed"
...
# `color:adjust_hue_fixed(degrees)`[¶](https://wezterm.org/config/lua/color/adjust_hue_fixed.html#coloradjust_hue_fixeddegrees "Permanent link")
...
See also [color:adjust\_hue\_fixed\_ryb()](https://wezterm.org/config/lua/color/adjust_hue_fixed_ryb.html).
