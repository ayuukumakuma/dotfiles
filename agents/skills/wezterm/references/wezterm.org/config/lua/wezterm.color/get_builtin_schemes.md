---
title: "get_builtin_schemes - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.color/get_builtin_schemes"
...
# `wezterm.color.get_builtin_schemes()`[¶](https://wezterm.org/config/lua/wezterm.color/get_builtin_schemes.html#weztermcolorget_builtin_schemes "Permanent link")
...
(In earlier releases, you can use [wezterm.get\_builtin\_color\_schemes()](https://wezterm.org/config/lua/wezterm/get_builtin_color_schemes.html))
