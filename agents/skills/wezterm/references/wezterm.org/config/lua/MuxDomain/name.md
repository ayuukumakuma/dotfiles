---
title: "name - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/name"
...
# `domain:name()`[¶](https://wezterm.org/config/lua/MuxDomain/name.html#domainname "Permanent link")
...
See also: [domain:label()](https://wezterm.org/config/lua/MuxDomain/label.html).
