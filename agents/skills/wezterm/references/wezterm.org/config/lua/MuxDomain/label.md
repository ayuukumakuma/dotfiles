---
title: "label - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/label"
...
# `domain:label()`[¶](https://wezterm.org/config/lua/MuxDomain/label.html#domainlabel "Permanent link")
...
See also: [domain:name()](https://wezterm.org/config/lua/MuxDomain/name.html).
