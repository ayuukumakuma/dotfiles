---
title: "detach - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/detach"
...
# `domain:detach()`[¶](https://wezterm.org/config/lua/MuxDomain/detach.html#domaindetach "Permanent link")
