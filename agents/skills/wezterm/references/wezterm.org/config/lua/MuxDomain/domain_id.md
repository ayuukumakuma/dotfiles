---
title: "domain_id - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/domain_id"
...
# `domain:domain_id()`[¶](https://wezterm.org/config/lua/MuxDomain/domain_id.html#domaindomain_id "Permanent link")
