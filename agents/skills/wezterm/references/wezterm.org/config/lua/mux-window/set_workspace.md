---
title: "set_workspace - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/set_workspace"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - set\_workspace
      ...
      Table of contents
      * [window:set\_workspace("something")](https://wezterm.org/config/lua/mux-window/set_workspace.html#windowset_workspacesomething)
...
## `window:set_workspace("something")`[¶](https://wezterm.org/config/lua/mux-window/set_workspace.html#windowset_workspacesomething "Permanent link")
