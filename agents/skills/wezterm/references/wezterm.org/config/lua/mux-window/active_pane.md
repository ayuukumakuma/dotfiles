---
title: "active_pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/active_pane"
...
# `window:active_pane()`[¶](https://wezterm.org/config/lua/mux-window/active_pane.html#windowactive_pane "Permanent link")
...
See also [gui\_window:active\_pane()](https://wezterm.org/config/lua/window/active_pane.html), which is similar
