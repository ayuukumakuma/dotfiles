---
title: "get_title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/get_title"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - get\_title
      ...
      Table of contents
      * [window:get\_title()](https://wezterm.org/config/lua/mux-window/get_title.html#windowget_title)
...
## window:get\_title()[¶](https://wezterm.org/config/lua/mux-window/get_title.html#windowget_title "Permanent link")
