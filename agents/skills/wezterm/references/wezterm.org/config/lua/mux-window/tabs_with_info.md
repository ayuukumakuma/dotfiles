---
title: "tabs_with_info - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/tabs_with_info"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - tabs\_with\_info
      ...
      Table of contents
      * [window:tabs\_with\_info()](https://wezterm.org/config/lua/mux-window/tabs_with_info.html#windowtabs_with_info)
...
## window:tabs\_with\_info()[¶](https://wezterm.org/config/lua/mux-window/tabs_with_info.html#windowtabs_with_info "Permanent link")
...
* `tab` - the [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html) object
