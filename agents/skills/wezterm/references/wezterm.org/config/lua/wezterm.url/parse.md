---
title: "parse - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.url/parse"
...
# `wezterm.url.parse(URL_STRING)`[¶](https://wezterm.org/config/lua/wezterm.url/parse.html#weztermurlparseurl_string "Permanent link")
...
Attempts to parse the provided *URL\_STRING* as a URL.
If success, returns a [Url](https://wezterm.org/config/lua/wezterm.url/Url.html) object representing that URL.
