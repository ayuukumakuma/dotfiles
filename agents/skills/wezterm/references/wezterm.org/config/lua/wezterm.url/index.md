---
title: "module: wezterm.url - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.url/index"
...
* [Available functions and objects](https://wezterm.org/config/lua/wezterm.url/index.html#available-functions-and-objects)

# `wezterm.url` module[¶](https://wezterm.org/config/lua/wezterm.url/index.html#weztermurl-module "Permanent link")
...
## Available functions and objects[¶](https://wezterm.org/config/lua/wezterm.url/index.html#available-functions-and-objects "Permanent link")
