---
title: "tab_and_split_indices_are_zero_based - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/tab_and_split_indices_are_zero_based"
...
# `tab_and_split_indices_are_zero_based = false`[¶](https://wezterm.org/config/lua/config/tab_and_split_indices_are_zero_based.html#tab_and_split_indices_are_zero_based-false "Permanent link")

If `true`, [show\_tab\_index\_in\_tab\_bar](https://wezterm.org/config/lua/config/show_tab_index_in_tab_bar.html) uses a
