---
title: "selection_word_boundary - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/selection_word_boundary"
...
# `selection_word_boundary`[¶](https://wezterm.org/config/lua/config/selection_word_boundary.html#selection_word_boundary "Permanent link")
...
(See mouse actions [SelectTextAtMouseCursor](https://wezterm.org/config/lua/keyassignment/SelectTextAtMouseCursor.html) & [ExtendSelectionToMouseCursor](https://wezterm.org/config/lua/keyassignment/ExtendSelectionToMouseCursor.html) with the mode argument set to `Word`)
