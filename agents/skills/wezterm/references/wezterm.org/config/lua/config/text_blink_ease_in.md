---
title: "text_blink_ease_in - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/text_blink_ease_in"
...
# `text_blink_ease_in = "Linear"`[¶](https://wezterm.org/config/lua/config/text_blink_ease_in.html#text_blink_ease_in-linear "Permanent link")
...
See [visual\_bell](https://wezterm.org/config/lua/config/visual_bell.html) for more information about
easing functions.

See [cursor\_blink\_rate](https://wezterm.org/config/lua/config/cursor_blink_rate.html) to control the rate
