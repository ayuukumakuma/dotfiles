---
title: "tiling_desktop_environments - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/tiling_desktop_environments"
...
# `tiling_desktop_environments = {}`[¶](https://wezterm.org/config/lua/config/tiling_desktop_environments.html#tiling_desktop_environments "Permanent link")
...
*The functionality described in this section requires version dev of wezterm,
or a more recent version.*
...
The default key binding for it is `Ctrl` + `Shift` +
`L`.
