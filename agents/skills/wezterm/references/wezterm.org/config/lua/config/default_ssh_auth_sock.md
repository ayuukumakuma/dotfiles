---
title: "default_ssh_auth_sock - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/default_ssh_auth_sock"
...
# `default_ssh_auth_sock`[¶](https://wezterm.org/config/lua/config/default_ssh_auth_sock.html#default_ssh_auth_sock "Permanent link")
...
For example, [@wez](https://github.com/wez "GitHub User: wez") currently uses the 1Password SSH Auth Agent, but when
