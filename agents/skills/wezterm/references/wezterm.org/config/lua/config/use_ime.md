---
title: "use_ime - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/use_ime"
...
# `use_ime`[¶](https://wezterm.org/config/lua/config/use_ime.html#use_ime "Permanent link")
...
environment variable or the new [xim\_im\_name](https://wezterm.org/config/lua/config/xim_im_name.html) configuration
