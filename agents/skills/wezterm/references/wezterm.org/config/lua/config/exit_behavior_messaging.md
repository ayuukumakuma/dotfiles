---
title: "exit_behavior_messaging - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/exit_behavior_messaging"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - exit\_behavior\_messaging
      ...
      Table of contents
      * [exit\_behavior\_messaging = "Verbose"](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#exit_behavior_messaging-verbose)
      * [Example of a failing process with Verbose messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-verbose-messaging)
      * [Example of a failing process with Brief messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-brief-messaging)
      * [Example of a failing process with Terse messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-terse-messaging)
      * [Example of a successful process with Verbose messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-verbose-messaging)
      * [Example of a successful process with Brief messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-brief-messaging)
      * [Example of a successful process with Terse messaging](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-terse-messaging)
...
## `exit_behavior_messaging = "Verbose"`[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#exit_behavior_messaging-verbose "Permanent link")
...
If [exit\_behavior](https://wezterm.org/config/lua/config/exit_behavior.html) is set to keep the pane open after
...
* `"Verbose"` - Shows 2-3 lines of explanation, including the process name, its exit status and a link to the [exit\_behavior](https://wezterm.org/config/lua/config/exit_behavior.html) documentation.
...
## Example of a failing process with Verbose messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-verbose-messaging "Permanent link")
...
## Example of a failing process with Brief messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-brief-messaging "Permanent link")
...
## Example of a failing process with Terse messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-failing-process-with-terse-messaging "Permanent link")
...
## Example of a successful process with Verbose messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-verbose-messaging "Permanent link")
...
## Example of a successful process with Brief messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-brief-messaging "Permanent link")
...
## Example of a successful process with Terse messaging[¶](https://wezterm.org/config/lua/config/exit_behavior_messaging.html#example-of-a-successful-process-with-terse-messaging "Permanent link")
