---
title: "tls_servers - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/tls_servers"
...
# `tls_servers`[¶](https://wezterm.org/config/lua/config/tls_servers.html#tls_servers "Permanent link")

Configures TLS multiplexing domains. [Read more about TLS Domains](https://wezterm.org/multiplexing.html#tls-domains).

This option accepts a list of [TlsDomainServer](https://wezterm.org/config/lua/TlsDomainServer.html) objects.
