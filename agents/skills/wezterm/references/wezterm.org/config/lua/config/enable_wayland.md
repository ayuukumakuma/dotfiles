---
title: "enable_wayland - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/enable_wayland"
...
# `enable_wayland`[¶](https://wezterm.org/config/lua/config/enable_wayland.html#enable_wayland "Permanent link")
