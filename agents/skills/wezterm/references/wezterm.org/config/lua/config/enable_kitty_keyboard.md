---
title: "enable_kitty_keyboard - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/enable_kitty_keyboard"
...
# `enable_kitty_keyboard = false`[¶](https://wezterm.org/config/lua/config/enable_kitty_keyboard.html#enable_kitty_keyboard-false "Permanent link")
...
sequences that modify the [keyboard encoding](https://wezterm.org/config/key-encoding.html).
