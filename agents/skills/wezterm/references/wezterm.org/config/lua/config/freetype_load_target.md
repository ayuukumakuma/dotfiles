---
title: "freetype_load_target - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/freetype_load_target"
...
# `freetype_load_target = "Normal"`[¶](https://wezterm.org/config/lua/config/freetype_load_target.html#freetype_load_target-normal "Permanent link")
...
See also [freetype\_render\_target](https://wezterm.org/config/lua/config/freetype_render_target.html) and
[freetype\_load\_flags](https://wezterm.org/config/lua/config/freetype_load_flags.html) for more advanced flags that can
...
[wezterm.font](https://wezterm.org/config/lua/wezterm/font.html) override is not sufficient.
