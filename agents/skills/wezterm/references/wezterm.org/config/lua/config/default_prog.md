---
title: "default_prog - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/default_prog"
...
# `default_prog`[¶](https://wezterm.org/config/lua/config/default_prog.html#default_prog "Permanent link")
...
See also: [Launching Programs](https://wezterm.org/config/launch.html)
