---
title: "font_dirs - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/font_dirs"
...
# `font_dirs`[¶](https://wezterm.org/config/lua/config/font_dirs.html#font_dirs "Permanent link")
...
[font\_locator](https://wezterm.org/config/lua/config/font_locator.html) which is typically the system specific font
