---
title: "prefer_egl - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/prefer_egl"
...
# `prefer_egl = true`[¶](https://wezterm.org/config/lua/config/prefer_egl.html#prefer_egl-true "Permanent link")
...
| Environment | prefer\_egl=true | prefer\_egl=false |
| --- | --- | --- |
