---
title: "colors - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/colors"
...
# `colors`[¶](https://wezterm.org/config/lua/config/colors.html#colors "Permanent link")

Specifies the color palette.

Described in more detail in [Colors & Appearance](https://wezterm.org/config/appearance.html#defining-your-own-colors)
