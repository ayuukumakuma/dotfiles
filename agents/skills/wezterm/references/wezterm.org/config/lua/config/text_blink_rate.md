---
title: "text_blink_rate - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/text_blink_rate"
...
# `text_blink_rate`[¶](https://wezterm.org/config/lua/config/text_blink_rate.html#text_blink_rate "Permanent link")
...
[text\_blink\_ease\_in](https://wezterm.org/config/lua/config/text_blink_ease_in.html) and
[text\_blink\_ease\_out](https://wezterm.org/config/lua/config/text_blink_ease_out.html) for more information.
