---
title: "cursor_thickness - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/cursor_thickness"
...
# `cursor_thickness`[¶](https://wezterm.org/config/lua/config/cursor_thickness.html#cursor_thickness "Permanent link")
...
The default is to use the [underline\_thickness](https://wezterm.org/config/lua/config/underline_thickness.html).
