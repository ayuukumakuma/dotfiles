---
title: "visual_bell - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/visual_bell"
...
# `visual_bell`[¶](https://wezterm.org/config/lua/config/visual_bell.html#visual_bell "Permanent link")
...
There are four fields to the visual\_bell config option:
...
See also [audible\_bell](https://wezterm.org/config/lua/config/audible_bell.html) and [bell event](https://wezterm.org/config/lua/window-events/bell.html).
