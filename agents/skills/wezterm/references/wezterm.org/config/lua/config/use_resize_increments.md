---
title: "use_resize_increments - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/use_resize_increments"
...
# `use_resize_increments = false`[¶](https://wezterm.org/config/lua/config/use_resize_increments.html#use_resize_increments-false "Permanent link")
...
Note that if you have configured [window\_padding](https://wezterm.org/config/lua/config/window_padding.html) then the
