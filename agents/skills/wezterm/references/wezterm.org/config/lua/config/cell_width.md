---
title: "cell_width - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/cell_width"
...
# `cell_width = 1.0`[¶](https://wezterm.org/config/lua/config/cell_width.html#cell_width-10 "Permanent link")
...
selecting a font using [wezterm.font](https://wezterm.org/config/lua/wezterm/font.html) or
[wezterm.font\_with\_fallback](https://wezterm.org/config/lua/wezterm/font_with_fallback.html) as that will
...
The default cell width is indirectly controlled by the [font](https://wezterm.org/config/lua/config/font.html) and
[font\_size](https://wezterm.org/config/lua/config/font_size.html) configuration options; the selected font and font
...
See also: [line\_height](https://wezterm.org/config/lua/config/line_height.html)
