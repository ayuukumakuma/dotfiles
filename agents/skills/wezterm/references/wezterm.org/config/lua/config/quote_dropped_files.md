---
title: "quote_dropped_files - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/quote_dropped_files"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - quote\_dropped\_files

      [quote\_dropped\_files](https://wezterm.org/config/lua/config/quote_dropped_files.html)

      Table of contents
      * [quote\_dropped\_files = "SpacesOnly"](https://wezterm.org/config/lua/config/quote_dropped_files.html#quote_dropped_files-spacesonly)
...
## quote\_dropped\_files = "SpacesOnly"[¶](https://wezterm.org/config/lua/config/quote_dropped_files.html#quote_dropped_files-spacesonly "Permanent link")
