---
title: "custom_block_glyphs - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/custom_block_glyphs"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - custom\_block\_glyphs

      [custom\_block\_glyphs](https://wezterm.org/config/lua/config/custom_block_glyphs.html)

      Table of contents
      * [custom\_block\_glyphs = true](https://wezterm.org/config/lua/config/custom_block_glyphs.html#custom_block_glyphs-true)
...
## `custom_block_glyphs = true`[¶](https://wezterm.org/config/lua/config/custom_block_glyphs.html#custom_block_glyphs-true "Permanent link")
...
| [Git Branch Symbols](https://github.com/wezterm/wezterm/issues/6328) | Custom branch drawing symbols for rendering DAGs such as Git branch structure | (*Since: Nightly Builds Only*) |
| [Progress Bar Symbols](https://github.com/ryanoasis/nerd-fonts/issues/1345) | Fixed and indeterminate progress bar elements | (*Since: Nightly Builds Only*) |

You can set this to `false` to use the block characters provided by your font selection.

See also [anti\_alias\_custom\_block\_glyphs](https://wezterm.org/config/lua/config/anti_alias_custom_block_glyphs.html).
