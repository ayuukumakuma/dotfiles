---
title: "freetype_render_target - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/freetype_render_target"
...
# `freetype_render_target = "Normal"`[¶](https://wezterm.org/config/lua/config/freetype_render_target.html#freetype_render_target-normal "Permanent link")
...
The default is to use the value of [freetype\_load\_target](https://wezterm.org/config/lua/config/freetype_load_target.html).
