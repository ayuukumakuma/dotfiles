---
title: "hyperlink_rules - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/hyperlink_rules"
...
# `hyperlink_rules`[¶](https://wezterm.org/config/lua/config/hyperlink_rules.html#hyperlink_rules "Permanent link")
...
[wezterm.default\_hyperlink\_rules()](https://wezterm.org/config/lua/wezterm/default_hyperlink_rules.html),
and is shown below:
...
```
regex = [[\b[tT](https://wezterm.org/config/lua/config/\d+)\b]]
```
