---
title: "webgpu_preferred_adapter - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/webgpu_preferred_adapter"
...
# `webgpu_preferred_adapter`[¶](https://wezterm.org/config/lua/config/webgpu_preferred_adapter.html#webgpu_preferred_adapter "Permanent link")
...
You can use the [wezterm.gui.enumerate\_gpus()](https://wezterm.org/config/lua/wezterm.gui/enumerate_gpus.html) function
to return a list of GPUs.

If you open the [Debug Overlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) (default:
`CTRL` + `SHIFT` + `L`) you can interactively review
the list:
...
See also [webgpu\_power\_preference](https://wezterm.org/config/lua/config/webgpu_power_preference.html),
[webgpu\_force\_fallback\_adapter](https://wezterm.org/config/lua/config/webgpu_force_fallback_adapter.html).
