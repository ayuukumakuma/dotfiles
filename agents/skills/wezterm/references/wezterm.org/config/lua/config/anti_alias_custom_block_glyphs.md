---
title: "anti_alias_custom_block_glyphs - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/anti_alias_custom_block_glyphs"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - anti\_alias\_custom\_block\_glyphs

      [anti\_alias\_custom\_block\_glyphs](https://wezterm.org/config/lua/config/anti_alias_custom_block_glyphs.html)

      Table of contents
      * [anti\_alias\_custom\_block\_glyphs = true](https://wezterm.org/config/lua/config/anti_alias_custom_block_glyphs.html#anti_alias_custom_block_glyphs-true)
...
## `anti_alias_custom_block_glyphs = true`[¶](https://wezterm.org/config/lua/config/anti_alias_custom_block_glyphs.html#anti_alias_custom_block_glyphs-true "Permanent link")

*Since: Version 20220405-091515-8a0072ad*

*The functionality described in this section requires version 20220405-091515-8a0072ad of wezterm,
or a more recent version.*

Control whether [custom\_block\_glyphs](https://wezterm.org/config/lua/config/custom_block_glyphs.html) are rendered
