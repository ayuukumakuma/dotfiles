---
title: "debug_key_events - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/debug_key_events"
...
# `debug_key_events = false`[¶](https://wezterm.org/config/lua/config/debug_key_events.html#debug_key_events-false "Permanent link")
...
* `key` is the decoded key after keymapping and composition effects. For
  ...
  [the Configuring Key Assignments](https://wezterm.org/config/keys.html#configuring-key-assignments)
  section.
