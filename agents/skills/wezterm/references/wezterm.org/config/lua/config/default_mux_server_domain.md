---
title: "default_mux_server_domain - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/default_mux_server_domain"
...
# `default_mux_server_domain = "local"`[¶](https://wezterm.org/config/lua/config/default_mux_server_domain.html#default_mux_server_domain-local "Permanent link")
...
the GUI, see [default\_domain](https://wezterm.org/config/lua/config/default_domain.html)
...
as an [ExecDomain](https://wezterm.org/config/lua/ExecDomain.html).
