---
title: "default_cursor_style - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/default_cursor_style"
...
# `default_cursor_style = "SteadyBlock"`[¶](https://wezterm.org/config/lua/config/default_cursor_style.html#default_cursor_style-steadyblock "Permanent link")
...
[animation\_fps](https://wezterm.org/config/lua/config/animation_fps.html) can be used to tune the frame
