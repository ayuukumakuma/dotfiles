---
title: "initial_cols - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/initial_cols"
...
# `initial_cols = 80`[¶](https://wezterm.org/config/lua/config/initial_cols.html#initial_cols-80 "Permanent link")

Together with [initial\_rows](https://wezterm.org/config/lua/config/initial_rows.html), configures the window size
