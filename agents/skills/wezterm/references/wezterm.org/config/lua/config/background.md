---
title: "background - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/background"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - background
      ...
      Table of contents
      * [Layer Definition](https://wezterm.org/config/lua/config/background.html#layer-definition)
      * [Source Definition](https://wezterm.org/config/lua/config/background.html#source-definition)
      * [Relationship with other config options](https://wezterm.org/config/lua/config/background.html#relationship-with-other-config-options)
      * [Parallax Example](https://wezterm.org/config/lua/config/background.html#parallax-example)
...
# `background`[¶](https://wezterm.org/config/lua/config/background.html#background "Permanent link")
...
[](https://wezterm.org/screenshots/wezterm-parallax-2.mp4)
...
## Layer Definition[¶](https://wezterm.org/config/lua/config/background.html#layer-definition "Permanent link")
...
* `hsb` - a hue, saturation, brightness transformation that can be used to adjust those attributes of the layer. See [foreground\_text\_hsb](https://wezterm.org/config/lua/config/foreground_text_hsb.html) for more information about this kind of transform.
...
## Source Definition[¶](https://wezterm.org/config/lua/config/background.html#source-definition "Permanent link")
...
* `{Gradient={preset="Warm"}}` - generate a gradient. The gradient definitions
  are the same as those allowed for [window\_background\_gradient](https://wezterm.org/config/lua/config/window_background_gradient.html).
* `{Color="black"}` - generate an image with the specified color.

## Relationship with other config options[¶](https://wezterm.org/config/lua/config/background.html#relationship-with-other-config-options "Permanent link")
...
## Parallax Example[¶](https://wezterm.org/config/lua/config/background.html#parallax-example "Permanent link")
