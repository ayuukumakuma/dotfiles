---
title: "status_update_interval - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/status_update_interval"
...
# `status_update_interval = 1000`[¶](https://wezterm.org/config/lua/config/status_update_interval.html#status_update_interval-1000 "Permanent link")
...
[update-status](https://wezterm.org/config/lua/window-events/update-status.html) and
[update-right-status](https://wezterm.org/config/lua/window-events/update-right-status.html) hook.
