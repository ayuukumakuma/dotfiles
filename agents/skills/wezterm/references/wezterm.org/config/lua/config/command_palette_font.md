---
title: "command_palette_font - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/command_palette_font"
...
# `command_palette_font`[¶](https://wezterm.org/config/lua/config/command_palette_font.html#command_palette_font "Permanent link")
...
You will typically use [wezterm.font](https://wezterm.org/config/lua/wezterm/font.html) or
[wezterm.font\_with\_fallback](https://wezterm.org/config/lua/wezterm/font_with_fallback.html) to specify the
font.
