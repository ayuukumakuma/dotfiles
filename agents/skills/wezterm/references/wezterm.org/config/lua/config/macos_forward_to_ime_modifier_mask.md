---
title: "macos_forward_to_ime_modifier_mask - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/macos_forward_to_ime_modifier_mask"
...
# `macos_forward_to_ime_modifier_mask = "SHIFT"`[¶](https://wezterm.org/config/lua/config/macos_forward_to_ime_modifier_mask.html#macos_forward_to_ime_modifier_mask-shift "Permanent link")
...
routed via the IME when [use\_ime = true](https://wezterm.org/config/lua/config/use_ime.html).
