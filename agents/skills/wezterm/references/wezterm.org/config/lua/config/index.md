---
title: "Config Options - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/index"
...
# `Config` struct[¶](https://wezterm.org/config/lua/config/index.html#config-struct "Permanent link")
