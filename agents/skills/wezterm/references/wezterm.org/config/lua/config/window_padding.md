---
title: "window_padding - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/window_padding"
...
# `window_padding`[¶](https://wezterm.org/config/lua/config/window_padding.html#window_padding "Permanent link")
...
If [enable\_scroll\_bar](https://wezterm.org/config/lua/config/enable_scroll_bar.html) is `true`, then the value you
