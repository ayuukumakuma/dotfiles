---
title: "unix_domains - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/unix_domains"
...
# `unix_domains`[¶](https://wezterm.org/config/lua/config/unix_domains.html#unix_domains "Permanent link")

Defines a list of multiplexer domains for both the multiplexer
server and multiplexer client.

[Read more about multiplexing](https://wezterm.org/multiplexing.html#unix-domains)
