---
title: "default_cwd - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/default_cwd"
...
# `default_cwd`[¶](https://wezterm.org/config/lua/config/default_cwd.html#default_cwd "Permanent link")
...
[wezterm.home\_dir](https://wezterm.org/config/lua/wezterm/home_dir.html) to explicitly refer to your home
directory.

If `wezterm start --cwd /some/path` is used to specify the current working
directory, that will take precedence.

Commands launched using [`SpawnCommand`](https://wezterm.org/config/lua/SpawnCommand.html) will use the
