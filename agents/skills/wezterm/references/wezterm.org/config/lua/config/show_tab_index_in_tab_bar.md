---
title: "show_tab_index_in_tab_bar - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/show_tab_index_in_tab_bar"
...
# `show_tab_index_in_tab_bar = true`[¶](https://wezterm.org/config/lua/config/show_tab_index_in_tab_bar.html#show_tab_index_in_tab_bar-true "Permanent link")
...
The [tab\_and\_split\_indices\_are\_zero\_based](https://wezterm.org/config/lua/config/tab_and_split_indices_are_zero_based.html) setting controls whether numbering starts with `0` or `1`.
