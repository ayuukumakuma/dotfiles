---
title: "spawn_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.mux/spawn_window"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm.mux](https://wezterm.org/config/lua/wezterm.mux/index.html)
    ...
    - spawn\_window
      ...
      Table of contents
      * [wezterm.mux.spawn\_window{}](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#weztermmuxspawn_window)

        + [args](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#args)
        + [cwd](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#cwd)
        + [set\_environment\_variables](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#set_environment_variables)
        + [domain](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#domain)
        + [width and height](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#width-and-height)
        + [workspace](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#workspace)
        + [position](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#position)
...
## `wezterm.mux.spawn_window{}`[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#weztermmuxspawn_window "Permanent link")
...
Spawns a program into a new window, returning the [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html),
[Pane](https://wezterm.org/config/lua/pane/index.html) and [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) objects
associated with it:
...
### args[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#args "Permanent link")
...
### cwd[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#cwd "Permanent link")

Specify the current working directory that should be used for
the program.

If unspecified, follows the rules from [default\_cwd](https://wezterm.org/config/lua/config/default_cwd.html)

```
wezterm.mux.spawn_window { cwd = '/tmp' }
```

### set\_environment\_variables[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#set_environment_variables "Permanent link")
...
### domain[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#domain "Permanent link")
...
### width and height[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#width-and-height "Permanent link")
...
### workspace[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#workspace "Permanent link")
...
### position[¶](https://wezterm.org/config/lua/wezterm.mux/spawn_window.html#position "Permanent link")
...
See also [wezterm.gui.screens()](https://wezterm.org/config/lua/wezterm.gui/screens.html)
