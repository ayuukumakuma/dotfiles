---
title: "get_pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.mux/get_pane"
...
# `wezterm.mux.get_pane(PANE_ID)`[¶](https://wezterm.org/config/lua/wezterm.mux/get_pane.html#weztermmuxget_panepane_id "Permanent link")
...
and returns a [Pane](https://wezterm.org/config/lua/pane/index.html) object that can be used to
operate on the pane.
