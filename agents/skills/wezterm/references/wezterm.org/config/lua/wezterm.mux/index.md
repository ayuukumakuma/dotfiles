---
title: "module: wezterm.mux - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.mux/index"
...
* [Important Note!](https://wezterm.org/config/lua/wezterm.mux/index.html#important-note)
* [Available functions, constants](https://wezterm.org/config/lua/wezterm.mux/index.html#available-functions-constants)

# `wezterm.mux` module[¶](https://wezterm.org/config/lua/wezterm.mux/index.html#weztermmux-module "Permanent link")
...
## Important Note![¶](https://wezterm.org/config/lua/wezterm.mux/index.html#important-note "Permanent link")

*You should* *avoid using, at the file scope in your config**, mux functions that cause new splits, tabs or windows to be created. The configuration file can be evaluated multiple times in various contexts. If you want to spawn new programs when wezterm starts up, look at the [gui-startup](https://wezterm.org/config/lua/gui-events/gui-startup.html) and [mux-startup](https://wezterm.org/config/lua/mux-events/mux-startup.html) events.*

## Available functions, constants[¶](https://wezterm.org/config/lua/wezterm.mux/index.html#available-functions-constants "Permanent link")
