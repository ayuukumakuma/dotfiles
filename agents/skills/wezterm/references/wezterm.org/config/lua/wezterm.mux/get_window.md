---
title: "get_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.mux/get_window"
...
# `wezterm.mux.get_window(WINDOW_ID)`[¶](https://wezterm.org/config/lua/wezterm.mux/get_window.html#weztermmuxget_windowwindow_id "Permanent link")
...
and returns a [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) object that can be used to
