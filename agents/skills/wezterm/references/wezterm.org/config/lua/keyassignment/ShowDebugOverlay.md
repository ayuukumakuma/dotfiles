---
title: "ShowDebugOverlay - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay"
...
# `ShowDebugOverlay`[¶](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html#showdebugoverlay "Permanent link")
...
* `wezterm` - the [wezterm](https://wezterm.org/config/lua/wezterm/index.html) module is pre-imported
* `window` - the [window](https://wezterm.org/config/lua/window/index.html) object for the current window
