---
title: "enum: KeyAssignment - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/index"
...
* [Available Key Assignments](https://wezterm.org/config/lua/keyassignment/index.html#available-key-assignments)

# `KeyAssignment` enumeration[¶](https://wezterm.org/config/lua/keyassignment/index.html#keyassignment-enumeration "Permanent link")
...
In most cases the [`wezterm.action`](https://wezterm.org/config/lua/wezterm/action.html) function is
used to create an instance of `KeyAssignment` and make it a bit more
clear and convenient.

## Available Key Assignments[¶](https://wezterm.org/config/lua/keyassignment/index.html#available-key-assignments "Permanent link")
