---
title: "ActivateCommandPalette - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ActivateCommandPalette"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - ActivateCommandPalette
      ...
      Table of contents
      * [Key Assignments](https://wezterm.org/config/lua/keyassignment/ActivateCommandPalette.html#key-assignments)
...
# `ActivateCommandPalette`[¶](https://wezterm.org/config/lua/keyassignment/ActivateCommandPalette.html#activatecommandpalette "Permanent link")
...
![Command Palette](https://wezterm.org/screenshots/command-palette.png)

### Key Assignments[¶](https://wezterm.org/config/lua/keyassignment/ActivateCommandPalette.html#key-assignments "Permanent link")
...
Typing text (and using `Backspace`) allows you to fuzzy match possible
