---
title: "SwitchToWorkspace - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SwitchToWorkspace"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - SwitchToWorkspace
      ...
      Table of contents
      * [Prompting for the workspace name](https://wezterm.org/config/lua/keyassignment/SwitchToWorkspace.html#prompting-for-the-workspace-name)
...
# `SwitchToWorkspace`[¶](https://wezterm.org/config/lua/keyassignment/SwitchToWorkspace.html#switchtoworkspace "Permanent link")
...
* `spawn` - a [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) describing the command that should be started in the workspace if it doesn't already exist. If omitted, the default program will be spawned in the newly created workspace.
...
## Prompting for the workspace name[¶](https://wezterm.org/config/lua/keyassignment/SwitchToWorkspace.html#prompting-for-the-workspace-name "Permanent link")
