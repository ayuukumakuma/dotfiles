---
title: "SplitHorizontal - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SplitHorizontal"
...
# `SplitHorizontal`[¶](https://wezterm.org/config/lua/keyassignment/SplitHorizontal.html#splithorizontal "Permanent link")
...
`SplitHorizontal` requires a [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) parameter to
...
See also: [SplitPane](https://wezterm.org/config/lua/keyassignment/SplitPane.html).
