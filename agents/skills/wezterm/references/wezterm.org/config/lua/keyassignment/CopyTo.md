---
title: "CopyTo - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/CopyTo"
...
# `CopyTo(destination)`[¶](https://wezterm.org/config/lua/keyassignment/CopyTo.html#copytodestination "Permanent link")
