---
title: "Copy - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/Copy"
...
# `Copy`[¶](https://wezterm.org/config/lua/keyassignment/Copy.html#copy "Permanent link")
...
a future release; please use [CopyTo](https://wezterm.org/config/lua/keyassignment/CopyTo.html) instead.
...
This action has been removed. Please use [CopyTo](https://wezterm.org/config/lua/keyassignment/CopyTo.html) instead.
