---
title: "PromptInputLine - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/PromptInputLine"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - PromptInputLine
      ...
      Table of contents
      * [Example of interactively renaming the current tab](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#example-of-interactively-renaming-the-current-tab)
      * [Example of interactively picking a name and creating a new workspace](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#example-of-interactively-picking-a-name-and-creating-a-new-workspace)
...
# `PromptInputLine`[¶](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#promptinputline "Permanent link")
...
* `description` - the text to show at the top of the display area. You may
  embed escape sequences and/or use [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html).
...
* `prompt` - the text to show as the prompt. You may embed escape sequences
  and/or use [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html). Defaults to: `"> "`. (*Since: Nightly Builds Only*)
* `initial_value` - optional. If provided, the initial content of the input
  ...
  the input. (*Since: Nightly Builds Only*)

## Example of interactively renaming the current tab[¶](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#example-of-interactively-renaming-the-current-tab "Permanent link")
...
## Example of interactively picking a name and creating a new workspace[¶](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#example-of-interactively-picking-a-name-and-creating-a-new-workspace "Permanent link")
