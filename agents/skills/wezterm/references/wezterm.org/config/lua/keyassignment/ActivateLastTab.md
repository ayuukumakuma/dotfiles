---
title: "ActivateLastTab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ActivateLastTab"
...
# `ActivateLastTab`[¶](https://wezterm.org/config/lua/keyassignment/ActivateLastTab.html#activatelasttab "Permanent link")
...
See [ActivateTab](https://wezterm.org/config/lua/keyassignment/ActivateTab.html) for a way to activate a tab based on its position/index.
