---
title: "ActivateWindowRelativeNoWrap - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ActivateWindowRelativeNoWrap"
...
# `ActivateWindowRelative(delta)`[¶](https://wezterm.org/config/lua/keyassignment/ActivateWindowRelativeNoWrap.html#activatewindowrelativedelta "Permanent link")
...
See also [ActivateWindowRelative](https://wezterm.org/config/lua/keyassignment/ActivateWindowRelative.html),
[ActivateWindow](https://wezterm.org/config/lua/keyassignment/ActivateWindow.html).
