---
title: "SetPaneZoomState - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SetPaneZoomState"
...
# `SetPaneZoomState(bool)`[¶](https://wezterm.org/config/lua/keyassignment/SetPaneZoomState.html#setpanezoomstatebool "Permanent link")
...
See also: [`unzoom_on_switch_pane`](https://wezterm.org/config/lua/config/unzoom_on_switch_pane.html),
[TogglePaneZoomState](https://wezterm.org/config/lua/keyassignment/TogglePaneZoomState.html),
[MuxTab:set\_zoomed()](https://wezterm.org/config/lua/MuxTab/set_zoomed.html).
