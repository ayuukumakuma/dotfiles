---
title: "PaneSelect - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/PaneSelect"
...
# `PaneSelect`[¶](https://wezterm.org/config/lua/keyassignment/PaneSelect.html#paneselect "Permanent link")
...
![Pane Select](https://wezterm.org/screenshots/pane-select.png)
...
[quick\_select\_alphabet](https://wezterm.org/config/lua/config/quick_select_alphabet.html), but can be
...
See also [RotatePanes](https://wezterm.org/config/lua/keyassignment/RotatePanes.html).
