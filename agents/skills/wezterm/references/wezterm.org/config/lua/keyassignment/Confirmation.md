---
title: "Confirmation - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/Confirmation"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - Confirmation
      ...
      Table of contents
      * [Example of choosing a program with user confirmation](https://wezterm.org/config/lua/keyassignment/Confirmation.html#example-of-choosing-a-program-with-user-confirmation)
...
# `Confirmation`[¶](https://wezterm.org/config/lua/keyassignment/Confirmation.html#confirmation "Permanent link")
...
* `message` - the text to show for confirmation. You may embed
  escape sequences and/or use [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html).
...
## Example of choosing a program with user confirmation[¶](https://wezterm.org/config/lua/keyassignment/Confirmation.html#example-of-choosing-a-program-with-user-confirmation "Permanent link")
