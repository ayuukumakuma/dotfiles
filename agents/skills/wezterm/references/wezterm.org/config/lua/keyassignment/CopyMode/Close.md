---
title: "Close - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/CopyMode/Close"
...
# CopyMode `Close`[¶](https://wezterm.org/config/lua/keyassignment/CopyMode/Close.html#copymode-close "Permanent link")
