---
title: "SplitPane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SplitPane"
...
# `SplitPane`[¶](https://wezterm.org/config/lua/keyassignment/SplitPane.html#splitpane "Permanent link")
...
* `command` - the [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) that specifies what program to launch into the new pane. If omitted, the [default\_prog](https://wezterm.org/config/lua/config/default_prog.html) is used
...
See also: [SplitHorizontal](https://wezterm.org/config/lua/keyassignment/SplitHorizontal.html), [SplitVertical](https://wezterm.org/config/lua/keyassignment/SplitVertical.html) and `wezterm cli split-pane --help`.
