...
source_url: "https://wezterm.org/config/lua/wezterm.plugin/list"
...
# list function[¶](https://wezterm.org/config/lua/wezterm.plugin/list.html#list-function "Permanent link")
