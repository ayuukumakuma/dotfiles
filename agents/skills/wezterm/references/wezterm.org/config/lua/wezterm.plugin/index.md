---
title: "module: wezterm.plugin - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.plugin/index"
...
* [Available functions](https://wezterm.org/config/lua/wezterm.plugin/index.html#available-functions)

# `wezterm.plugin` module[¶](https://wezterm.org/config/lua/wezterm.plugin/index.html#weztermplugin-module "Permanent link")
...
## Available functions[¶](https://wezterm.org/config/lua/wezterm.plugin/index.html#available-functions "Permanent link")
