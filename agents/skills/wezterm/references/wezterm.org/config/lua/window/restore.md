---
title: "restore - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/restore"
...
# `window:restore()`[¶](https://wezterm.org/config/lua/window/restore.html#windowrestore "Permanent link")
...
See also: [window:maximize()](https://wezterm.org/config/lua/window/maximize.html).
