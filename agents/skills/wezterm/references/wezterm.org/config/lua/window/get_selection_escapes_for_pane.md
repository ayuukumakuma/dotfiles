---
title: "get_selection_escapes_for_pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/get_selection_escapes_for_pane"
...
# `window:get_selection_escapes_for_pane(pane)`[¶](https://wezterm.org/config/lua/window/get_selection_escapes_for_pane.html#windowget_selection_escapes_for_panepane "Permanent link")
...
[window:get\_selection\_text\_for\_pane()](https://wezterm.org/config/lua/window/get_selection_text_for_pane.html) would
...
See also: [window:copy\_to\_clipboard()](https://wezterm.org/config/lua/window/copy_to_clipboard.html).
