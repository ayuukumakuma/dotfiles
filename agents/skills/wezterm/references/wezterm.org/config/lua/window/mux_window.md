---
title: "mux_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/mux_window"
...
# window:mux\_window()[¶](https://wezterm.org/config/lua/window/mux_window.html#windowmux_window "Permanent link")
...
Returns the [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) representation of this window.

This method is the inverse of [mux\_window:gui\_window](https://wezterm.org/config/lua/mux-window/gui_window.html).
