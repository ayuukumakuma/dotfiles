...
source_url: "https://wezterm.org/config/lua/window/active_pane"
...
# `window:active_pane()`[¶](https://wezterm.org/config/lua/window/active_pane.html#windowactive_pane "Permanent link")
...
This is similar to [mux\_window:active\_pane()](https://wezterm.org/config/lua/mux-window/active_pane.html)
