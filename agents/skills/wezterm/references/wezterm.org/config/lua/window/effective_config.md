---
title: "effective_config - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/effective_config"
...
# `window:effective_config()`[¶](https://wezterm.org/config/lua/window/effective_config.html#windoweffective_config "Permanent link")
...
If you want to change the configuration in a window, look at [set\_config\_overrides](https://wezterm.org/config/lua/window/set_config_overrides.html).
