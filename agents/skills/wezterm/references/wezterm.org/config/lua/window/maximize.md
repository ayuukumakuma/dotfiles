---
title: "maximize - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/maximize"
...
# `window:maximize()`[¶](https://wezterm.org/config/lua/window/maximize.html#windowmaximize "Permanent link")
...
Use [window:restore()](https://wezterm.org/config/lua/window/restore.html) to return to the normal/non-maximized state.
