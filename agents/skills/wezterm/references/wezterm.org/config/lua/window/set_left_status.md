---
title: "set_left_status - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/set_left_status"
...
# `window:set_left_status(string)`[¶](https://wezterm.org/config/lua/window/set_left_status.html#windowset_left_statusstring "Permanent link")
...
It is recommended that you use [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html) to
compose the string.

See [window:set\_right\_status](https://wezterm.org/config/lua/window/set_right_status.html) for examples.
