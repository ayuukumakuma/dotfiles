---
title: "get_selection_text_for_pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/get_selection_text_for_pane"
...
# `window:get_selection_text_for_pane(pane)`[¶](https://wezterm.org/config/lua/window/get_selection_text_for_pane.html#windowget_selection_text_for_panepane "Permanent link")
...
clipboard if the [CopyTo](https://wezterm.org/config/lua/keyassignment/CopyTo.html) action were to be
performed.
