---
title: "object: ExecDomain - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/ExecDomain"
...
* Full Config & Lua Reference
  ...
  + object: ExecDomain
    ...
    Table of contents
    - [Defining an ExecDomain](https://wezterm.org/config/lua/ExecDomain.html#defining-an-execdomain)

      * [fixup](https://wezterm.org/config/lua/ExecDomain.html#fixup)
      * [label](https://wezterm.org/config/lua/ExecDomain.html#label)
    - [Example: Running commands in their own systemd scope](https://wezterm.org/config/lua/ExecDomain.html#example-running-commands-in-their-own-systemd-scope)
    - [Example: docker domains](https://wezterm.org/config/lua/ExecDomain.html#example-docker-domains)
...
# ExecDomain[¶](https://wezterm.org/config/lua/ExecDomain.html#execdomain "Permanent link")
...
## Defining an ExecDomain[¶](https://wezterm.org/config/lua/ExecDomain.html#defining-an-execdomain "Permanent link")
...
* *label* - optional. Can be either a string to serve as a label in the
  [Launcher Menu](https://wezterm.org/config/launch.html#the-launcher-menu), or a lua function that will
  return the label.

### fixup[¶](https://wezterm.org/config/lua/ExecDomain.html#fixup "Permanent link")
...
The *cmd* parameter is a [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) that contains
...
### label[¶](https://wezterm.org/config/lua/ExecDomain.html#label "Permanent link")

The label is visible in the [Launcher Menu](https://wezterm.org/config/launch.html#the-launcher-menu).
...
[wezterm.format()](https://wezterm.org/config/lua/wezterm/format.html) to manage that.

## Example: Running commands in their own systemd scope[¶](https://wezterm.org/config/lua/ExecDomain.html#example-running-commands-in-their-own-systemd-scope "Permanent link")
...
## Example: docker domains[¶](https://wezterm.org/config/lua/ExecDomain.html#example-docker-domains "Permanent link")
