---
title: "Key Binding - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/keys"
...
* Configuration
  ...
  + Key Binding
    ...
    Table of contents
    - [Configuring Key Assignments](https://wezterm.org/config/keys.html#configuring-key-assignments)

      * [Physical vs Mapped Key Assignments](https://wezterm.org/config/keys.html#physical-vs-mapped-key-assignments)
      * [Raw Key Assignments](https://wezterm.org/config/keys.html#raw-key-assignments)
      * [Leader Key](https://wezterm.org/config/keys.html#leader-key)
      * [VoidSymbol](https://wezterm.org/config/keys.html#voidsymbol)
    - [Available Actions](https://wezterm.org/config/keys.html#available-actions)
...
## Configuring Key Assignments[¶](https://wezterm.org/config/keys.html#configuring-key-assignments "Permanent link")
...
assignments](https://wezterm.org/config/lua/keyassignment/index.html). Every action has an example that shows
how to use it.
...
* `LEADER` - a special modal modifier state managed by `wezterm`. See [Leader Key](https://wezterm.org/config/keys.html#leader-key) for more information.
...
### Physical vs Mapped Key Assignments[¶](https://wezterm.org/config/keys.html#physical-vs-mapped-key-assignments "Permanent link")
...
*The functionality described in this section requires version 20220408-101518-b908e2dd of wezterm,
or a more recent version.*
...
### Raw Key Assignments[¶](https://wezterm.org/config/keys.html#raw-key-assignments "Permanent link")
...
To discover these values, you can set [debug\_key\_events =
true](https://wezterm.org/config/lua/config/debug_key_events.html) and press the keys of
interest.

You can specify a raw key value of 123 by using `key="raw:123"` in your config
rather than one of the other key values.

### Leader Key[¶](https://wezterm.org/config/keys.html#leader-key "Permanent link")
...
### VoidSymbol[¶](https://wezterm.org/config/keys.html#voidsymbol "Permanent link")
...
# Available Actions[¶](https://wezterm.org/config/keys.html#available-actions "Permanent link")
