---
title: "Colors & Appearance - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/appearance"
...
* Configuration
  ...
  + Colors & Appearance
    ...
    Table of contents
    - [Color Scheme](https://wezterm.org/config/appearance.html#color-scheme)
    - [Precedence of colors vs color\_schemes](https://wezterm.org/config/appearance.html#precedence-of-colors-vs-color_schemes)
    - [Defining your own colors](https://wezterm.org/config/appearance.html#defining-your-own-colors)
    - [Defining a Color Scheme in your .wezterm.lua](https://wezterm.org/config/appearance.html#defining-a-color-scheme-in-your-weztermlua)
    - [Defining a Color Scheme in a separate file](https://wezterm.org/config/appearance.html#defining-a-color-scheme-in-a-separate-file)
    - [Dynamic Color Escape Sequences](https://wezterm.org/config/appearance.html#dynamic-color-escape-sequences)
    - [Tab Bar Appearance & Colors](https://wezterm.org/config/appearance.html#tab-bar-appearance-colors)

      * [Native (Fancy) Tab Bar appearance](https://wezterm.org/config/appearance.html#native-fancy-tab-bar-appearance)
      * [Retro Tab Bar appearance](https://wezterm.org/config/appearance.html#retro-tab-bar-appearance)
    - [Window Padding](https://wezterm.org/config/appearance.html#window-padding)
    - [Styling Inactive Panes](https://wezterm.org/config/appearance.html#styling-inactive-panes)
    - [Window Background Image](https://wezterm.org/config/appearance.html#window-background-image)
    - [Window Background Gradient](https://wezterm.org/config/appearance.html#window-background-gradient)
    - [Window Background Opacity](https://wezterm.org/config/appearance.html#window-background-opacity)
    - [Text Background Opacity](https://wezterm.org/config/appearance.html#text-background-opacity)
...
### Color Scheme[¶](https://wezterm.org/config/appearance.html#color-scheme "Permanent link")
...
in [The Color Schemes Section](https://wezterm.org/colorschemes/index.html).
...
[wezterm.gui.get\_appearance()](https://wezterm.org/config/lua/wezterm.gui/get_appearance.html)
...
### Precedence of `colors` vs `color_schemes`[¶](https://wezterm.org/config/appearance.html#precedence-of-colors-vs-color_schemes "Permanent link")
...
you need to use [wezterm.color.get\_default\_colors()](https://wezterm.org/config/lua/wezterm.color/get_default_colors.html) and explicitly merge them.
...
### Defining your own colors[¶](https://wezterm.org/config/appearance.html#defining-your-own-colors "Permanent link")
...
*The functionality described in this section requires version 20220101-133340-7edc5b5a of wezterm,
or a more recent version.*
...
### Defining a Color Scheme in your `.wezterm.lua`[¶](https://wezterm.org/config/appearance.html#defining-a-color-scheme-in-your-weztermlua "Permanent link")
...
See also [wezterm.get\_builtin\_color\_schemes()](https://wezterm.org/config/lua/wezterm/get_builtin_color_schemes.html) for
some more advanced examples, such as picking a random color scheme, or deriving from a
builting color scheme.

### Defining a Color Scheme in a separate file[¶](https://wezterm.org/config/appearance.html#defining-a-color-scheme-in-a-separate-file "Permanent link")
...
### Dynamic Color Escape Sequences[¶](https://wezterm.org/config/appearance.html#dynamic-color-escape-sequences "Permanent link")
...
[](https://wezterm.org/screenshots/wezterm-dynamic-colors.mp4)

### Tab Bar Appearance & Colors[¶](https://wezterm.org/config/appearance.html#tab-bar-appearance-colors "Permanent link")
...
* [use\_fancy\_tab\_bar](https://wezterm.org/config/lua/config/use_fancy_tab_bar.html) option controls
  which tab bar style is used.
* [enable\_tab\_bar](https://wezterm.org/config/lua/config/enable_tab_bar.html) option control
  whether the tab bar is used at all.
* [hide\_tab\_bar\_if\_only\_one\_tab](https://wezterm.org/config/lua/config/hide_tab_bar_if_only_one_tab.html) option
  causes the tab bar to be hidden when there is only a single tab.
* [tab\_bar\_at\_bottom](https://wezterm.org/config/lua/config/tab_bar_at_bottom.html) places the tab
  bar at the bottom of the window instead of the top
* [tab\_max\_width](https://wezterm.org/config/lua/config/tab_max_width.html) sets the maximum width, measured in cells,
  of a given tab when using retro tab mode.

#### Native (Fancy) Tab Bar appearance[¶](https://wezterm.org/config/appearance.html#native-fancy-tab-bar-appearance "Permanent link")
...
#### Retro Tab Bar appearance[¶](https://wezterm.org/config/appearance.html#retro-tab-bar-appearance "Permanent link")
...
### Window Padding[¶](https://wezterm.org/config/appearance.html#window-padding "Permanent link")

You may add padding around the edges of the terminal area.

[See the window\_padding docs for more info](https://wezterm.org/config/lua/config/window_padding.html)

## Styling Inactive Panes[¶](https://wezterm.org/config/appearance.html#styling-inactive-panes "Permanent link")

*Since: Version 20201031-154415-9614e117*

*The functionality described in this section requires version 20201031-154415-9614e117 of wezterm,
or a more recent version.*
...
## Window Background Image[¶](https://wezterm.org/config/appearance.html#window-background-image "Permanent link")

![Screenshot](https://wezterm.org/screenshots/wezterm-vday-screenshot.png)
...
See [Styling Inactive Panes](https://wezterm.org/config/appearance.html#styling-inactive-panes) for more information
...
[background](https://wezterm.org/config/lua/config/background.html) configuration option.

## Window Background Gradient[¶](https://wezterm.org/config/appearance.html#window-background-gradient "Permanent link")

*Since: Version 20210814-124438-54e29167*

*The functionality described in this section requires version 20210814-124438-54e29167 of wezterm,
or a more recent version.*

![Gradient](https://wezterm.org/screenshots/radial-gradient.png)

See [window\_background\_gradient](https://wezterm.org/config/lua/config/window_background_gradient.html)
for configuration information on gradients.

## Window Background Opacity[¶](https://wezterm.org/config/appearance.html#window-background-opacity "Permanent link")
...
## Text Background Opacity[¶](https://wezterm.org/config/appearance.html#text-background-opacity "Permanent link")
