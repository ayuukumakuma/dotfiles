---
title: "Use hyperlinks directly in the terminal - Wez's Terminal Emulator"
source_url: "https://wezterm.org/recipes/hyperlinks"
...
* Configuration
  ...
  + [Recipes](https://wezterm.org/recipes/index.html)
    ...
    - Use hyperlinks directly in the terminal
      ...
      Table of contents
      * [Requirements](https://wezterm.org/recipes/hyperlinks.html#requirements)
      * [Configuration](https://wezterm.org/recipes/hyperlinks.html#configuration)
      * [Optional configuration](https://wezterm.org/recipes/hyperlinks.html#optional-configuration)
      * [Drawbacks](https://wezterm.org/recipes/hyperlinks.html#drawbacks)
...
# Use hyperlinks directly in the terminal[¶](https://wezterm.org/recipes/hyperlinks.html#use-hyperlinks-directly-in-the-terminal "Permanent link")
...
## Requirements[¶](https://wezterm.org/recipes/hyperlinks.html#requirements "Permanent link")
...
## Configuration[¶](https://wezterm.org/recipes/hyperlinks.html#configuration "Permanent link")
...
## Optional configuration[¶](https://wezterm.org/recipes/hyperlinks.html#optional-configuration "Permanent link")
...
Check the [mouse bindings](https://wezterm.org/config/mouse.html) section for examples on modifying the `OpenLinkAtMouseCursor` action.
...
## Drawbacks[¶](https://wezterm.org/recipes/hyperlinks.html#drawbacks "Permanent link")
...
(see [bypass mouse reporting modifiers](https://wezterm.org/config/lua/config/bypass_mouse_reporting_modifiers.html)), add `Shift` when clicking an hyperlink.
