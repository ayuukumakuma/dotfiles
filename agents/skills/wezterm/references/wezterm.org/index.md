---
title: "WezTerm - Wez's Terminal Emulator"
source_url: "https://wezterm.org/index"
...
* [Features](https://wezterm.org/index.html#features)

# WezTerm

*WezTerm is a powerful cross-platform terminal emulator and multiplexer written by [[@wez](https://github.com/wez "GitHub User: wez")](https://github.com/wez/) and implemented in [Rust](https://www.rust-lang.org/)*

![Screenshot](https://wezterm.org/screenshots/wezterm-vday-screenshot.png)

[Download](https://wezterm.org/installation.html)

## Features[¶](https://wezterm.org/index.html#features "Permanent link")
...
* [Hyperlinks](https://wezterm.org/hyperlinks.html)
* [A full list of features can be found here](https://wezterm.org/features.html)

Looking for a [configuration reference?](https://wezterm.org/config/files.html)

**These docs are searchable: press `S` or click on the magnifying glass icon
to activate the search function!**

![Screenshot](https://wezterm.org/screenshots/two.png)
