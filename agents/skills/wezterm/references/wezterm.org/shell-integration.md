---
title: "Shell Integration - Wez's Terminal Emulator"
source_url: "https://wezterm.org/shell-integration"
...
* [WezTerm](https://wezterm.org/index.html)
  ...
  + Shell Integration
    ...
    Table of contents
    - [User Vars](https://wezterm.org/shell-integration.html#user-vars)
    - [OSC 7 Escape sequence to set the working directory](https://wezterm.org/shell-integration.html#osc-7-escape-sequence-to-set-the-working-directory)
    - [OSC 7 on Windows with cmd.exe](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-cmdexe)
    - [OSC 7 on Windows with powershell](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-powershell)
    - [OSC 7 on Windows with powershell (with starship)](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-powershell-with-starship)
    - [Using Clink on Windows Systems](https://wezterm.org/shell-integration.html#using-clink-on-windows-systems)
...
as the current pane, [jumping through the scrollback to the start of an earlier command](https://wezterm.org/config/lua/keyassignment/ScrollToPrompt.html),
or [conveniently selecting the complete output from a command](https://wezterm.org/config/lua/keyassignment/SelectTextAtMouseCursor.html).
...
## User Vars[¶](https://wezterm.org/shell-integration.html#user-vars "Permanent link")
...
## OSC 7 Escape sequence to set the working directory[¶](https://wezterm.org/shell-integration.html#osc-7-escape-sequence-to-set-the-working-directory "Permanent link")
...
## OSC 7 on Windows with cmd.exe[¶](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-cmdexe "Permanent link")
...
## OSC 7 on Windows with powershell[¶](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-powershell "Permanent link")
...
## OSC 7 on Windows with powershell (with starship)[¶](https://wezterm.org/shell-integration.html#osc-7-on-windows-with-powershell-with-starship "Permanent link")
...
## Using Clink on Windows Systems[¶](https://wezterm.org/shell-integration.html#using-clink-on-windows-systems "Permanent link")
