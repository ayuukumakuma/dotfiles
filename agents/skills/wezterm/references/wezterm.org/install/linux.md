---
title: "Linux - Wez's Terminal Emulator"
source_url: "https://wezterm.org/install/linux"
...
* Download
  ...
  + Linux
    ...
    Table of contents
    - [Installing on Linux via Flathub](https://wezterm.org/install/linux.html#installing-on-linux-via-flathub)
    - [Installing on Linux using AppImage](https://wezterm.org/install/linux.html#installing-on-linux-using-appimage)
    - [Using the APT repo](https://wezterm.org/install/linux.html#using-the-apt-repo)
    - [Pre-built .deb packages](https://wezterm.org/install/linux.html#pre-built-deb-packages)
    - [Installing on Fedora and rpm-based Systems via Copr](https://wezterm.org/install/linux.html#installing-on-fedora-and-rpm-based-systems-via-copr)
    - [Fedora Atomic Desktops (Silverblue, Kinoite) specific](https://wezterm.org/install/linux.html#fedora-atomic-desktops-silverblue-kinoite-specific)
    - [openSUSE specific](https://wezterm.org/install/linux.html#opensuse-specific)
    - [Update](https://wezterm.org/install/linux.html#update)
    - [Installing on Fedora and rpm-based Systems](https://wezterm.org/install/linux.html#installing-on-fedora-and-rpm-based-systems)
    - [openSUSE](https://wezterm.org/install/linux.html#opensuse)
    - [openSUSE Tumbleweed/Slowroll](https://wezterm.org/install/linux.html#opensuse-tumbleweedslowroll)
    - [openSUSE Leap](https://wezterm.org/install/linux.html#opensuse-leap)
    - [Arch Linux](https://wezterm.org/install/linux.html#arch-linux)
    - [Linuxbrew Tap](https://wezterm.org/install/linux.html#linuxbrew-tap)
    - [Nix](https://wezterm.org/install/linux.html#nix)

      * [Flake](https://wezterm.org/install/linux.html#flake)
      * [Cachix](https://wezterm.org/install/linux.html#cachix)
    - [Raw Linux Binary](https://wezterm.org/install/linux.html#raw-linux-binary)
...
FlatpakAppImageUbuntu/DebianCoprFedora/RPMopenSUSEArchLinuxbrewNix/NixOSRaw

## Installing on Linux via Flathub[¶](https://wezterm.org/install/linux.html#installing-on-linux-via-flathub "Permanent link")
...
[![Download on Flathub](https://flathub.org/assets/badges/flathub-badge-en.png)](https://flathub.org/apps/details/org.wezfurlong.wezterm)
...
## Installing on Linux using AppImage[¶](https://wezterm.org/install/linux.html#installing-on-linux-using-appimage "Permanent link")
...
[AppImage](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/WezTerm-20240203-110809-5046fc22-Ubuntu20.04.AppImage)
[Nightly AppImage](https://github.com/wezterm/wezterm/releases/download/nightly/WezTerm-nightly-Ubuntu20.04.AppImage)
...
* Configuration instructions can be [found here](https://wezterm.org/config/files.html)

## Using the APT repo[¶](https://wezterm.org/install/linux.html#using-the-apt-repo "Permanent link")
...
## Pre-built `.deb` packages[¶](https://wezterm.org/install/linux.html#pre-built-deb-packages "Permanent link")
...
| --- | --- | --- | --- | --- |
| Ubuntu20 | [amd64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Ubuntu20.04.deb) |  | [amd64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu20.04.deb) |  |
| Ubuntu22 | [amd64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Ubuntu22.04.deb) | [arm64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Ubuntu22.04.arm64.deb) | [amd64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu22.04.deb) | [arm64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu22.04.arm64.deb) |
| Ubuntu24 | Nightly Only | Nightly Only | [amd64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu24.04.deb) | [arm64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu24.04.arm64.deb) |
| Debian11 | [amd64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Debian11.deb) |  | [amd64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Debian11.deb) |  |
| Debian12 | [amd64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Debian12.deb) | [arm64](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Debian12.arm64.deb) | [amd64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Debian12.deb) | [arm64](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Debian12.arm64.deb) |
...
## Installing on Fedora and rpm-based Systems via Copr[¶](https://wezterm.org/install/linux.html#installing-on-fedora-and-rpm-based-systems-via-copr "Permanent link")
...
## Fedora Atomic Desktops (Silverblue, Kinoite) specific[¶](https://wezterm.org/install/linux.html#fedora-atomic-desktops-silverblue-kinoite-specific "Permanent link")
...
## openSUSE specific[¶](https://wezterm.org/install/linux.html#opensuse-specific "Permanent link")
...
## Update[¶](https://wezterm.org/install/linux.html#update "Permanent link")

```
$ sudo dnf update wezterm
```

## Installing on Fedora and rpm-based Systems[¶](https://wezterm.org/install/linux.html#installing-on-fedora-and-rpm-based-systems "Permanent link")
...
| Distro | Stable | Nightly |
| --- | --- | --- |
| CentOS8 | [wezterm-20240203\_110809\_5046fc22-1.centos8.x86\_64.rpm](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.centos8.x86_64.rpm) | No longer supported |
| CentOS9 | [wezterm-20240203\_110809\_5046fc22-1.centos9.x86\_64.rpm](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.centos9.x86_64.rpm) | [wezterm-nightly-centos9.rpm](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly-centos9.rpm) |
| Fedora37 | [wezterm-20240203\_110809\_5046fc22-1.fedora37.x86\_64.rpm](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.fedora37.x86_64.rpm) | No longer supported |
| Fedora38 | [wezterm-20240203\_110809\_5046fc22-1.fedora38.x86\_64.rpm](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.fedora38.x86_64.rpm) | No longer supported |
| Fedora39 | [wezterm-20240203\_110809\_5046fc22-1.fedora39.x86\_64.rpm](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203_110809_5046fc22-1.fedora39.x86_64.rpm) | [wezterm-nightly-fedora39.rpm](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly-fedora39.rpm) |
| Fedora40 | Nightly only | [wezterm-nightly-fedora40.rpm](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly-fedora40.rpm) |
...
## openSUSE[¶](https://wezterm.org/install/linux.html#opensuse "Permanent link")
...
## openSUSE Tumbleweed/Slowroll[¶](https://wezterm.org/install/linux.html#opensuse-tumbleweedslowroll "Permanent link")
...
## openSUSE Leap[¶](https://wezterm.org/install/linux.html#opensuse-leap "Permanent link")

Use Copr or build if from source.

## Arch Linux[¶](https://wezterm.org/install/linux.html#arch-linux "Permanent link")
...
## Linuxbrew Tap[¶](https://wezterm.org/install/linux.html#linuxbrew-tap "Permanent link")
...
## Nix[¶](https://wezterm.org/install/linux.html#nix "Permanent link")
...
binary being available in `$PATH` during the *evaluation* phase (before building packages).
...
### Flake[¶](https://wezterm.org/install/linux.html#flake "Permanent link")
...
### Cachix[¶](https://wezterm.org/install/linux.html#cachix "Permanent link")
...
## Raw Linux Binary[¶](https://wezterm.org/install/linux.html#raw-linux-binary "Permanent link")
...
[Raw Linux Binary](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/wezterm-20240203-110809-5046fc22.Ubuntu20.04.tar.xz)
[Nightly Raw Linux Binary](https://github.com/wezterm/wezterm/releases/download/nightly/wezterm-nightly.Ubuntu20.04.tar.xz)
