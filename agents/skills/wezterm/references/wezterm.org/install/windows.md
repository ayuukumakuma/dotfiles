---
title: "Windows - Wez's Terminal Emulator"
source_url: "https://wezterm.org/install/windows"
...
* Download
  ...
  + Windows
    ...
    Table of contents
    - [Installing on Windows](https://wezterm.org/install/windows.html#installing-on-windows)

      * [For winget users](https://wezterm.org/install/windows.html#for-winget-users)
      * [For Scoop users](https://wezterm.org/install/windows.html#for-scoop-users)
      * [For Chocolatey users](https://wezterm.org/install/windows.html#for-chocolatey-users)
...
## Installing on Windows[¶](https://wezterm.org/install/windows.html#installing-on-windows "Permanent link")
...
[Windows (setup.exe)](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/WezTerm-20240203-110809-5046fc22-setup.exe)
 [Nightly Windows (setup.exe)](https://github.com/wezterm/wezterm/releases/download/nightly/WezTerm-nightly-setup.exe)
...
[Windows (zip)](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/WezTerm-windows-20240203-110809-5046fc22.zip)
 [Nightly Windows (zip)](https://github.com/wezterm/wezterm/releases/download/nightly/WezTerm-windows-nightly.zip)
...
1. Download [Release](https://github.com/wezterm/wezterm/releases/download/20240203-110809-5046fc22/WezTerm-windows-20240203-110809-5046fc22.zip)
2. Extract the zipfile and double-click `wezterm.exe` to run the UI
3. Configuration instructions can be [found here](https://wezterm.org/config/files.html)

### For `winget` users[¶](https://wezterm.org/install/windows.html#for-winget-users "Permanent link")
...
### For `Scoop` users[¶](https://wezterm.org/install/windows.html#for-scoop-users "Permanent link")
...
### For `Chocolatey` users[¶](https://wezterm.org/install/windows.html#for-chocolatey-users "Permanent link")
