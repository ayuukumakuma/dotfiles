---
title: "FreeBSD - Wez's Terminal Emulator"
source_url: "https://wezterm.org/install/freebsd"
...
* Download
  ...
  + FreeBSD
    ...
    Table of contents
    - [Installing on FreeBSD](https://wezterm.org/install/freebsd.html#installing-on-freebsd)
...
## Installing on FreeBSD[¶](https://wezterm.org/install/freebsd.html#installing-on-freebsd "Permanent link")
...
you need to run a newer version, then the [build from source](https://wezterm.org/install/source.html)
