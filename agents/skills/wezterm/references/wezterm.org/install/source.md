---
title: "Build from source - Wez's Terminal Emulator"
source_url: "https://wezterm.org/install/source"
...
* Download
  ...
  + Build from source
    ...
    Table of contents
    - [Installing from source](https://wezterm.org/install/source.html#installing-from-source)

      * [Building without Wayland support on Unix systems](https://wezterm.org/install/source.html#building-without-wayland-support-on-unix-systems)
      * [Building on Windows](https://wezterm.org/install/source.html#building-on-windows)
* Configuration
...
## Installing from source[¶](https://wezterm.org/install/source.html#installing-from-source "Permanent link")
...
### Building without Wayland support on Unix systems[¶](https://wezterm.org/install/source.html#building-without-wayland-support-on-unix-systems "Permanent link")
...
### Building on Windows[¶](https://wezterm.org/install/source.html#building-on-windows "Permanent link")
