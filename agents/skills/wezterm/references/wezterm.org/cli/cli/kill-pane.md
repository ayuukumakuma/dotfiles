---
title: "kill-pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/kill-pane"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - kill-pane
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/kill-pane.html#synopsis)
...
# `wezterm cli kill-pane`[¶](https://wezterm.org/cli/cli/kill-pane.html#wezterm-cli-kill-pane "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/kill-pane.html#synopsis "Permanent link")

```
Kill a pane

Usage: wezterm cli kill-pane [OPTIONS]
