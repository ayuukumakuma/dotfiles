---
title: "move-pane-to-new-tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/move-pane-to-new-tab"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - move-pane-to-new-tab
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/move-pane-to-new-tab.html#synopsis)
...
# `wezterm cli move-pane-to-new-tab`[¶](https://wezterm.org/cli/cli/move-pane-to-new-tab.html#wezterm-cli-move-pane-to-new-tab "Permanent link")
...
* `--pane-id` - Specifies which pane to move. See also [Targeting Panes](https://wezterm.org/cli/cli/index.html#targeting-panes).

See also: [pane:move\_to\_new\_window()](https://wezterm.org/config/lua/pane/move_to_new_window.html),
[pane:move\_to\_new\_tab()](https://wezterm.org/config/lua/pane/move_to_new_tab.html).

## Synopsis[¶](https://wezterm.org/cli/cli/move-pane-to-new-tab.html#synopsis "Permanent link")
