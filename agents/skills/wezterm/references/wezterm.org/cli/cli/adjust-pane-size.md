---
title: "adjust-pane-size - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/adjust-pane-size"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - adjust-pane-size
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/adjust-pane-size.html#synopsis)
...
# `wezterm cli adjust-pane-size DIRECTION`[¶](https://wezterm.org/cli/cli/adjust-pane-size.html#wezterm-cli-adjust-pane-size-direction "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/adjust-pane-size.html#synopsis "Permanent link")
