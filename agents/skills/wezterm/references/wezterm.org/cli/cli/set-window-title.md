---
title: "set-window-title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/set-window-title"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - set-window-title
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/set-window-title.html#synopsis)
...
# `wezterm cli set-window-title TITLE`[¶](https://wezterm.org/cli/cli/set-window-title.html#wezterm-cli-set-window-title-title "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/set-window-title.html#synopsis "Permanent link")
