---
title: "set-tab-title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/set-tab-title"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - set-tab-title
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/set-tab-title.html#synopsis)
...
# `wezterm cli set-tab-title TITLE`[¶](https://wezterm.org/cli/cli/set-tab-title.html#wezterm-cli-set-tab-title-title "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/set-tab-title.html#synopsis "Permanent link")
