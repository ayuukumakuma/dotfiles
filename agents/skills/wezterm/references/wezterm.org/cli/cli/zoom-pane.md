---
title: "zoom-pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/zoom-pane"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - zoom-pane
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/zoom-pane.html#synopsis)
...
# `wezterm cli zoom-pane`[¶](https://wezterm.org/cli/cli/zoom-pane.html#wezterm-cli-zoom-pane "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/zoom-pane.html#synopsis "Permanent link")
