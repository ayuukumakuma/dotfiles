---
title: "activate-tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/activate-tab"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - activate-tab
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/activate-tab.html#synopsis)
...
# `wezterm cli activate-tab`[¶](https://wezterm.org/cli/cli/activate-tab.html#wezterm-cli-activate-tab "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/activate-tab.html#synopsis "Permanent link")
