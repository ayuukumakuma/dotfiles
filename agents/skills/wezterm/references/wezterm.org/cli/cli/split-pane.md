---
title: "split-pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/split-pane"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - split-pane
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/split-pane.html#synopsis)
...
# `wezterm cli split-pane`[¶](https://wezterm.org/cli/cli/split-pane.html#wezterm-cli-split-pane "Permanent link")
...
* `--pane-id` - Specifies the pane that should be split. See also [Targeting Panes](https://wezterm.org/cli/cli/index.html#targeting-panes).
...
## Synopsis[¶](https://wezterm.org/cli/cli/split-pane.html#synopsis "Permanent link")
