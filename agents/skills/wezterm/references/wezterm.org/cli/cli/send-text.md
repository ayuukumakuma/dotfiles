---
title: "send-text - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/send-text"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - send-text
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/send-text.html#synopsis)
...
# `wezterm cli send-text`[¶](https://wezterm.org/cli/cli/send-text.html#wezterm-cli-send-text "Permanent link")
...
* `--no-paste` - Send the text directly, rather than as a bracketed paste. (*Since: Version 20220624-141144-bd1b7c5d*)
* `--pane-id` - Specifies which pane to send the text to. See also [Targeting Panes](https://wezterm.org/cli/cli/index.html#targeting-panes).

## Synopsis[¶](https://wezterm.org/cli/cli/send-text.html#synopsis "Permanent link")
