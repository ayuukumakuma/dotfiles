---
title: "activate-pane-direction - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/activate-pane-direction"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - activate-pane-direction
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/activate-pane-direction.html#synopsis)
...
# `wezterm cli activate-pane-direction DIRECTION`[¶](https://wezterm.org/cli/cli/activate-pane-direction.html#wezterm-cli-activate-pane-direction-direction "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/activate-pane-direction.html#synopsis "Permanent link")
