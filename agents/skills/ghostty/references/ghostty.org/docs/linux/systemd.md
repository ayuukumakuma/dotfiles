...
source_url: "https://ghostty.org/docs/linux/systemd"
...
* [Systemd and D-Bus](https://ghostty.org/docs/linux/systemd.html)
...
If properly installed[1](https://ghostty.org/docs/linux/systemd.html#user-content-fn-1), Ghostty comes with several systemd units.
...
systemd integrations are: instantaneous launching[2](https://ghostty.org/docs/linux/systemd.html#user-content-fn-2) and centralized
logging.

If you are on a system with `systemd` and you installed Ghostty
via a system package or [as documented](https://ghostty.org/docs/install/build.html),
then Ghostty should *just work*. You don't have to read this
...
> their running processes *without asking for confirmation*. This may cause data
> or state loss.

### Relevant Files

If properly installed [1](https://ghostty.org/docs/linux/systemd.html#user-content-fn-1), Ghostty will come with several configuration
...
1. "Properly installed" means via a package that followed our
   packaging guidelines or from source in `$HOME/.local`. [↩](https://ghostty.org/docs/linux/systemd.html#user-content-fnref-1) [↩2](https://ghostty.org/docs/linux/systemd.html#user-content-fnref-1-2)
2. "Instantaneous" is hyperbolic, of course. Practically speaking,
   ...
   but the relative increase should be noticeable on all systems. [↩](https://ghostty.org/docs/linux/systemd.html#user-content-fnref-2)



[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/linux/systemd.mdx)

* [Starting Ghostty at Login](https://ghostty.org/docs/linux/systemd.html#starting-ghostty-at-login)
* [Reloading the Config](https://ghostty.org/docs/linux/systemd.html#reloading-the-config)
* [Scripting New Windows](https://ghostty.org/docs/linux/systemd.html#scripting-new-windows)
* [Hyprland](https://ghostty.org/docs/linux/systemd.html#hyprland)
* [How Launching Works](https://ghostty.org/docs/linux/systemd.html#how-launching-works)
* [Ghostty is Already Running](https://ghostty.org/docs/linux/systemd.html#ghostty-is-already-running)
* [Ghostty is Not Running](https://ghostty.org/docs/linux/systemd.html#ghostty-is-not-running)
* [Other](https://ghostty.org/docs/linux/systemd.html#other)
* [Logs](https://ghostty.org/docs/linux/systemd.html#logs)
* [Status](https://ghostty.org/docs/linux/systemd.html#status)
* [Stopping](https://ghostty.org/docs/linux/systemd.html#stopping)
* [Relevant Files](https://ghostty.org/docs/linux/systemd.html#relevant-files)
* [Dev Builds](https://ghostty.org/docs/linux/systemd.html#dev-builds)
