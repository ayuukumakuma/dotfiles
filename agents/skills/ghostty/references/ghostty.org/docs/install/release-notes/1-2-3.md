...
source_url: "https://ghostty.org/docs/install/release-notes/1-2-3"
...
* [1.2.3](https://ghostty.org/docs/install/release-notes/1-2-3.html)
...
This addresses all currently known font *rendering* issues, particularly
...
* font: Numerous tweaks to improve various edge cases, especially around
  icon glyphs. [#9076](https://github.com/ghostty-org/ghostty/issues/9076)  [#9142](https://github.com/ghostty-org/ghostty/issues/9142)  [#9160](https://github.com/ghostty-org/ghostty/issues/9160)  [#9152](https://github.com/ghostty-org/ghostty/issues/9152)
...
* input: modify other keys 2 should use all mods, ignore consumed mods.
  ...
  [#9289](https://github.com/ghostty-org/ghostty/issues/9289)
* Fix a deadlock scenario where programs that emit many color change
  or query operations could cause Ghostty to hang. [#9224](https://github.com/ghostty-org/ghostty/issues/9224)
* Fix a resource leak by not starting the scroll timer when scrolling
  outside the viewport if the scroll timer is already active. [#9195](https://github.com/ghostty-org/ghostty/issues/9195)
* Fix memory corruption that could happen when starting a scroll in
  ...
  program switched screens. [#9223](https://github.com/ghostty-org/ghostty/issues/9223)
...
* macOS: `goto_split` direction is now compatible with `performable:` bindings.
  [#9283](https://github.com/ghostty-org/ghostty/issues/9283)  [#9284](https://github.com/ghostty-org/ghostty/issues/9284)
...
* macOS: Fixed multiple `macos-titlebar-style=tabs` related issues. [#1787](https://github.com/ghostty-org/ghostty/issues/1787)
  [#1813](https://github.com/ghostty-org/ghostty/issues/1813)  [#1945](https://github.com/ghostty-org/ghostty/issues/1945)  [#8612](https://github.com/ghostty-org/ghostty/issues/8612)  [#9090](https://github.com/ghostty-org/ghostty/issues/9090)  [#9163](https://github.com/ghostty-org/ghostty/issues/9163)
* macOS: New Tab action now reliably opens tab instead of window when
  appropriate. [#9124](https://github.com/ghostty-org/ghostty/issues/9124)
...
* A new `-Demit-themes` (default true) build option has been added to
  ...
  [#9288](https://github.com/ghostty-org/ghostty/issues/9288)
...
* [Highlights](https://ghostty.org/docs/install/release-notes/1-2-3.html#highlights)
* [macOS Titlebar Tabs Improvements](https://ghostty.org/docs/install/release-notes/1-2-3.html#macos-titlebar-tabs-improvements)
* [Font Rendering Improvements](https://ghostty.org/docs/install/release-notes/1-2-3.html#font-rendering-improvements)
* [Full Changelog](https://ghostty.org/docs/install/release-notes/1-2-3.html#full-changelog)
* [macOS](https://ghostty.org/docs/install/release-notes/1-2-3.html#macos)
* [GTK (Linux, FreeBSD)](https://ghostty.org/docs/install/release-notes/1-2-3.html#gtk-(linux-freebsd))
* [Changes for Package Maintainers](https://ghostty.org/docs/install/release-notes/1-2-3.html#changes-for-package-maintainers)
* [Roadmap](https://ghostty.org/docs/install/release-notes/1-2-3.html#roadmap)
