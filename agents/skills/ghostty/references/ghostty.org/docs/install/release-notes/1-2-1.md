...
source_url: "https://ghostty.org/docs/install/release-notes/1-2-1"
...
* [1.2.1](https://ghostty.org/docs/install/release-notes/1-2-1.html)
...
* Ghostty now limits builds to 32 cores on Linux to workaround a known
  ...
  [#8925](https://github.com/ghostty-org/ghostty/issues/8925)
...
See the roadmap from the [1.2.0 release notes](https://ghostty.org/docs/install/release-notes/1-2-0.html#roadmap)
...
* [Highlights](https://ghostty.org/docs/install/release-notes/1-2-1.html#highlights)
* [Font Rendering Improvements](https://ghostty.org/docs/install/release-notes/1-2-1.html#font-rendering-improvements)
* [Shell Integration Adds ghostty to PATH](https://ghostty.org/docs/install/release-notes/1-2-1.html#shell-integration-adds-ghostty-to-path)
* [Mouse Scroll Multiplier for Precision Scrolling Devices](https://ghostty.org/docs/install/release-notes/1-2-1.html#mouse-scroll-multiplier-for-precision-scrolling-devices)
* [Full Changelog](https://ghostty.org/docs/install/release-notes/1-2-1.html#full-changelog)
* [macOS](https://ghostty.org/docs/install/release-notes/1-2-1.html#macos)
* [GTK (Linux, FreeBSD)](https://ghostty.org/docs/install/release-notes/1-2-1.html#gtk-(linux-freebsd))
* [Changes for Package Maintainers](https://ghostty.org/docs/install/release-notes/1-2-1.html#changes-for-package-maintainers)
* [Roadmap](https://ghostty.org/docs/install/release-notes/1-2-1.html#roadmap)
