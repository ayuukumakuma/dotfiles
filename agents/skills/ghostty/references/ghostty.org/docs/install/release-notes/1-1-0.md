...
source_url: "https://ghostty.org/docs/install/release-notes/1-1-0"
...
* [1.1.0](https://ghostty.org/docs/install/release-notes/1-1-0.html)
...
[![](https://ghostty.org/images/1-1-0/csd.png)](https://ghostty.org/images/1-1-0/csd.png)[![](https://ghostty.org/images/1-1-0/ssd.png)](https://ghostty.org/images/1-1-0/ssd.png)
...
> See [the dedication section](https://ghostty.org/docs/install/release-notes/1-1-0.html#gtk:-forcing-a-dependency-on-libadwaita) for more
> details.
...
![](https://ghostty.org/images/1-1-0/srgb_blending.png)![](https://ghostty.org/images/1-1-0/p3_blending.png)![](https://ghostty.org/images/1-1-0/linear_blending.png)![](https://ghostty.org/images/1-1-0/linear-corrected_blending.png)
...
* Add the new `performable:` prefix to keybindings to only consume
  ...
  ["Performable" Keybindings](https://ghostty.org/docs/install/release-notes/1-1-0.html#%22performable%22-keybindings).
  [#4328](https://github.com/ghostty-org/ghostty/pull/4328)
...
* macOS: Consistent and correct alpha blending for correct colors.
  ...
  See [macOS Alpha Blending Improvements](https://ghostty.org/docs/install/release-notes/1-1-0.html#macos-alpha-blending-improvements).
  [#4913](https://github.com/ghostty-org/ghostty/pull/4913)
...
* GTK: Support for server-side decorations (SSD) has been added.
  ...
  See [Server Side Decorations (SSD) on Linux](https://ghostty.org/docs/install/release-notes/1-1-0.html#server-side-decorations-(ssd)-on-linux).
  [#4630](https://github.com/ghostty-org/ghostty/pull/4630)
...
* Build: Terminfo/Termcap sources are no longer installed by default.
  Note the *compiled* version is still properly installed so the terminfo
...
[explicit SSD support](https://ghostty.org/docs/install/release-notes/1-1-0.html#server-side-decorations-(ssd)-on-linux)
...
[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/install/release-notes/1-1-0.mdx)

* [Security](https://ghostty.org/docs/install/release-notes/1-1-0.html#security)
* [Highlights](https://ghostty.org/docs/install/release-notes/1-1-0.html#highlights)
* [Server Side Decorations (SSD) on Linux](https://ghostty.org/docs/install/release-notes/1-1-0.html#server-side-decorations-(ssd)-on-linux)
* [Input Method Editor (IME) Improvements](https://ghostty.org/docs/install/release-notes/1-1-0.html#input-method-editor-(ime)-improvements)
* ["Performable" Keybindings](https://ghostty.org/docs/install/release-notes/1-1-0.html#"performable"-keybindings)
* [macOS: Alpha Blending Improvements](https://ghostty.org/docs/install/release-notes/1-1-0.html#macos:-alpha-blending-improvements)
* [macOS: Quick Terminal Improvements](https://ghostty.org/docs/install/release-notes/1-1-0.html#macos:-quick-terminal-improvements)
* [Full List](https://ghostty.org/docs/install/release-notes/1-1-0.html#full-list)
* [macOS](https://ghostty.org/docs/install/release-notes/1-1-0.html#macos)
* [Linux (GTK)](https://ghostty.org/docs/install/release-notes/1-1-0.html#linux-(gtk))
* [Changes for Package Maintainers](https://ghostty.org/docs/install/release-notes/1-1-0.html#changes-for-package-maintainers)
* [Roadmap](https://ghostty.org/docs/install/release-notes/1-1-0.html#roadmap)
* [GTK: Forcing a Dependency on libadwaita](https://ghostty.org/docs/install/release-notes/1-1-0.html#gtk:-forcing-a-dependency-on-libadwaita)
