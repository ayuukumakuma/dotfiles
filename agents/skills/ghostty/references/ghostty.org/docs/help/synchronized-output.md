---
title: "Synchronized Output - Help"
source_url: "https://ghostty.org/docs/help/synchronized-output"
...
* [Synchronized Output](https://ghostty.org/docs/help/synchronized-output.html)
...
to upstream developers with a link to the ["For developers"](https://ghostty.org/docs/help/synchronized-output.html#for-developers)
section of this page, so that they know how to fix the underlying problem.

Programs known to be affected by this include:

* Claude Code ([#8176](https://github.com/ghostty-org/ghostty/discussions/8176), [#8285](https://github.com/ghostty-org/ghostty/discussions/8285))
* Docker CLI ([#5493](https://github.com/ghostty-org/ghostty/discussions/5493), [#5657](https://github.com/ghostty-org/ghostty/discussions/5657), [#8162](https://github.com/ghostty-org/ghostty/discussions/8162))
* Ollama ([#4048](https://github.com/ghostty-org/ghostty/discussions/4048))
* Grok ([#9618](https://github.com/ghostty-org/ghostty/discussions/9618))

## For developers

If you're a developer of a CLI or TUI-based app that has this issue, you
need to implement the [Synchronized Output](https://github.com/contour-terminal/vt-extensions/blob/1a9fde53d80c4a60b1be44c5a4492d86ec9f9cce/synchronized-output.md) protocol which signals Ghostty
...
cursor to the part to be updated by using [Cursor Position (CUP)](https://ghostty.org/docs/vt/csi/cup.html), update the
cells, and erase the rest of the line using [Erase in Line (EL)](https://ghostty.org/docs/vt/csi/el.html). This not
...
[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/help/synchronized-output.mdx)
