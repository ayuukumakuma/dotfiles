---
title: "Configuring Languages | Language Server and Tree-sitter Config - Zed"
source_url: "https://zed.dev/docs/configuring-languages?"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Configuring Supported Languages](https://zed.dev/docs/configuring-languages%3F.html#configuring-supported-languages)
...
For a list of supported languages, see [Supported Languages](https://zed.dev/docs/languages.html). To add support for new languages, see [Language Extensions](https://zed.dev/docs/extensions/languages.html).

## [Language-specific Settings](https://zed.dev/docs/configuring-languages%3F.html#language-specific-settings)
...
* [`tab_size`](https://zed.dev/docs/reference/all-settings.html#tab-size): The number of spaces for each indentation level
* [`formatter`](https://zed.dev/docs/reference/all-settings.html#formatter): The tool used for code formatting
* [`format_on_save`](https://zed.dev/docs/reference/all-settings.html#format-on-save): Whether to automatically format code when saving
* [`enable_language_server`](https://zed.dev/docs/reference/all-settings.html#enable-language-server): Toggle language server support
* [`hard_tabs`](https://zed.dev/docs/reference/all-settings.html#hard-tabs): Use tabs instead of spaces for indentation
* [`preferred_line_length`](https://zed.dev/docs/reference/all-settings.html#preferred-line-length): The recommended maximum line length
* [`soft_wrap`](https://zed.dev/docs/reference/all-settings.html#soft-wrap): How to wrap long lines of code
* [`show_completions_on_input`](https://zed.dev/docs/reference/all-settings.html#show-completions-on-input): Whether or not to show completions as you type
* [`show_completion_documentation`](https://zed.dev/docs/reference/all-settings.html#show-completion-documentation): Whether to display inline and alongside documentation for items in the completions menu
* [`colorize_brackets`](https://zed.dev/docs/reference/all-settings.html#colorize-brackets): Whether to use tree-sitter bracket queries to detect and colorize the brackets in the editor (also known as "rainbow brackets")

These settings allow you to maintain specific coding styles across different languages and projects.

## [File Associations](https://zed.dev/docs/configuring-languages%3F.html#file-associations)
...
To set up custom file associations, use the [`file_types`](https://zed.dev/docs/reference/all-settings.html#file-types) setting in your `settings.json`:
...
## [Working with Language Servers](https://zed.dev/docs/configuring-languages%3F.html#working-with-language-servers)
...
### [What are Language Servers?](https://zed.dev/docs/configuring-languages%3F.html#what-are-language-servers)
...
### [Managing Language Servers](https://zed.dev/docs/configuring-languages%3F.html#managing-language-servers)
...
### [Choosing Language Servers](https://zed.dev/docs/configuring-languages%3F.html#choosing-language-servers)
...
#### [Examples](https://zed.dev/docs/configuring-languages%3F.html#examples)
...
### [Toolchains](https://zed.dev/docs/configuring-languages%3F.html#toolchains)
...
Not all languages in Zed support toolchain discovery and selection, but for those that do, you can specify the toolchain from a toolchain picker (via `toolchain: select`). To learn more about toolchains in Zed, see [`toolchains`](https://zed.dev/docs/toolchains.html).

### [Configuring Language Servers](https://zed.dev/docs/configuring-languages%3F.html#configuring-language-servers)
...
#### [Nested objects](https://zed.dev/docs/configuring-languages%3F.html#nested-objects)
...
#### [Possible configuration options](https://zed.dev/docs/configuring-languages%3F.html#possible-configuration-options)
...
### [Enabling or Disabling Language Servers](https://zed.dev/docs/configuring-languages%3F.html#enabling-or-disabling-language-servers)
...
## [Formatting and Linting](https://zed.dev/docs/configuring-languages%3F.html#formatting-and-linting)

Zed provides support for code formatting and linting to maintain consistent code style and catch potential issues early.

### [Configuring Formatters](https://zed.dev/docs/configuring-languages%3F.html#configuring-formatters)

Zed supports both built-in and external formatters. See [`formatter`](https://zed.dev/docs/reference/all-settings.html#formatter) docs for more. You can configure formatters globally or per-language in your `settings.json`:
...
### [Setting Up Linters](https://zed.dev/docs/configuring-languages%3F.html#setting-up-linters)
...
### [Integrating Formatting and Linting](https://zed.dev/docs/configuring-languages%3F.html#integrating-formatting-and-linting)
...
### [Troubleshooting](https://zed.dev/docs/configuring-languages%3F.html#troubleshooting)
...
## [Syntax Highlighting and Themes](https://zed.dev/docs/configuring-languages%3F.html#syntax-highlighting-and-themes)
...
### [Customizing Syntax Highlighting](https://zed.dev/docs/configuring-languages%3F.html#customizing-syntax-highlighting)
...
### [Selecting and Customizing Themes](https://zed.dev/docs/configuring-languages%3F.html#selecting-and-customizing-themes)
...
### [Using Theme Extensions](https://zed.dev/docs/configuring-languages%3F.html#using-theme-extensions)

Zed supports theme extensions. Browse and install theme extensions from the Extensions panel (`cmd-shift-x|ctrl-shift-x`).

To create your own theme extension, refer to the [Developing Theme Extensions](https://zed.dev/docs/extensions/themes.html) guide.

## [Using Language Server Features](https://zed.dev/docs/configuring-languages%3F.html#using-language-server-features)

### [Semantic Tokens](https://zed.dev/docs/configuring-languages%3F.html#semantic-tokens)
...
→ [Semantic Tokens documentation](https://zed.dev/docs/semantic-tokens.html)

### [Inlay Hints](https://zed.dev/docs/configuring-languages%3F.html#inlay-hints)
...
### [Code Actions](https://zed.dev/docs/configuring-languages%3F.html#code-actions)
...
### [Go To Definition and References](https://zed.dev/docs/configuring-languages%3F.html#go-to-definition-and-references)
...
### [Rename Symbol](https://zed.dev/docs/configuring-languages%3F.html#rename-symbol)
...
### [Hover Information](https://zed.dev/docs/configuring-languages%3F.html#hover-information)
...
### [Workspace Symbol Search](https://zed.dev/docs/configuring-languages%3F.html#workspace-symbol-search)

The `project symbols: toggle` command allows you to search for symbols (functions, classes, variables) across your entire project. This is useful for quickly navigating large codebases.

### [Code Completion](https://zed.dev/docs/configuring-languages%3F.html#code-completion)
...
### [Diagnostics](https://zed.dev/docs/configuring-languages%3F.html#diagnostics)

Language servers provide real-time diagnostics (errors, warnings, hints) as you code. View all diagnostics for your project using the `diagnostics: deploy` command.
