---
title: "Linux | Building Zed for Linux"
source_url: "https://zed.dev/docs/development/linux"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Building Zed for Linux](https://zed.dev/docs/development/linux.html#building-zed-for-linux)

## [Repository](https://zed.dev/docs/development/linux.html#repository)

Clone the [Zed repository](https://github.com/zed-industries/zed).

## [Dependencies](https://zed.dev/docs/development/linux.html#dependencies)
...
### [Linkers](https://zed.dev/docs/development/linux.html#linker)
...
## [Building from source](https://zed.dev/docs/development/linux.html#building-from-source)
...
## [Installing a development build](https://zed.dev/docs/development/linux.html#installing-a-development-build)
...
>
> You can refer to [linux: Linker error for remote\_server when using script/install-linux](https://github.com/zed-industries/zed/issues/24880) for more information.
>
> **Workaround**:
...
## [Wayland & X11](https://zed.dev/docs/development/linux.html#wayland--x11)
...
## [Notes for packaging Zed](https://zed.dev/docs/development/linux.html#notes-for-packaging-zed)

This section is for distribution maintainers packaging Zed.

### [Technical requirements](https://zed.dev/docs/development/linux.html#technical-requirements)
...
### [Other things to note](https://zed.dev/docs/development/linux.html#other-things-to-note)
...
## [Flatpak](https://zed.dev/docs/development/linux.html#flatpak)
...
## [Memory profiling](https://zed.dev/docs/development/linux.html#memory-profiling)
...
## [Perf recording](https://zed.dev/docs/development/linux.html#perf-recording)
...
### [During the incident](https://zed.dev/docs/development/linux.html#during-the-incident)
...
### [Later](https://zed.dev/docs/development/linux.html#later)
...
## [Troubleshooting](https://zed.dev/docs/development/linux.html#troubleshooting)

### [Cargo errors claiming that a dependency is using unstable features](https://zed.dev/docs/development/linux.html#cargo-errors-claiming-that-a-dependency-is-using-unstable-features)
