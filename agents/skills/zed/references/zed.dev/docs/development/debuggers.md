---
title: "Using Debuggers | Using a debugger"
source_url: "https://zed.dev/docs/development/debuggers"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Using a debugger](https://zed.dev/docs/development/debuggers.html#using-a-debugger)

> This page is not about [configuring Zed's debugger](https://zed.dev/docs/debugger.html).
> It covers how to use a debugger while developing Zed itself.

## [Using Zed's built-in debugger](https://zed.dev/docs/development/debuggers.html#using-zeds-built-in-debugger)
...
## [Release build profile considerations](https://zed.dev/docs/development/debuggers.html#release-build-profile-considerations)
...
## [Running Zed with a shell debugger GDB/LLDB](https://zed.dev/docs/development/debuggers.html#running-zed-with-a-shell-debugger-gdblldb)

### [Background](https://zed.dev/docs/development/debuggers.html#background)

When you install Rust through rustup (the recommended setup for Zed development; see your platform guide [here](https://zed.dev/docs/development.html)), rustup also installs helper scripts for debugging Rust binaries.
...
### [Usage with Zed](https://zed.dev/docs/development/debuggers.html#usage-with-zed)
...
#### [Debugging Panics and Crashes](https://zed.dev/docs/development/debuggers.html#debugging-panics-and-crashes)
...
You can find additional information on debugging Zed crashes [here](https://zed.dev/docs/development/debugging-crashes.html).

[FreeBSD](https://zed.dev/docs/development/freebsd.html "FreeBSD")
[Performance](https://zed.dev/docs/performance.html "Performance")
