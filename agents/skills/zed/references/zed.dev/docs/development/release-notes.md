...
source_url: "https://zed.dev/docs/development/release-notes"
...
On Wednesdays, we run [`get-preview-channel-changes`](https://github.com/zed-industries/zed/blob/main/script/get-preview-channel-changes), which collects `Release Notes` lines from pull requests landing in preview, as described in the [Release](https://zed.dev/docs/development/release-notes.html) docs.
...
## [Guidelines for crafting your `Release Notes` line(s)](https://zed.dev/docs/development/release-notes.html#guidelines-for-crafting-your-release-notes-lines)
...
[Glossary](https://zed.dev/docs/development/glossary.html "Glossary")
