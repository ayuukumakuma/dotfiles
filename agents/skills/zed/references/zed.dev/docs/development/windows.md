---
title: "Windows | Building Zed for Windows"
source_url: "https://zed.dev/docs/development/windows"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Building Zed for Windows](https://zed.dev/docs/development/windows.html#building-zed-for-windows)

> The following commands may be executed in any shell.

## [Repository](https://zed.dev/docs/development/windows.html#repository)

Clone the [Zed repository](https://github.com/zed-industries/zed).

## [Dependencies](https://zed.dev/docs/development/windows.html#dependencies)
...
### [Notes](https://zed.dev/docs/development/windows.html#notes)
...
## [Building from source](https://zed.dev/docs/development/windows.html#building-from-source)
...
> **Note:** Visual regression tests are currently macOS-only and require Screen Recording permission. See [Building Zed for macOS](https://zed.dev/docs/development/macos.html#visual-regression-tests) for details.

## [Installing from msys2](https://zed.dev/docs/development/windows.html#installing-from-msys2)
...
## [Troubleshooting](https://zed.dev/docs/development/windows.html#troubleshooting)

### [Setting `RUSTFLAGS` env var breaks builds](https://zed.dev/docs/development/windows.html#setting-rustflags-env-var-breaks-builds)
...
### [Cargo errors claiming that a dependency is using unstable features](https://zed.dev/docs/development/windows.html#cargo-errors-claiming-that-a-dependency-is-using-unstable-features)

Try `cargo clean` and `cargo build`.

### [`STATUS_ACCESS_VIOLATION`](https://zed.dev/docs/development/windows.html#status_access_violation)
...
### [Invalid RC path selected](https://zed.dev/docs/development/windows.html#invalid-rc-path-selected)
...
### [Build fails: Path too long](https://zed.dev/docs/development/windows.html#build-fails-path-too-long)
...
### [Graphics issues](https://zed.dev/docs/development/windows.html#graphics-issues)

#### [Zed fails to launch](https://zed.dev/docs/development/windows.html#zed-fails-to-launch)
...
[FreeBSD](https://zed.dev/docs/development/freebsd.html "FreeBSD")
