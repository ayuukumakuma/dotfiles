---
title: "Outline Panel | Outline Panel - Zed"
source_url: "https://zed.dev/docs/outline-panel"
...
## [Usage with multibuffers](https://zed.dev/docs/outline-panel.html#usage-with-multibuffers)

The outline panel truly excels when used with multi-buffers. Here are some examples of its versatility:

### [Project Search Results](https://zed.dev/docs/outline-panel.html#project-search-results)
...
### [Project Diagnostics](https://zed.dev/docs/outline-panel.html#project-diagnostics)
...
### [Find All References](https://zed.dev/docs/outline-panel.html#find-all-references)
