...
# [Configuring Supported Languages](https://zed.dev/docs/configuring-languages.html#configuring-supported-languages)
...
## [Language-specific Settings](https://zed.dev/docs/configuring-languages.html#language-specific-settings)
...
## [File Associations](https://zed.dev/docs/configuring-languages.html#file-associations)
...
## [Working with Language Servers](https://zed.dev/docs/configuring-languages.html#working-with-language-servers)
...
### [What are Language Servers?](https://zed.dev/docs/configuring-languages.html#what-are-language-servers)
...
### [Managing Language Servers](https://zed.dev/docs/configuring-languages.html#managing-language-servers)
...
### [Choosing Language Servers](https://zed.dev/docs/configuring-languages.html#choosing-language-servers)
...
#### [Examples](https://zed.dev/docs/configuring-languages.html#examples)
...
### [Toolchains](https://zed.dev/docs/configuring-languages.html#toolchains)
...
### [Configuring Language Servers](https://zed.dev/docs/configuring-languages.html#configuring-language-servers)
...
#### [Nested objects](https://zed.dev/docs/configuring-languages.html#nested-objects)
...
#### [Possible configuration options](https://zed.dev/docs/configuring-languages.html#possible-configuration-options)
...
### [Enabling or Disabling Language Servers](https://zed.dev/docs/configuring-languages.html#enabling-or-disabling-language-servers)
...
## [Formatting and Linting](https://zed.dev/docs/configuring-languages.html#formatting-and-linting)

Zed provides support for code formatting and linting to maintain consistent code style and catch potential issues early.

### [Configuring Formatters](https://zed.dev/docs/configuring-languages.html#configuring-formatters)
...
### [Setting Up Linters](https://zed.dev/docs/configuring-languages.html#setting-up-linters)
...
### [Integrating Formatting and Linting](https://zed.dev/docs/configuring-languages.html#integrating-formatting-and-linting)
...
### [Troubleshooting](https://zed.dev/docs/configuring-languages.html#troubleshooting)
...
## [Syntax Highlighting and Themes](https://zed.dev/docs/configuring-languages.html#syntax-highlighting-and-themes)
...
### [Customizing Syntax Highlighting](https://zed.dev/docs/configuring-languages.html#customizing-syntax-highlighting)
...
### [Selecting and Customizing Themes](https://zed.dev/docs/configuring-languages.html#selecting-and-customizing-themes)
...
### [Using Theme Extensions](https://zed.dev/docs/configuring-languages.html#using-theme-extensions)
...
## [Using Language Server Features](https://zed.dev/docs/configuring-languages.html#using-language-server-features)

### [Semantic Tokens](https://zed.dev/docs/configuring-languages.html#semantic-tokens)
...
### [Inlay Hints](https://zed.dev/docs/configuring-languages.html#inlay-hints)
...
### [Code Actions](https://zed.dev/docs/configuring-languages.html#code-actions)
...
### [Go To Definition and References](https://zed.dev/docs/configuring-languages.html#go-to-definition-and-references)
...
### [Rename Symbol](https://zed.dev/docs/configuring-languages.html#rename-symbol)
...
### [Hover Information](https://zed.dev/docs/configuring-languages.html#hover-information)
...
### [Workspace Symbol Search](https://zed.dev/docs/configuring-languages.html#workspace-symbol-search)
...
### [Code Completion](https://zed.dev/docs/configuring-languages.html#code-completion)
...
### [Diagnostics](https://zed.dev/docs/configuring-languages.html#diagnostics)
