...
source_url: "https://zed.dev/docs/collaboration/channels"
...
## [Inviting People](https://zed.dev/docs/collaboration/channels.html#inviting-people)
...
## [Voice Chat](https://zed.dev/docs/collaboration/channels.html#voice-chat)

You can mute/unmute your microphone via the microphone icon in the upper right-hand side of the window.

> **Note:** When joining a channel, Zed automatically shares your microphone with other users in the call, if your OS allows it. To start muted, use the [`mute_on_join`](https://zed.dev/docs/reference/all-settings.html#calls) setting.

## [Sharing Projects](https://zed.dev/docs/collaboration/channels.html#sharing-projects)
...
### [Unsharing a Project](https://zed.dev/docs/collaboration/channels.html#unsharing-a-project)
...
## [Channel Notes](https://zed.dev/docs/collaboration/channels.html#channel-notes)
...
## [Following Collaborators](https://zed.dev/docs/collaboration/channels.html#following-collaborators)

To follow a collaborator, click on their avatar in the top left of the title bar.
You can also cycle through collaborators using `ctrl-alt-cmd-f|ctrl-alt-shift-f` or `workspace: follow next collaborator` in the command palette.
...
### [How Following Works](https://zed.dev/docs/collaboration/channels.html#how-following-works)
...
### [Following a Terminal](https://zed.dev/docs/collaboration/channels.html#following-a-terminal)
...
## [Screen Sharing](https://zed.dev/docs/collaboration/channels.html#screen-sharing)
...
## [Livestreaming & Guests](https://zed.dev/docs/collaboration/channels.html#livestreaming--guests)
...
## [Leaving a Call](https://zed.dev/docs/collaboration/channels.html#leaving-a-call)
