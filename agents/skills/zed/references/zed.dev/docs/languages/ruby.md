---
title: "Ruby | Ruby"
source_url: "https://zed.dev/docs/languages/ruby"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Ruby](https://zed.dev/docs/languages/ruby.html#ruby)
...
## [Language Servers](https://zed.dev/docs/languages/ruby.html#language-servers)
...
## [Configuring a language server](https://zed.dev/docs/languages/ruby.html#configuring-a-language-server)

The [Ruby extension](https://github.com/zed-extensions/ruby) offers both `solargraph` and `ruby-lsp` language server support.

### [Language Server Activation](https://zed.dev/docs/languages/ruby.html#language-server-activation)
...
### [Using `solargraph`](https://zed.dev/docs/languages/ruby.html#using-solargraph)

`solargraph` is enabled by default in the Ruby extension.

### [Using `ruby-lsp`](https://zed.dev/docs/languages/ruby.html#using-ruby-lsp)
...
### [Using `rubocop`](https://zed.dev/docs/languages/ruby.html#using-rubocop)
...
## [Setting up `solargraph`](https://zed.dev/docs/languages/ruby.html#setting-up-solargraph)
...
### [Configuration](https://zed.dev/docs/languages/ruby.html#configuration)
...
## [Setting up `ruby-lsp`](https://zed.dev/docs/languages/ruby.html#setting-up-ruby-lsp)
...
## [Setting up `rubocop` LSP](https://zed.dev/docs/languages/ruby.html#setting-up-rubocop-lsp)
...
## [Setting up Sorbet](https://zed.dev/docs/languages/ruby.html#setting-up-sorbet)
...
## [Setting up Steep](https://zed.dev/docs/languages/ruby.html#setting-up-steep)
...
## [Setting up Herb](https://zed.dev/docs/languages/ruby.html#setting-up-herb)

`Herb` is enabled by default for the `HTML+ERB` language.

## [Using the Tailwind CSS Language Server with Ruby](https://zed.dev/docs/languages/ruby.html#using-the-tailwind-css-language-server-with-ruby)
...
```
{
  "lsp": {
    "tailwindcss-language-server": {
      "settings": {
        "experimental": {
          "classRegex": ["\\bclass:\\s*['\"](https://zed.dev/docs/languages/[^'\"]*)['\"]"]
        }
      }
    }
  }
...
## [Running tests](https://zed.dev/docs/languages/ruby.html#running-tests)
...
### [Minitest with Rails](https://zed.dev/docs/languages/ruby.html#minitest-with-rails)
...
### [Minitest](https://zed.dev/docs/languages/ruby.html#minitest)
...
### [RSpec](https://zed.dev/docs/languages/ruby.html#rspec)
...
## [Debugging](https://zed.dev/docs/languages/ruby.html#debugging)

The Ruby extension provides a debug adapter for debugging Ruby code. Zed's name for the adapter (in the UI and `debug.json`) is `rdbg`, and under the hood, it uses the [`debug`](https://github.com/ruby/debug) gem. The extension uses the [same activation logic](https://zed.dev/docs/languages/ruby.html#language-server-activation) as the language servers.

### [Examples](https://zed.dev/docs/languages/ruby.html#examples)

#### [Debug a Ruby script](https://zed.dev/docs/languages/ruby.html#debug-a-ruby-script)
...
#### [Debug Rails server](https://zed.dev/docs/languages/ruby.html#debug-rails-server)
...
## [Formatters](https://zed.dev/docs/languages/ruby.html#formatters)

### [`erb-formatter`](https://zed.dev/docs/languages/ruby.html#erb-formatter)
...
[Roc](https://zed.dev/docs/languages/roc.html "Roc")
