---
title: "JSON | JSON"
source_url: "https://zed.dev/docs/languages/json"
...
## [JSONC](https://zed.dev/docs/languages/json.html#jsonc)
...
## [JSONC Prettier Formatting](https://zed.dev/docs/languages/json.html#jsonc-prettier-formatting)
...
## [JSON Language Server](https://zed.dev/docs/languages/json.html#json-language-server)
...
### [Inline Schema Specification](https://zed.dev/docs/languages/json.html#inline-schema-specification)
...
### [Schema Specification via Settings](https://zed.dev/docs/languages/json.html#schema-specification-via-settings)
