---
title: "Vue | Vue"
source_url: "https://zed.dev/docs/languages/vue"
...
## [Using the Tailwind CSS Language Server with Vue](https://zed.dev/docs/languages/vue.html#using-the-tailwind-css-language-server-with-vue)
