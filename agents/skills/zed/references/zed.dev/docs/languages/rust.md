---
title: "Rust | Rust"
source_url: "https://zed.dev/docs/languages/rust"
...
## [Inlay Hints](https://zed.dev/docs/languages/rust.html#inlay-hints)
...
## [Target directory](https://zed.dev/docs/languages/rust.html#target-directory)
...
## [Binary](https://zed.dev/docs/languages/rust.html#binary)
...
## [Alternate Targets](https://zed.dev/docs/languages/rust.html#alternate-targets)
...
## [LSP tasks](https://zed.dev/docs/languages/rust.html#lsp-tasks)
...
## [Manual Cargo Diagnostics fetch](https://zed.dev/docs/languages/rust.html#manual-cargo-diagnostics-fetch)
...
## [More server configuration](https://zed.dev/docs/languages/rust.html#more-server-configuration)
...
### [Large projects and performance](https://zed.dev/docs/languages/rust.html#large-projects-and-performance)
...
The alternatives would be to use [tasks](https://zed.dev/docs/tasks.html), as Zed already provides a `cargo check --workspace --all-targets` task and the ability to cmd/ctrl-click on the terminal output to navigate to the error, and limit or turn off the check on save feature entirely.
...
### [Multi-project workspaces](https://zed.dev/docs/languages/rust.html#multi-project-workspaces)
...
### [Snippets](https://zed.dev/docs/languages/rust.html#snippets)
...
## [Debugging](https://zed.dev/docs/languages/rust.html#debugging)
...
### [Build binary then debug](https://zed.dev/docs/languages/rust.html#build-binary-then-debug)
...
### [Automatically locate a debug target based on build command](https://zed.dev/docs/languages/rust.html#automatically-locate-a-debug-target-based-on-build-command)
