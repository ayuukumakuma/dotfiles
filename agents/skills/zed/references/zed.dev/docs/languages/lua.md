---
title: "Lua | Lua"
source_url: "https://zed.dev/docs/languages/lua"
...
## [luarc.json](https://zed.dev/docs/languages/lua.html#luarcjson)
...
### [LuaCATS Definitions](https://zed.dev/docs/languages/lua.html#luacats-definitions)
...
### [LÖVE (Love2D)](https://zed.dev/docs/languages/lua.html#love2d)
...
### [PlaydateSDK](https://zed.dev/docs/languages/lua.html#playdatesdk)
...
### [Inlay Hints](https://zed.dev/docs/languages/lua.html#inlay-hints)

To enable [Inlay Hints](https://zed.dev/docs/configuring-languages.html#inlay-hints) for LuaLS in Zed

1. Configure inlay hints in Settings (`cmd-,|ctrl-,`) under Languages > Lua, or add to your settings file:
...
## [Formatting](https://zed.dev/docs/languages/lua.html#formatting)

### [LuaLS Formatting](https://zed.dev/docs/languages/lua.html#luals-formatting)
...
Configure formatting in Settings (`cmd-,|ctrl-,`) under Languages > Lua, or add to your settings file:
...
### [StyLua Formatting](https://zed.dev/docs/languages/lua.html#stylua-formatting)
...
2. Configure formatting in Settings (`cmd-,|ctrl-,`) under Languages > Lua, or add to your settings file:
