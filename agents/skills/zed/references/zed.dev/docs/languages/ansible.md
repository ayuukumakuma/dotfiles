...
source_url: "https://zed.dev/docs/languages/ansible"
...
## [Setup](https://zed.dev/docs/languages/ansible.html#setup)

### [File detection](https://zed.dev/docs/languages/ansible.html#file-detection)
...
#### [Inventory](https://zed.dev/docs/languages/ansible.html#inventory)
...
* or, configure the YAML language server settings to set this schema for all your inventory files, that match your inventory pattern, under your Zed settings ([ref](https://zed.dev/docs/languages/yaml.html)):
...
### [LSP Configuration](https://zed.dev/docs/languages/ansible.html#lsp-configuration)
