---
title: "Debugger | Debugger - Zed"
source_url: "https://zed.dev/docs/debugger"
...
## [Supported Languages](https://zed.dev/docs/debugger.html#supported-languages)

To debug code written in a specific language, Zed needs to find a debug adapter for that language. Some debug adapters are provided by Zed without additional setup, and some are provided by [language extensions](https://zed.dev/docs/extensions/debugger-extensions.html). The following languages currently have debug adapters available:

* [C](https://zed.dev/docs/languages/c.html#debugging) (built-in)
* [C++](https://zed.dev/docs/languages/cpp.html#debugging) (built-in)
* [Go](https://zed.dev/docs/languages/go.html#debugging) (built-in)
* [Java](https://zed.dev/docs/languages/java.html#debugging) (provided by extension)
* [JavaScript](https://zed.dev/docs/languages/javascript.html#debugging) (built-in)
* [PHP](https://zed.dev/docs/languages/php.html#debugging) (built-in)
* [Python](https://zed.dev/docs/languages/python.html#debugging) (built-in)
* [Ruby](https://zed.dev/docs/languages/ruby.html#debugging) (provided by extension)
* [Rust](https://zed.dev/docs/languages/rust.html#debugging) (built-in)
* [Swift](https://zed.dev/docs/languages/swift.html#debugging) (provided by extension)
* [TypeScript](https://zed.dev/docs/languages/typescript.html#debugging) (built-in)

> If your language isn't listed, you can contribute by adding a debug adapter for it. Check out our [debugger extensions](https://zed.dev/docs/extensions/debugger-extensions.html) documentation for more information.
...
## [Getting Started](https://zed.dev/docs/debugger.html#getting-started)
...
#### [Global debug configurations](https://zed.dev/docs/debugger.html#global-debug-configurations)

If you run the same launch profiles across multiple projects, you can store them once in your user configuration. Invoke `zed: open debug tasks` from the command palette to open the global `debug.json` file; Zed creates it next to your user `settings.json` and keeps it in sync with the debugger UI. The file lives at:
...
### [Launching & Attaching](https://zed.dev/docs/debugger.html#launching--attaching)
...
## [Configuration](https://zed.dev/docs/debugger.html#configuration)

Zed requires the `adapter` and `label` fields for all debug tasks. In addition, Zed will use the `build` field to run any necessary setup steps before the debugger starts [(see below)](https://zed.dev/docs/debugger.html#build-tasks), and can accept a `tcp_connection` field to connect to an existing process.

All other fields are provided by the debug adapter and can contain [task variables](https://zed.dev/docs/tasks.html#variables). Most adapters support `request`, `program`, and `cwd`:
...
### [Build tasks](https://zed.dev/docs/debugger.html#build-tasks)
...
### [Automatic scenario creation](https://zed.dev/docs/debugger.html#automatic-scenario-creation)
...
## [Breakpoints](https://zed.dev/docs/debugger.html#breakpoints)
...
## [Working with Split Panes](https://zed.dev/docs/debugger.html#working-with-split-panes)
...
## [Settings](https://zed.dev/docs/debugger.html#settings)
...
### [Dock](https://zed.dev/docs/debugger.html#dock)
...
### [Stepping granularity](https://zed.dev/docs/debugger.html#stepping-granularity)
...
### [Save Breakpoints](https://zed.dev/docs/debugger.html#save-breakpoints)
...
### [Button](https://zed.dev/docs/debugger.html#button)
...
### [Timeout](https://zed.dev/docs/debugger.html#timeout)
...
### [Inline Values](https://zed.dev/docs/debugger.html#inline-values)
...
### [Log Dap Communications](https://zed.dev/docs/debugger.html#log-dap-communications)

* Description: Whether to log messages between active debug adapters and Zed. (Used for DAP development)
* Default: false
* Setting: debugger.log\_dap\_communications
...
### [Format Dap Log Messages](https://zed.dev/docs/debugger.html#format-dap-log-messages)

* Description: Whether to format DAP messages when adding them to the debug adapter logger. (Used for DAP development)
* Default: false
* Setting: debugger.format\_dap\_log\_messages
...
### [Customizing Debug Adapters](https://zed.dev/docs/debugger.html#customizing-debug-adapters)
...
## [Theme](https://zed.dev/docs/debugger.html#theme)
...
## [Troubleshooting](https://zed.dev/docs/debugger.html#troubleshooting)
