---
title: "Worktree Trust | Zed and trusted worktrees"
source_url: "https://zed.dev/docs/worktree-trust"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Zed and trusted worktrees](https://zed.dev/docs/worktree-trust.html#zed-and-trusted-worktrees)
...
## [What is restricted](https://zed.dev/docs/worktree-trust.html#what-is-restricted)
...
## [Configuring broad worktree trust](https://zed.dev/docs/worktree-trust.html#configuring-broad-worktree-trust)

By default, Zed does not trust new worktrees. Users must trust each new worktree individually. Though not recommended, users can trust all worktrees with this setting ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
## [Trust hierarchy](https://zed.dev/docs/worktree-trust.html#trust-hierarchy)
