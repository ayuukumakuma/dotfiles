---
title: "Keybindings | Key Bindings and Shortcuts - Zed"
source_url: "https://zed.dev/docs/key-bindings"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Key bindings](https://zed.dev/docs/key-bindings.html#key-bindings)
...
## [Predefined Keymaps](https://zed.dev/docs/key-bindings.html#predefined-keymaps)

If you're used to a specific editor's defaults, you can change your `base_keymap` through the settings window (`cmd-,|ctrl-,`) or directly through your `settings.json` file (`cmd-alt-,|ctrl-alt-,`).
...
For more information, see the documentation for [Vim mode](https://zed.dev/docs/vim.html) and [Helix mode](https://zed.dev/docs/helix.html).

## [Keymap Editor](https://zed.dev/docs/key-bindings.html#keymap-editor)

You can access the keymap editor through the `cmd-k cmd-s|ctrl-k ctrl-s` action or by running `zed: open keymap` action from the command palette. You can easily add or change a keybind for an action with the `Change Keybinding` or `Add Keybinding` button on the command pallets left bottom corner.
...
## [User Keymaps](https://zed.dev/docs/key-bindings.html#user-keymaps)
...
You can open the keymap with the `zed: open keymap file` action from the command palette.

This file contains a JSON array of objects with `"bindings"`.
If no `"context"` is set, the bindings are always active.
If it is set, the binding is only active when the [context matches](https://zed.dev/docs/key-bindings.html#contexts).

Within each binding section, a [key sequence](https://zed.dev/docs/key-bindings.html#keybinding-syntax) is mapped to [an action](https://zed.dev/docs/key-bindings.html#actions).
If conflicts are detected, they are resolved as [described below](https://zed.dev/docs/key-bindings.html#precedence).

If you are using a non-QWERTY, Latin-character keyboard, you may want to set `use_key_equivalents` to `true`. See [Non-QWERTY keyboards](https://zed.dev/docs/key-bindings.html#non-qwerty-keyboards) for more information.
...
### [Keybinding Syntax](https://zed.dev/docs/key-bindings.html#keybinding-syntax)
...
### [Contexts](https://zed.dev/docs/key-bindings.html#contexts)
...
If you're using Vim mode, we have information on how [vim modes influence the context](https://zed.dev/docs/vim.html#contexts). Helix mode is built on top of Vim mode and uses the same contexts.

### [Actions](https://zed.dev/docs/key-bindings.html#actions)
...
### [Precedence](https://zed.dev/docs/key-bindings.html#precedence)
...
### [Non-QWERTY keyboards](https://zed.dev/docs/key-bindings.html#non-qwerty-keyboards)
...
#### [macOS](https://zed.dev/docs/key-bindings.html#macos)
...
### [Linux](https://zed.dev/docs/key-bindings.html#linux)
...
## [Tips and tricks](https://zed.dev/docs/key-bindings.html#tips-and-tricks)

### [Disabling a binding](https://zed.dev/docs/key-bindings.html#disabling-a-binding)
...
### [Remapping keys](https://zed.dev/docs/key-bindings.html#remapping-keys)
...
### [Forward keys to terminal](https://zed.dev/docs/key-bindings.html#forward-keys-to-terminal)
...
### [Task Key bindings](https://zed.dev/docs/key-bindings.html#task-key-bindings)

You can also bind keys to launch Zed Tasks defined in your `tasks.json`.
See the [tasks documentation](https://zed.dev/docs/tasks.html#custom-keybindings-for-tasks) for more.
