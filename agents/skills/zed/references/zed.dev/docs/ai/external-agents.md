---
title: "External Agents | Use Claude Agent, Gemini CLI, and Codex in Zed"
source_url: "https://zed.dev/docs/ai/external-agents"
...
Zed supports [Gemini CLI](https://github.com/google-gemini/gemini-cli) (the reference ACP implementation), [Claude Agent](https://platform.claude.com/docs/en/agent-sdk/overview), [Codex](https://developers.openai.com/codex), [GitHub Copilot](https://github.com/github/copilot-language-server-release), and [additional agents](https://zed.dev/docs/ai/external-agents.html#add-more-agents) you can configure.
...
> Zed does not charge for use of external agents, and our [zero-data retention agreements/privacy guarantees](https://zed.dev/docs/ai/ai-improvement.html) are ***only*** applicable for Zed's hosted models.

## [Gemini CLI](https://zed.dev/docs/ai/external-agents.html#gemini-cli)
...
### [Getting Started](https://zed.dev/docs/ai/external-agents.html#getting-started)
...
#### [Installation](https://zed.dev/docs/ai/external-agents.html#installation)
...
#### [Authentication](https://zed.dev/docs/ai/external-agents.html#authentication)
...
If the `GEMINI_API_KEY` environment variable (or `GOOGLE_AI_API_KEY`) is already set, or you have configured a Google AI API key in Zed's [language model provider settings](https://zed.dev/docs/ai/llm-providers.html#google-ai), it will be passed to Gemini CLI automatically.

For more information, see the [Gemini CLI docs](https://github.com/google-gemini/gemini-cli/blob/main/docs/index.md).

### [Usage](https://zed.dev/docs/ai/external-agents.html#usage)
...
## [Claude Agent](https://zed.dev/docs/ai/external-agents.html#claude-agent)

Similar to Gemini CLI, you can also run [Claude Agent](https://platform.claude.com/docs/en/agent-sdk/overview) directly via Zed's [agent panel](https://zed.dev/docs/ai/agent-panel.html).
...
### [Getting Started](https://zed.dev/docs/ai/external-agents.html#getting-started-1)
...
### [Authentication](https://zed.dev/docs/ai/external-agents.html#authentication-1)

As of version `0.202.7`, authentication to Zed's Claude Agent installation is decoupled entirely from Zed's agent.
That is to say, an Anthropic API key added via the [Zed Agent's settings](https://zed.dev/docs/ai/llm-providers.html#anthropic) will *not* be utilized by Claude Agent for authentication and billing.

To ensure you're using your billing method of choice, [open a new Claude Agent thread](https://zed.dev/docs/ai/agent-panel.html#new-thread).
Then, run `/login`, and authenticate either via API key, or via `Log in with Claude Code` to use a Claude Pro/Max subscription.

#### [Installation](https://zed.dev/docs/ai/external-agents.html#installation-1)
...
### [Usage](https://zed.dev/docs/ai/external-agents.html#usage-1)
...
> Some [agent panel](https://zed.dev/docs/ai/agent-panel.html) features are not yet available with Claude Agent: editing past messages, resuming threads from history, and checkpointing.

#### [CLAUDE.md](https://zed.dev/docs/ai/external-agents.html#claudemd)
...
## [Codex CLI](https://zed.dev/docs/ai/external-agents.html#codex-cli)

You can also run [Codex CLI](https://github.com/openai/codex) directly via Zed's [agent panel](https://zed.dev/docs/ai/agent-panel.html).
...
### [Getting Started](https://zed.dev/docs/ai/external-agents.html#getting-started-2)

As of version `0.208`, you should be able to use Codex directly from Zed.
Open the agent panel with `cmd-?|ctrl-?`, and then use the `+` button in the top right to start a new Codex thread.
...
### [Authentication](https://zed.dev/docs/ai/external-agents.html#authentication-2)

Authentication to Zed's Codex installation is decoupled entirely from Zed's agent.
That is to say, an OpenAI API key added via the [Zed Agent's settings](https://zed.dev/docs/ai/llm-providers.html#openai) will *not* be utilized by Codex for authentication and billing.

To ensure you're using your billing method of choice, [open a new Codex thread](https://zed.dev/docs/ai/agent-panel.html#new-thread).
...
#### [Installation](https://zed.dev/docs/ai/external-agents.html#installation-2)
...
### [Usage](https://zed.dev/docs/ai/external-agents.html#usage-2)
...
## [Add More Agents](https://zed.dev/docs/ai/external-agents.html#add-more-agents)

### [Via Agent Server Extensions](https://zed.dev/docs/ai/external-agents.html#via-agent-server-extensions)
...
Add more external agents to Zed by installing [Agent Server extensions](https://zed.dev/docs/extensions/agent-servers.html).
...
### [Via The ACP Registry](https://zed.dev/docs/ai/external-agents.html#via-the-acp-registry)

#### [Overview](https://zed.dev/docs/ai/external-agents.html#overview)
...
#### [Using it in Zed](https://zed.dev/docs/ai/external-agents.html#using-it-in-zed)
...
### [Custom Agents](https://zed.dev/docs/ai/external-agents.html#custom-agents)

You can also add agents through your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)) by specifying certain fields under `agent_servers`, like so:
...
## [Debugging Agents](https://zed.dev/docs/ai/external-agents.html#debugging-agents)
...
## [MCP Servers](https://zed.dev/docs/ai/external-agents.html#mcp-servers)

Note that for external agents, access to MCP servers [installed from Zed](https://zed.dev/docs/ai/mcp.html) may vary depending on the ACP implementation.
