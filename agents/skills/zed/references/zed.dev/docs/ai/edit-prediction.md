---
title: "Edit Prediction | AI Code Completion in Zed - Zeta, Copilot, Sweep, Mercury Coder"
source_url: "https://zed.dev/docs/ai/edit-prediction"
...
The default provider is [Zeta, a proprietary open source and open dataset model](https://huggingface.co/zed-industries/zeta), but you can also use [other providers](https://zed.dev/docs/ai/edit-prediction.html#other-providers) like GitHub Copilot, Sweep, Mercury Coder, and Codestral.

## [Configuring Zeta](https://zed.dev/docs/ai/edit-prediction.html#configuring-zeta)

To use Zeta, [sign in](https://zed.dev/docs/authentication.html#what-features-require-signing-in).
...
### [Pricing and Plans](https://zed.dev/docs/ai/edit-prediction.html#pricing-and-plans)

The free plan includes 2,000 Zeta predictions per month. The [Pro plan](https://zed.dev/docs/ai/plans-and-usage.html) removes this limit. See [Zed's pricing page](https://zed.dev/pricing) for details.

### [Switching Modes](https://zed.dev/docs/ai/edit-prediction.html#switching-modes)
...
### [Conflict With Other `tab` Actions](https://zed.dev/docs/ai/edit-prediction.html#edit-predictions-conflict)
...
`editor: accept next word edit prediction` (`ctrl-cmd-right|alt-k`) can be used to accept the current edit prediction up to the next word boundary.
`editor: accept next line edit prediction` (`ctrl-cmd-down|alt-j`) can be used to accept the current edit prediction up to the new line boundary.

## [Configuring Edit Prediction Keybindings](https://zed.dev/docs/ai/edit-prediction.html#edit-predictions-keybinding)
...
When there's a [conflict with the `tab` key](https://zed.dev/docs/ai/edit-prediction.html#edit-predictions-conflict), Zed uses a different key context to accept keybindings (`edit_prediction_conflict`).
...
### [Keybinding Example: Always Use Tab](https://zed.dev/docs/ai/edit-prediction.html#keybinding-example-always-use-tab)
...
This will make `tab` work to accept edit predictions *even when* you're also seeing language server completions.
That means that you need to rely on `enter` for accepting the latter.

### [Keybinding Example: Always Use Alt-Tab](https://zed.dev/docs/ai/edit-prediction.html#keybinding-example-always-use-alt-tab)
...
If you are using [Vim mode](https://zed.dev/docs/vim.html), then additional bindings are needed after the above to return `tab` to its original behavior:
...
### [Keybinding Example: Displaying Tab and Alt-Tab on Linux](https://zed.dev/docs/ai/edit-prediction.html#keybinding-example-displaying-tab-and-alt-tab-on-linux)
...
### [Missing keybind](https://zed.dev/docs/ai/edit-prediction.html#edit-predictions-missing-keybinding)

Zed requires at least one keybinding for the `editor: accept edit prediction` action in both the `Editor && edit_prediction` and `Editor && edit_prediction_conflict` contexts ([learn more above](https://zed.dev/docs/ai/edit-prediction.html#edit-predictions-keybinding)).
...
## [Disabling Automatic Edit Prediction](https://zed.dev/docs/ai/edit-prediction.html#disabling-automatic-edit-prediction)

You can disable edit predictions at several levels, or turn them off entirely.

Alternatively, if you have Zed set as your provider, consider [using Subtle Mode](https://zed.dev/docs/ai/edit-prediction.html#switching-modes).

### [On Buffers](https://zed.dev/docs/ai/edit-prediction.html#on-buffers)

To not have predictions appear automatically as you type, set this in your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
This hides every indication that there is a prediction available, regardless of [the display mode](https://zed.dev/docs/ai/edit-prediction.html#switching-modes) you're in (valid only if you have Zed as your provider).
Still, you can trigger edit predictions manually by executing `editor: show edit prediction` or hitting `alt-tab|alt-\`.

### [For Specific Languages](https://zed.dev/docs/ai/edit-prediction.html#for-specific-languages)

To not have predictions appear automatically as you type when working with a specific language, set this in your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
### [In Specific Directories](https://zed.dev/docs/ai/edit-prediction.html#in-specific-directories)

To disable edit predictions for specific directories or files, set this in your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
### [Turning Off Completely](https://zed.dev/docs/ai/edit-prediction.html#turning-off-completely)
...
## [Configuring Other Providers](https://zed.dev/docs/ai/edit-prediction.html#other-providers)

Edit Prediction also works with other providers.

### [GitHub Copilot](https://zed.dev/docs/ai/edit-prediction.html#github-copilot)

To use GitHub Copilot as your provider, set this in your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
#### [Using GitHub Copilot Enterprise](https://zed.dev/docs/ai/edit-prediction.html#using-github-copilot-enterprise)

If your organization uses GitHub Copilot Enterprise, you can configure Zed to use your enterprise instance by specifying the enterprise URI in your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
### [Sweep](https://zed.dev/docs/ai/edit-prediction.html#sweep)
...
### [Mercury Coder](https://zed.dev/docs/ai/edit-prediction.html#mercury-coder)
...
### [Codestral](https://zed.dev/docs/ai/edit-prediction.html#codestral)
...
### [Self-Hosted OpenAI-compatible servers](https://zed.dev/docs/ai/edit-prediction.html#self-hosted-openai-compatible-servers)
...
#### [Configuration](https://zed.dev/docs/ai/edit-prediction.html#configuration)
...
## [See also](https://zed.dev/docs/ai/edit-prediction.html#see-also)

* [Agent Panel](https://zed.dev/docs/ai/agent-panel.html): Agentic editing with file read/write and terminal access
* [Inline Assistant](https://zed.dev/docs/ai/inline-assistant.html): Prompt-driven transformations on selected code

[Inline Assistant](https://zed.dev/docs/ai/inline-assistant.html "Inline Assistant")
[Text Threads](https://zed.dev/docs/ai/text-threads.html "Text Threads")
