---
title: "Text Threads | AI Chat in Your Editor - Zed Text Threads"
source_url: "https://zed.dev/docs/ai/text-threads"
...
Text threads in the [Agent Panel](https://zed.dev/docs/ai/agent-panel.html) work like a regular editor.
You can use custom keybindings, multiple cursors, and all the standard editing features while chatting.

## [Text Threads vs. Threads](https://zed.dev/docs/ai/text-threads.html#text-threads-vs-threads)

Text Threads were Zed's original AI interface.
In May 2025, Zed introduced the current [Agent Panel](https://zed.dev/docs/ai/agent-panel.html), designed for agentic workflows.
...
Therefore, [MCP servers](https://zed.dev/docs/ai/mcp.html) and [external agents](https://zed.dev/docs/ai/external-agents.html) are also not available in Text Threads.

## [Usage Overview](https://zed.dev/docs/ai/text-threads.html#usage-overview)
...
To add context from an editor, highlight text and run `agent: add selection to thread` (`cmd->|ctrl->`).
If the selection is code, Zed will wrap it in a fenced code block.

To submit a message, use `cmd-enter|ctrl-enter` (`assistant: assist`).
In text threads, `enter|enter` inserts a new line instead of submitting, which preserves standard editor behavior.
...
## [Commands Overview](https://zed.dev/docs/ai/text-threads.html#commands)
...
* `/prompt`: Adds a custom-configured prompt to the context ([see Rules Library](https://zed.dev/docs/ai/rules.html#rules-library))
...
### [`/default`](https://zed.dev/docs/ai/text-threads.html#default)

Read more about `/default` in the [Rules: Editing the Default Rules](https://zed.dev/docs/ai/rules.html#default-rules) section.

Usage: `/default`

### [`/diagnostics`](https://zed.dev/docs/ai/text-threads.html#diagnostics)
...
### [`/file`](https://zed.dev/docs/ai/text-threads.html#file)
...
### [`/terminal`](https://zed.dev/docs/ai/text-threads.html#terminal)
...
### [`/selection`](https://zed.dev/docs/ai/text-threads.html#selection)

Inserts the currently selected text. Equivalent to `agent: add selection to thread` (`cmd->|ctrl->`).

Usage: `/selection`

## [Commands in the Rules Library](https://zed.dev/docs/ai/text-threads.html#slash-commands-in-rules)

[Commands](https://zed.dev/docs/ai/text-threads.html#commands) can be used in rules, in the Rules Library (previously known as Prompt Library), to insert dynamic content or perform actions.
...
See the [list of commands](https://zed.dev/docs/ai/text-threads.html#commands) above for more information on commands, and what slash commands are available.

### [Example](https://zed.dev/docs/ai/text-threads.html#example)
...
## [Nesting Rules](https://zed.dev/docs/ai/text-threads.html#nesting-rules)
...
### [Example](https://zed.dev/docs/ai/text-threads.html#example-1)
...
## [Extensibility](https://zed.dev/docs/ai/text-threads.html#extensibility)

Additional slash commands can be provided by extensions.

See [Extension: Slash Commands](https://zed.dev/docs/extensions/slash-commands.html) to learn how to create your own.

## [Advanced Concepts](https://zed.dev/docs/ai/text-threads.html#advanced-concepts)

### [Rule Templates](https://zed.dev/docs/ai/text-threads.html#rule-templates)
...
### [Overriding Templates](https://zed.dev/docs/ai/text-threads.html#overriding-templates)
...
### [History](https://zed.dev/docs/ai/text-threads.html#history)
...
[Rules](https://zed.dev/docs/ai/rules.html "Rules")
