---
title: "LLM Providers | LLM Providers - Use Your Own API Keys in Zed"
source_url: "https://zed.dev/docs/ai/llm-providers"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---
...
To use AI in Zed, you need to have at least one large language model provider set up. Once configured, providers are available in the [Agent Panel](https://zed.dev/docs/ai/agent-panel.html), [Inline Assistant](https://zed.dev/docs/ai/inline-assistant.html), and [Text Threads](https://zed.dev/docs/ai/text-threads.html).

You can do that by either subscribing to [one of Zed's plans](https://zed.dev/docs/ai/plans-and-usage.html), or by using API keys you already have for the supported providers. For general AI setup, see [Configuration](https://zed.dev/docs/ai/configuration.html).

## [Use Your Own Keys](https://zed.dev/docs/ai/llm-providers.html#use-your-own-keys)
...
## [Supported Providers](https://zed.dev/docs/ai/llm-providers.html#supported-providers)

Zed supports these providers with your own API keys:

* [Amazon Bedrock](https://zed.dev/docs/ai/llm-providers.html#amazon-bedrock)
* [Anthropic](https://zed.dev/docs/ai/llm-providers.html#anthropic)
* [DeepSeek](https://zed.dev/docs/ai/llm-providers.html#deepseek)
* [GitHub Copilot Chat](https://zed.dev/docs/ai/llm-providers.html#github-copilot-chat)
* [Google AI](https://zed.dev/docs/ai/llm-providers.html#google-ai)
* [LM Studio](https://zed.dev/docs/ai/llm-providers.html#lmstudio)
* [Mistral](https://zed.dev/docs/ai/llm-providers.html#mistral)
* [Ollama](https://zed.dev/docs/ai/llm-providers.html#ollama)
* [OpenAI](https://zed.dev/docs/ai/llm-providers.html#openai)
* [OpenAI API Compatible](https://zed.dev/docs/ai/llm-providers.html#openai-api-compatible)
* [OpenRouter](https://zed.dev/docs/ai/llm-providers.html#openrouter)
* [Vercel AI Gateway](https://zed.dev/docs/ai/llm-providers.html#vercel-ai-gateway)
* [Vercel](https://zed.dev/docs/ai/llm-providers.html#vercel-v0)
* [xAI](https://zed.dev/docs/ai/llm-providers.html#xai)
...
#### [Authentication via Named Profile (Recommended)](https://zed.dev/docs/ai/llm-providers.html#authentication-via-named-profile-recommended)
...
#### [Authentication via Static Credentials](https://zed.dev/docs/ai/llm-providers.html#authentication-via-static-credentials)
...
#### [Authentication via Bedrock API Key](https://zed.dev/docs/ai/llm-providers.html#authentication-via-bedrock-api-key)
...
#### [Cross-Region Inference](https://zed.dev/docs/ai/llm-providers.html#cross-region-inference)
...
##### [Regional vs Global Inference Profiles](https://zed.dev/docs/ai/llm-providers.html#regional-vs-global-inference-profiles)
...
#### [Extended Context Window](https://zed.dev/docs/ai/llm-providers.html#bedrock-extended-context)
...
#### [Image Support](https://zed.dev/docs/ai/llm-providers.html#bedrock-image-support)
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#anthropic-custom-models)

You can add custom models to the Anthropic provider by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#deepseek-custom-models)

The Zed agent comes pre-configured to use the latest version for common models (DeepSeek Chat, DeepSeek Reasoner).
If you wish to use alternate models or customize the API endpoint, you can do so by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
To use Copilot Enterprise with Zed (for both agent and completions), you must configure your enterprise endpoint as described in [Configuring GitHub Copilot Enterprise](https://zed.dev/docs/ai/edit-prediction.html#github-copilot-enterprise).
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#google-ai-custom-models)
...
Here is an example of a custom Google AI model you could add to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#mistral-custom-models)
...
If you wish to use alternate models or customize their parameters, you can do so by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
#### [Ollama Autodiscovery](https://zed.dev/docs/ai/llm-providers.html#ollama-autodiscovery)
...
#### [Ollama Context Length](https://zed.dev/docs/ai/llm-providers.html#ollama-context)
...
#### [Ollama Authentication](https://zed.dev/docs/ai/llm-providers.html#ollama-authentication)
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#openai-custom-models)
...
To use alternate models, perhaps a preview release, or if you wish to control the request parameters, you can do so by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
To do it via your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)), add the following snippet under `language_models`:
...
#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#openrouter-custom-models)

You can add custom models to the OpenRouter provider by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
#### [Provider Routing](https://zed.dev/docs/ai/llm-providers.html#provider-routing)
...
### [Vercel v0](https://zed.dev/docs/ai/llm-providers.html#vercel-v0)
...
The v0 models are [OpenAI-compatible models](https://zed.dev/#openai-api-compatible), and Vercel appears as a dedicated provider in the panel's settings view.
...
> **Note:** The xAI API is OpenAI-compatible, and Zed also includes a dedicated xAI provider. We recommend using the dedicated `x_ai` provider configuration instead of the [OpenAI API Compatible](https://zed.dev/docs/ai/llm-providers.html#openai-api-compatible) method.

#### [Custom Models](https://zed.dev/docs/ai/llm-providers.html#xai-custom-models)

The Zed agent comes pre-configured with common Grok models. If you wish to use alternate models or customize their parameters, you can do so by adding the following to your Zed settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
## [Custom Provider Endpoints](https://zed.dev/docs/ai/llm-providers.html#custom-provider-endpoint)

You can use a custom API endpoint for different providers, as long as it's compatible with the provider's API structure.
To do so, add the following to your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)):
...
This is the same infrastructure that powers models that are, for example, [OpenAI-compatible](https://zed.dev/docs/ai/llm-providers.html#openai-api-compatible).

[Configuration](https://zed.dev/docs/ai/configuration.html "Configuration")
[Agent Settings](https://zed.dev/docs/ai/agent-settings.html "Agent Settings")
