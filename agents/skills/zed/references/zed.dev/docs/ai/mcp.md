---
title: "Model Context Protocol | Model Context Protocol (MCP) in Zed"
source_url: "https://zed.dev/docs/ai/mcp"
...
## [Supported Features](https://zed.dev/docs/ai/mcp.html#supported-features)
...
## [Installing MCP Servers](https://zed.dev/docs/ai/mcp.html#installing-mcp-servers)

### [As Extensions](https://zed.dev/docs/ai/mcp.html#as-extensions)

One of the ways you can use MCP servers in Zed is by exposing them as an extension.
Check out the [MCP Server Extensions](https://zed.dev/docs/extensions/mcp-extensions.html) page to learn how to create your own.
...
### [As Custom Servers](https://zed.dev/docs/ai/mcp.html#as-custom-servers)

Creating an extension is not the only way to use MCP servers in Zed.
You can connect them by adding their commands directly to your settings file ([how to edit](https://zed.dev/docs/configuring-zed.html#settings-files)), like so:
...
## [Using MCP Servers](https://zed.dev/docs/ai/mcp.html#using-mcp-servers)

### [Configuration Check](https://zed.dev/docs/ai/mcp.html#configuration-check)
...
### [Agent Panel Usage](https://zed.dev/docs/ai/mcp.html#agent-panel-usage)
...
However, if you want to *ensure* a given MCP server will be used, you can create [a custom profile](https://zed.dev/docs/ai/agent-panel.html#custom-profiles) where all built-in tools (or the ones that could cause conflicts with the server's tools) are turned off and only the tools coming from the MCP server are turned on.
...
### [Tool Permissions](https://zed.dev/docs/ai/mcp.html#tool-permissions)
...
### [External Agents](https://zed.dev/docs/ai/mcp.html#external-agents)

Note that for [external agents](https://zed.dev/docs/ai/external-agents.html) connected through the [Agent Client Protocol](https://agentclientprotocol.com/), access to MCP servers installed from Zed may vary depending on the ACP agent implementation.
...
### [Error Handling](https://zed.dev/docs/ai/mcp.html#error-handling)
