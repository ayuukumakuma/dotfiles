---
title: "Rules | AI Rules in Zed - .rules, .cursorrules, CLAUDE.md"
source_url: "https://zed.dev/docs/ai/rules"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Using Rules](https://zed.dev/docs/ai/rules.html#using-rules)

Rules are prompts that can be inserted either automatically at the beginning of each [Agent Panel](https://zed.dev/docs/ai/agent-panel.html) interaction, through `.rules` files available in your project's file tree, or on-demand, through @-mentioning, via the Rules Library.

## [`.rules` files](https://zed.dev/docs/ai/rules.html#rules-files)
...
## [Rules Library](https://zed.dev/docs/ai/rules.html#rules-library)
...
### [Opening the Rules Library](https://zed.dev/docs/ai/rules.html#opening-the-rules-library)
...
### [Managing Rules](https://zed.dev/docs/ai/rules.html#managing-rules)
...
### [Creating Rules](https://zed.dev/docs/ai/rules.html#creating-rules)
...
#### [Default Rules](https://zed.dev/docs/ai/rules.html#default-rules)
...
## [Migrating from Prompt Library](https://zed.dev/docs/ai/rules.html#migrating-from-prompt-library)
...
### [Slash Commands in Rules](https://zed.dev/docs/ai/rules.html#slash-commands-in-rules)
...
See the documentation for using [slash commands in rules](https://zed.dev/docs/ai/text-threads.html#slash-commands-in-rules) for more information.

### [Prompt templates](https://zed.dev/docs/ai/rules.html#prompt-templates)
...
For more details, see the [Rules Templates](https://zed.dev/docs/ai/text-threads.html#rule-templates) section under [Text Threads](https://zed.dev/docs/ai/text-threads.html).
