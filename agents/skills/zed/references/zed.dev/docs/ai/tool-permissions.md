---
title: "Tool Permissions | Zed Code Editor Documentation"
source_url: "https://zed.dev/docs/ai/tool-permissions"
...
Configure which [Agent Panel](https://zed.dev/docs/ai/agent-panel.html) tools run automatically and which require your approval.
For a list of available tools, [see the Tools page](https://zed.dev/docs/ai/tools.html).
...
## [Quick Start](https://zed.dev/docs/ai/tool-permissions.html#quick-start)
...
## [How It Works](https://zed.dev/docs/ai/tool-permissions.html#how-it-works)
...
## [Supported Tools](https://zed.dev/docs/ai/tool-permissions.html#supported-tools)
...
## [Configuration](https://zed.dev/docs/ai/tool-permissions.html#configuration)
...
### [Options](https://zed.dev/docs/ai/tool-permissions.html#options)
...
### [Pattern Syntax](https://zed.dev/docs/ai/tool-permissions.html#pattern-syntax)
...
## [Rule Precedence](https://zed.dev/docs/ai/tool-permissions.html#rule-precedence)
...
## [Global Auto-Approve](https://zed.dev/docs/ai/tool-permissions.html#global-auto-approve)
...
## [Shell Compatibility](https://zed.dev/docs/ai/tool-permissions.html#shell-compatibility)
...
## [Writing Patterns](https://zed.dev/docs/ai/tool-permissions.html#writing-patterns)
...
## [Built-in Security Rules](https://zed.dev/docs/ai/tool-permissions.html#built-in-security-rules)
...
The default settings file (`zed: open default settings`) includes commented-out examples for protecting `.env` files, secrets directories, and private keys — you can uncomment or adapt these to suit your needs.

## [Permission Request in the UI](https://zed.dev/docs/ai/tool-permissions.html#permission-request-in-the-ui)
...
Selecting "Always for " sets `tools.<tool>.default` to allow or deny.
When a pattern can be safely extracted, selecting "Always for " adds an `always_allow` or `always_deny` rule for that input.
MCP tools only support the tool-level option.

## [Examples](https://zed.dev/docs/ai/tool-permissions.html#examples)

### [Terminal: Auto-Approve Build Commands](https://zed.dev/docs/ai/tool-permissions.html#terminal-auto-approve-build-commands)
...
### [File Editing: Protect Sensitive Files](https://zed.dev/docs/ai/tool-permissions.html#file-editing-protect-sensitive-files)
...
### [Path Deletion: Block Critical Directories](https://zed.dev/docs/ai/tool-permissions.html#path-deletion-block-critical-directories)
...
### [URL Fetching: Control External Access](https://zed.dev/docs/ai/tool-permissions.html#url-fetching-control-external-access)
...
### [MCP Tools](https://zed.dev/docs/ai/tool-permissions.html#mcp-tools)
