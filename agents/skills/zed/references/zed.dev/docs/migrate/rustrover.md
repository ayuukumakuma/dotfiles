---
title: "RustRover | How to Migrate from RustRover to Zed"
source_url: "https://zed.dev/docs/migrate/rustrover"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [How to Migrate from RustRover to Zed](https://zed.dev/docs/migrate/rustrover.html#how-to-migrate-from-rustrover-to-zed)

This guide covers keybindings, settings, and the differences you'll encounter as a Rust developer switching from RustRover.

## [Install Zed](https://zed.dev/docs/migrate/rustrover.html#install-zed)
...
## [Set Up the JetBrains Keymap](https://zed.dev/docs/migrate/rustrover.html#set-up-the-jetbrains-keymap)
...
## [Set Up Editor Preferences](https://zed.dev/docs/migrate/rustrover.html#set-up-editor-preferences)
...
## [Open or Create a Project](https://zed.dev/docs/migrate/rustrover.html#open-or-create-a-project)
...
## [Differences in Keybindings](https://zed.dev/docs/migrate/rustrover.html#differences-in-keybindings)
...
### [Common Shared Keybindings](https://zed.dev/docs/migrate/rustrover.html#common-shared-keybindings)
...
### [Different Keybindings (RustRover → Zed)](https://zed.dev/docs/migrate/rustrover.html#different-keybindings-rustrover--zed)
...
### [Unique to Zed](https://zed.dev/docs/migrate/rustrover.html#unique-to-zed)
...
### [How to Customize Keybindings](https://zed.dev/docs/migrate/rustrover.html#how-to-customize-keybindings)
...
## [Differences in User Interfaces](https://zed.dev/docs/migrate/rustrover.html#differences-in-user-interfaces)

### [Different Analysis Engines](https://zed.dev/docs/migrate/rustrover.html#different-analysis-engines)
...
### [Project Configuration](https://zed.dev/docs/migrate/rustrover.html#project-configuration)
...
**Run configurations don't transfer.** RustRover stores run/debug configurations in `.idea`. These have no automatic migration path. You'll recreate them as Zed [tasks](https://zed.dev/docs/tasks.html) in `.zed/tasks.json` and debug configurations in `.zed/debug.json`.
...
### [No Cargo Integration UI](https://zed.dev/docs/migrate/rustrover.html#no-cargo-integration-ui)
...
### [Tool Windows vs. Docks](https://zed.dev/docs/migrate/rustrover.html#tool-windows-vs-docks)
...
### [Debugging](https://zed.dev/docs/migrate/rustrover.html#debugging)
...
### [Running Tests](https://zed.dev/docs/migrate/rustrover.html#running-tests)
...
### [Extensions vs. Plugins](https://zed.dev/docs/migrate/rustrover.html#extensions-vs-plugins)
...
### [What's Not in Zed](https://zed.dev/docs/migrate/rustrover.html#whats-not-in-zed)
...
## [A Note on Licensing and Telemetry](https://zed.dev/docs/migrate/rustrover.html#a-note-on-licensing-and-telemetry)
...
## [Collaboration in Zed vs. RustRover](https://zed.dev/docs/migrate/rustrover.html#collaboration-in-zed-vs-rustrover)
...
* Create a channel and [invite your collaborators](https://zed.dev/docs/collaboration.html#inviting-a-collaborator) to join
* [Share your screen or your codebase](https://zed.dev/docs/collaboration.html#share-a-project) directly
...
## [Using AI in Zed](https://zed.dev/docs/migrate/rustrover.html#using-ai-in-zed)

Zed has built-in AI features. If you've used JetBrains AI Assistant, here's how to get set up.

### [Configuring GitHub Copilot](https://zed.dev/docs/migrate/rustrover.html#configuring-github-copilot)
...
### [Additional AI Options](https://zed.dev/docs/migrate/rustrover.html#additional-ai-options)

To use other AI models in Zed, you have several options:

* Use Zed's hosted models, with higher rate limits. Requires [authentication](https://zed.dev/docs/authentication.html) and subscription to [Zed Pro](https://zed.dev/docs/ai/subscription.html).
...
## [Advanced Config and Productivity Tweaks](https://zed.dev/docs/migrate/rustrover.html#advanced-config-and-productivity-tweaks)
...
## [Next Steps](https://zed.dev/docs/migrate/rustrover.html#next-steps)

Now that you're set up, here are some resources to help you get the most out of Zed:

* [All Settings](https://zed.dev/docs/reference/all-settings.html) — Customize settings, themes, and editor behavior
* [Key Bindings](https://zed.dev/docs/key-bindings.html) — Learn how to customize and extend your keymap
* [Tasks](https://zed.dev/docs/tasks.html) — Set up build and run commands for your projects
* [AI Features](https://zed.dev/docs/ai/overview.html) — Explore Zed's AI capabilities beyond code completion
* [Collaboration](https://zed.dev/docs/collaboration/overview.html) — Share your projects and code together in real time
* [Rust in Zed](https://zed.dev/docs/languages/rust.html) — Rust-specific setup and configuration

[WebStorm](https://zed.dev/docs/migrate/webstorm.html "WebStorm")
