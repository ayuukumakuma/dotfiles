...
source_url: "https://zed.dev/docs/getting-started"
...
## [Quick Start](https://zed.dev/docs/getting-started.html#quick-start)

### [Welcome Page](https://zed.dev/docs/getting-started.html#welcome-page)
...
### [1. Open a Project](https://zed.dev/docs/getting-started.html#1-open-a-project)
...
### [2. Learn the Essential Commands](https://zed.dev/docs/getting-started.html#2-learn-the-essential-commands)
...
### [3. Configure Your Editor](https://zed.dev/docs/getting-started.html#3-configure-your-editor)
...
### [4. Set Up Your Language](https://zed.dev/docs/getting-started.html#4-set-up-your-language)
...
### [5. Try AI Features](https://zed.dev/docs/getting-started.html#5-try-ai-features)
...
## [Coming from Another Editor?](https://zed.dev/docs/getting-started.html#coming-from-another-editor)
...
## [Join the Community](https://zed.dev/docs/getting-started.html#join-the-community)
