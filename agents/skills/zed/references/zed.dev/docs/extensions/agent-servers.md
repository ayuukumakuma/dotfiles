---
title: "Agent Server Extensions | Agent Server Extensions"
source_url: "https://zed.dev/docs/extensions/agent-servers"
...
## [Defining Agent Server Extensions](https://zed.dev/docs/extensions/agent-servers.html#defining-agent-server-extensions)
...
### [Required Fields](https://zed.dev/docs/extensions/agent-servers.html#required-fields)
...
### [Target Configuration](https://zed.dev/docs/extensions/agent-servers.html#target-configuration)
...
### [Optional Fields](https://zed.dev/docs/extensions/agent-servers.html#optional-fields)
...
### [Environment Variables](https://zed.dev/docs/extensions/agent-servers.html#environment-variables)
...
### [Complete Example](https://zed.dev/docs/extensions/agent-servers.html#complete-example)
...
## [Installation Process](https://zed.dev/docs/extensions/agent-servers.html#installation-process)
...
## [Distribution Best Practices](https://zed.dev/docs/extensions/agent-servers.html#distribution-best-practices)

### [Use GitHub Releases](https://zed.dev/docs/extensions/agent-servers.html#use-github-releases)

GitHub Releases are a reliable way to distribute agent server binaries:

1. Build your agent for each platform (macOS ARM64, macOS x86\_64, Linux x86\_64, Windows x86\_64)
...
## [SHA-256 Hashes](https://zed.dev/docs/extensions/agent-servers.html#sha-256-hashes)

For better supply-chain security, include SHA-256 hashes of your archives in `extension.toml`. Here's how to generate one:

### [macOS and Linux](https://zed.dev/docs/extensions/agent-servers.html#macos-and-linux)

```
shasum -a 256 agent-darwin-arm64.tar.gz
```

### [Windows](https://zed.dev/docs/extensions/agent-servers.html#windows)
...
## [Testing](https://zed.dev/docs/extensions/agent-servers.html#testing)

To test your Agent Server Extension:

1. [Install it as a dev extension](https://zed.dev/docs/extensions/developing-extensions.html#developing-an-extension-locally)
2. Open the [Agent Panel](https://zed.dev/docs/ai/agent-panel.html)
3. Select your Agent Server from the list
4. Verify that it downloads, installs, and launches correctly
5. Test its functionality by conversing with it and watching the [ACP logs](https://zed.dev/docs/ai/external-agents.html#debugging-agents)

## [Icon Guideline](https://zed.dev/docs/extensions/agent-servers.html#icon-guideline)
...
## [Publishing](https://zed.dev/docs/extensions/agent-servers.html#publishing)

Once your extension is ready, see [Publishing your extension](https://zed.dev/docs/extensions/developing-extensions.html#publishing-your-extension) to learn how to submit it to the Zed extension registry.
