---
title: "Debugger Extensions | Debugger Extensions"
source_url: "https://zed.dev/docs/extensions/debugger-extensions"
...
[Debug Adapter Protocol](https://microsoft.github.io/debug-adapter-protocol) Servers can be exposed as extensions for use in the [debugger](https://zed.dev/docs/debugger.html).

## [Defining Debugger Extensions](https://zed.dev/docs/extensions/debugger-extensions.html#defining-debugger-extensions)
...
## [Defining Debug Locators](https://zed.dev/docs/extensions/debugger-extensions.html#defining-debug-locators)
...
Note that a `DebugScenario` can include a [build task](https://zed.dev/docs/debugger.html#build-tasks). If there is one, we will execute `run_dap_locator` after a build task is finished successfully.
...
## [Available Extensions](https://zed.dev/docs/extensions/debugger-extensions.html#available-extensions)
...
## [Testing](https://zed.dev/docs/extensions/debugger-extensions.html#testing)

To test your new Debug Adapter Protocol server extension, you can [install it as a dev extension](https://zed.dev/docs/extensions/developing-extensions.html#developing-an-extension-locally).
