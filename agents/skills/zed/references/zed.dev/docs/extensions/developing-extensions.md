---
title: "Developing Extensions | Developing Extensions"
source_url: "https://zed.dev/docs/extensions/developing-extensions"
...
## [Extension Features](https://zed.dev/docs/extensions/developing-extensions.html#extension-features)

Extensions can provide:

* [Languages](https://zed.dev/docs/extensions/languages.html)
* [Debuggers](https://zed.dev/docs/extensions/debugger-extensions.html)
...
* [MCP Servers](https://zed.dev/docs/extensions/mcp-extensions.html)

## [Developing an Extension Locally](https://zed.dev/docs/extensions/developing-extensions.html#developing-an-extension-locally)
...
## [Directory Structure of a Zed Extension](https://zed.dev/docs/extensions/developing-extensions.html#directory-structure-of-a-zed-extension)
...
> **Note:** If you are working on a theme extension with the intent to publish it later, suffix your theme extension ID with `-theme`. Otherwise, this may be raised during [extension publishing](https://zed.dev/docs/extensions/developing-extensions.html#publishing-your-extension).
...
## [WebAssembly](https://zed.dev/docs/extensions/developing-extensions.html#webassembly)
...
## [Forking and cloning the repo](https://zed.dev/docs/extensions/developing-extensions.html#forking-and-cloning-the-repo)
...
## [Extension License Requirements](https://zed.dev/docs/extensions/developing-extensions.html#extension-license-requirements)
...
## [Publishing your extension](https://zed.dev/docs/extensions/developing-extensions.html#publishing-your-extension)
...
## [Updating an extension](https://zed.dev/docs/extensions/developing-extensions.html#updating-an-extension)
...
> **Note:** If your extension repository has a different license, you'll need to update it to be one of the [accepted extension licenses](https://zed.dev/docs/extensions/developing-extensions.html#extension-license-requirements) before publishing your update.
