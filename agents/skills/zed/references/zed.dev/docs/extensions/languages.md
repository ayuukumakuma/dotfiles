---
title: "Language Extensions | Language Extensions"
source_url: "https://zed.dev/docs/extensions/languages"
...
## [Language Metadata](https://zed.dev/docs/extensions/languages.html#language-metadata)
...
* `line_comments` is an array of strings that are used to identify line comments in the language. This is used for the `editor::ToggleComments` keybind: `cmd-/|ctrl-k ctrl-c` for toggling lines of code.
...
## [Grammar](https://zed.dev/docs/extensions/languages.html#grammar)
...
## [Tree-sitter Queries](https://zed.dev/docs/extensions/languages.html#tree-sitter-queries)
...
### [Syntax highlighting](https://zed.dev/docs/extensions/languages.html#syntax-highlighting)
...
| @link\_text | Captures link text |
| @link\_uri | Captures link URIs |
...
| @punctuation.list\_marker | Captures list markers |
...
### [Bracket matching](https://zed.dev/docs/extensions/languages.html#bracket-matching)
...
### [Code outline/structure](https://zed.dev/docs/extensions/languages.html#code-outlinestructure)
...
| @annotation | Captures nodes that annotate outline item (doc comments, attributes, decorators)[1](https://zed.dev/docs/extensions/languages.html#1) |

1

These annotations are used by Assistant when generating code modification steps.

### [Auto-indentation](https://zed.dev/docs/extensions/languages.html#auto-indentation)
...
### [Code injections](https://zed.dev/docs/extensions/languages.html#code-injections)
...
### [Syntax overrides](https://zed.dev/docs/extensions/languages.html#syntax-overrides)
...
#### [Range inclusivity](https://zed.dev/docs/extensions/languages.html#range-inclusivity)
...
### [Text objects](https://zed.dev/docs/extensions/languages.html#text-objects)
...
### [Text redactions](https://zed.dev/docs/extensions/languages.html#text-redactions)
...
### [Runnable code detection](https://zed.dev/docs/extensions/languages.html#runnable-code-detection)
...
## [Language Servers](https://zed.dev/docs/extensions/languages.html#language-servers)
...
### [Syntax Highlighting with Semantic Tokens](https://zed.dev/docs/extensions/languages.html#syntax-highlighting-with-semantic-tokens)
...
#### [Extension-Provided Semantic Token Rules](https://zed.dev/docs/extensions/languages.html#extension-provided-semantic-token-rules)
...
#### [Customizing Semantic Token Styles](https://zed.dev/docs/extensions/languages.html#customizing-semantic-token-styles)
...
### [Multi-Language Support](https://zed.dev/docs/extensions/languages.html#multi-language-support)
...
[Debugger Extensions](https://zed.dev/docs/extensions/debugger-extensions.html "Debugger Extensions")
