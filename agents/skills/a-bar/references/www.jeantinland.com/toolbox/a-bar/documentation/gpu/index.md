...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/gpu/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/gpu/index.html#description)

The GPU widget displays GPU usage with a small graph.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/gpu/index.html#interactions)

* Click to open Activity Monitor.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/gpu/index.html#available-settings)

* `Show icon`: Show or hide the GPU icon. **Default is true**.
* `Graph color`: Theme color used for the graph. **Default is "cyan"**.
...
[MemoryPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/memory/index.html)[Network statsNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/network-stats/index.html)
