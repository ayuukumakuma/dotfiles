...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/layout-builder/index"
...
The **Layout builder** lets you configure bars per display and save them into profiles.

## Displays [#](https://www.jeantinland.com/toolbox/a-bar/documentation/layout-builder/index.html#displays)

* Add display configurations with a custom name.
* Each display can have a **top bar**, **bottom bar**, or both.
* Connected displays are detected automatically.

## Bars [#](https://www.jeantinland.com/toolbox/a-bar/documentation/layout-builder/index.html#bars)

* Enable/disable top and bottom bars.
* Edit a bar to assign widgets to **left**, **center**, and **right** sections.
* Drag and drop widgets to reorder.

## Profiles [#](https://www.jeantinland.com/toolbox/a-bar/documentation/layout-builder/index.html#profiles)

* Create multiple profiles for different workflows.
* Switch profiles from the system menu bar or with AppleScript.
...
[ConfigurationPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/configuration/index.html)[AutomationNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/automation/index.html)
