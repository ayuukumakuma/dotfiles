...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/github/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/github/index.html#description)

The GitHub widget shows your unread notifications count using the `gh` CLI.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/github/index.html#interactions)

* Click to open the notifications URL.
* Right‑click to refresh immediately.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/github/index.html#available-settings)

* `Show icon`: Show or hide the GitHub icon. **Default is true**.
* `GitHub CLI path`: Path to the `gh` binary. **Default is "/opt/homebrew/bin/gh"**.
* `Notifications URL`: URL opened on click. **Default is "<https://github.com/notifications>"**.
* `Hide when no notifications`: Hide when count is zero. **Default is false**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 600**.
...
[KeyboardPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/keyboard/index.html)[Hacker NewsNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/hacker-news/index.html)
