...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/battery/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/battery/index.html#description)

The Battery widget shows current battery percentage and charging state.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/battery/index.html#interactions)

* Click to toggle caffeinate (if enabled).

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/battery/index.html#available-settings)

* `Show icon`: Show or hide the battery icon. **Default is true**.
* `Toggle caffeinate on click`: Enable click-to-caffeinate. **Default is true**.
* `Caffeinate option`: Choose what to prevent (display/system/disk/all). **Default is "systemSleep"**.
* `Background color`: Theme color for the widget background. **Default is "magenta"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 10**.
...
[Process (AeroSpace)Previous article](https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-process/index.html)[WeatherNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index.html)
