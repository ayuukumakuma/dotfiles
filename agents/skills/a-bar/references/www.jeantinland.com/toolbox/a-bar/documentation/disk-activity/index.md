...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/disk-activity/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/disk-activity/index.html#description)

The Disk activity widget shows read/write throughput using a dual graph.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/disk-activity/index.html#interactions)

* Click to open Activity Monitor.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/disk-activity/index.html#available-settings)

* `Show icon`: Show or hide the read/write icons. **Default is true**.
* `Read graph color`: Theme color for read graph. **Default is "blue"**.
* `Write graph color`: Theme color for write graph. **Default is "red"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 4**.
...
[Network statsPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/network-stats/index.html)[StorageNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/storage/index.html)
