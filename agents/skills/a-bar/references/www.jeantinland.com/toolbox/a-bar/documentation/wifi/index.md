...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index.html#description)

The Wi‑Fi widget displays connection status and the current SSID.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index.html#interactions)

* Click to toggle Wi‑Fi (if enabled).
* Right‑click to open Network preferences.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index.html#available-settings)

* `Show icon`: Show or hide the Wi‑Fi icon. **Default is true**.
* `Toggle Wi‑Fi on click`: Enable click-to-toggle. **Default is true**.
* `Hide network name`: Hide the SSID label. **Default is false**.
* `Hide when disabled`: Hide the widget when Wi‑Fi is off. **Default is false**.
* `Network device`: Interface name (e.g., `en0`). **Default is "en0"**.
* `Background color`: Theme color for the widget background. **Default is "red"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 20**.
...
[TimePrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/time/index.html)[SoundNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/sound/index.html)
