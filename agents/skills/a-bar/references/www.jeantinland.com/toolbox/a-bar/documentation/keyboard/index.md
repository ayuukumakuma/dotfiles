...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/keyboard/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/keyboard/index.html#description)

The Keyboard widget shows the active keyboard layout.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/keyboard/index.html#interactions)

* Left‑click to open Keyboard preferences.
* Right‑click to refresh the widget.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/keyboard/index.html#available-settings)

* `Show icon`: Show or hide the keyboard icon. **Default is true**.
* `Background color`: Theme color for the widget background. **Default is "mainAlt"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 5**.
...
[MicrophonePrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/microphone/index.html)[GitHubNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/github/index.html)
