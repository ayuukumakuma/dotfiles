...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/layout-settings/index"
...
## Layout builder [#](https://www.jeantinland.com/toolbox/a-bar/documentation/layout-settings/index.html#layout-builder)

The **Layout** tab opens the layout builder where you can:

* Manage display configurations
* Enable top and/or bottom bars per display
* Drag and drop widgets into left, center, and right sections
* Save layouts into profiles
...
[Appearance settingsPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/appearance-settings/index.html)
