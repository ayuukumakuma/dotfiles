...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/date/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/date/index.html#description)

The Date widget shows the current date using your preferred format and locale.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/date/index.html#interactions)

* Click to open the configured calendar app.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/date/index.html#available-settings)

* `Show icon`: Show or hide the calendar icon. **Default is true**.
* `Short format`: Use a short date format. **Default is false**.
* `Locale`: Locale identifier (e.g., `en-UK`). **Default is "en-UK"**.
* `Calendar app`: App name or path to open on click. **Default is "Calendar"**.
* `Background color`: Theme color for the widget background. **Default is "cyan"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 30**.
...
[WeatherPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index.html)[TimeNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/time/index.html)
