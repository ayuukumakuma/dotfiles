...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/general-settings/index"
...
## General options [#](https://www.jeantinland.com/toolbox/a-bar/documentation/general-settings/index.html#general-options)

* `Launch at login`: Start *a-bar* when you sign in.
* `Window manager`: Choose between **yabai** and **AeroSpace**. **Default is yabai**.
* `yabai binary path`: Absolute path to `yabai`. **Default is `/opt/homebrew/bin/yabai`**.
* `AeroSpace binary path`: Absolute path to `aerospace`. **Default is `/opt/homebrew/bin/aerospace`**.
...
[SettingsPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/settings/index.html)[Appearance settingsNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/appearance-settings/index.html)
