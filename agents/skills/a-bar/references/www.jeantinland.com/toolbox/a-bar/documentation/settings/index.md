...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/settings/index"
...
## Where are settings stored? [#](https://www.jeantinland.com/toolbox/a-bar/documentation/settings/index.html#where-are-settings-stored)

*a-bar* stores settings in UserDefaults and in `~/.a-barrc`. The file is updated whenever you save changes in the app.

## Opening the settings window [#](https://www.jeantinland.com/toolbox/a-bar/documentation/settings/index.html#opening-the-settings-window)

Open the settings window from the system menu bar. Changes are staged until you click **Save Changes**.

## Configuration approach [#](https://www.jeantinland.com/toolbox/a-bar/documentation/settings/index.html#configuration-approach)

Use the **Settings** tabs for UI-based configuration. The JSON file is meant for backup or manual edits if needed.
...
[Custom widgetsPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/custom-widgets/index.html)[General settingsNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/general-settings/index.html)
