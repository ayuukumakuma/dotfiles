...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index"
...
## Requirements [#](https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index.html#requirements)

* macOS 13.0 or later
* [yabai](https://github.com/koekeishiya/yabai) or [AeroSpace](https://github.com/nikitabobko/AeroSpace)
...
## Install with Homebrew [#](https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index.html#install-with-homebrew)
...
**Warning:** [Homebrew installation](https://github.com/Jean-Tinland/homebrew-a-bar/blob/main/Casks/a-bar.rb) script automatically removes the `com.apple.quarantine` attribute. That way, the app should work out of the box without having to open System Settings to allow it.

## Install from release [#](https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index.html#install-from-release)
...
4. Launch *a-bar*. If macOS blocks it, open **System Settings → Privacy & Security** and click **Open Anyway**.
5. Grant required permissions when prompted.

(\*) I'm not planning to notarize the app as it would cost almost $100/year.

## Build from source [#](https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index.html#build-from-source)
...
[FeaturesPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/features/index.html)[ConfigurationNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/configuration/index.html)
