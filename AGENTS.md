...
- 現在のリポジトリ内スキル: `a-bar`、`aerospace`、`code-simplifier`、`conventional-commit`、`difit-review`、`empirical-prompt-tuning`、`frontend-design`、`ghostty`、`grill-me`、`justfile`、`lazy.nvim`、`nix-darwin`、`viteplus`、`wezterm`、`zed`。
