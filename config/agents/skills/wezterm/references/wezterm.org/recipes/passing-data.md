---
title: "Passing Data from a pane to Lua - Wez's Terminal Emulator"
source_url: "https://wezterm.org/recipes/passing-data"
...
* Configuration
  ...
  + [Recipes](https://wezterm.org/recipes/index.html)
    ...
    - Passing Data from a pane to Lua
      ...
      Table of contents
      * [User Vars](https://wezterm.org/recipes/passing-data.html#user-vars)
      * [OSC 0, 1, 2 for setting the Window/Pane Title](https://wezterm.org/recipes/passing-data.html#osc-0-1-2-for-setting-the-windowpane-title)
      * [OSC 7 for setting the current working directory](https://wezterm.org/recipes/passing-data.html#osc-7-for-setting-the-current-working-directory)
      * [Local Process State](https://wezterm.org/recipes/passing-data.html#local-process-state)
...
# Passing Data from a pane to Lua[¶](https://wezterm.org/recipes/passing-data.html#passing-data-from-a-pane-to-lua "Permanent link")
...
## User Vars[¶](https://wezterm.org/recipes/passing-data.html#user-vars "Permanent link")
...
* [user-var-changed](https://wezterm.org/config/lua/window-events/user-var-changed.html), which
  allows you to directly take action when a var is set/changed.
* [update-status](https://wezterm.org/config/lua/window-events/update-status.html) which allows you to update left/right status items
...
[pane:get\_user\_vars()](https://wezterm.org/config/lua/pane/get_user_vars.html), or by accessing
the `user_vars` field in a [PaneInformation](https://wezterm.org/config/lua/PaneInformation.html)
struct.
...
If you install the [wezterm shell integration](https://wezterm.org/shell-integration.html) you
...
## OSC 0, 1, 2 for setting the Window/Pane Title[¶](https://wezterm.org/recipes/passing-data.html#osc-0-1-2-for-setting-the-windowpane-title "Permanent link")
...
[pane:get\_title()](https://wezterm.org/config/lua/pane/get_title.html) and/or the
[PaneInformation](https://wezterm.org/config/lua/PaneInformation.html) `title` field can be used
...
## OSC 7 for setting the current working directory[¶](https://wezterm.org/recipes/passing-data.html#osc-7-for-setting-the-current-working-directory "Permanent link")
...
[pane:get\_current\_working\_dir()](https://wezterm.org/config/lua/pane/get_current_working_dir.html)
and/or the [PaneInformation](https://wezterm.org/config/lua/PaneInformation.html)
...
Installing the [wezterm shell integration](https://wezterm.org/shell-integration.html) will
arrange for bash/zsh to set OSC 7 for you.

## Local Process State[¶](https://wezterm.org/recipes/passing-data.html#local-process-state "Permanent link")
...
* [pane:get\_foreground\_process\_info()](https://wezterm.org/config/lua/pane/get_foreground_process_info.html) -
  returns information about the process hierarchy in a pane
* [wezterm.procinfo.get\_info\_for\_pid()](https://wezterm.org/config/lua/wezterm.procinfo/get_info_for_pid.html) -
...
[Pane](https://wezterm.org/config/lua/pane/index.html) object and in the
[wezterm.procinfo](https://wezterm.org/config/lua/wezterm.procinfo/index.html) module.
