---
title: "Workspaces / Sessions - Wez's Terminal Emulator"
source_url: "https://wezterm.org/recipes/workspaces"
...
# Workspaces / Sessions[¶](https://wezterm.org/recipes/workspaces.html#workspaces-sessions "Permanent link")
...
Every [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) is associated with a
...
* [ShowLauncher](https://wezterm.org/config/lua/keyassignment/ShowLauncher.html) and
  [ShowLauncherArgs](https://wezterm.org/config/lua/keyassignment/ShowLauncherArgs.html) will list
