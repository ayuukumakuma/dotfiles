---
title: "Copy Mode - Wez's Terminal Emulator"
source_url: "https://wezterm.org/copymode"
...
* [WezTerm](https://wezterm.org/index.html)
  ...
  + Copy Mode
    ...
    Table of contents
    - [Key Assignments](https://wezterm.org/copymode.html#key-assignments)
    - [Configurable Key Assignments](https://wezterm.org/copymode.html#configurable-key-assignments)
...
mode](https://wezterm.org/quickselect.html) but is geared up for describing selections based on
keyboard control, whereas quick select mode is used to quickly select and
copy commonly used patterns. The [colors](https://wezterm.org/config/appearance.html#defining-your-own-colors)
...
### Key Assignments[¶](https://wezterm.org/copymode.html#key-assignments "Permanent link")
...
### Configurable Key Assignments[¶](https://wezterm.org/copymode.html#configurable-key-assignments "Permanent link")
...
The key assignments for copy mode are specified by the `copy_mode` [Key Table](https://wezterm.org/config/key-tables.html).
