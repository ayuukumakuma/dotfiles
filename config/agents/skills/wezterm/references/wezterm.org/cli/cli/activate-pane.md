---
title: "activate-pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/activate-pane"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - activate-pane
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/activate-pane.html#synopsis)
...
# `wezterm cli activate-pane`[¶](https://wezterm.org/cli/cli/activate-pane.html#wezterm-cli-activate-pane "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/activate-pane.html#synopsis "Permanent link")
