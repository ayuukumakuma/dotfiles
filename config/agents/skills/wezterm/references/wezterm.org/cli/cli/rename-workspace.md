---
title: "rename-workspace - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/cli/rename-workspace"
...
* CLI Reference
  ...
  + [wezterm cli](https://wezterm.org/cli/cli/index.html)
    ...
    - rename-workspace
      ...
      Table of contents
      * [Synopsis](https://wezterm.org/cli/cli/rename-workspace.html#synopsis)
...
# `wezterm cli rename-workspace NEW-NAME`[¶](https://wezterm.org/cli/cli/rename-workspace.html#wezterm-cli-rename-workspace-new-name "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/cli/rename-workspace.html#synopsis "Permanent link")
