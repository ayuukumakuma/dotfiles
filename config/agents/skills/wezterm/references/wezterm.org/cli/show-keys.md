---
title: "wezterm show-keys - Wez's Terminal Emulator"
source_url: "https://wezterm.org/cli/show-keys"
...
* CLI Reference
  ...
  + wezterm show-keys
    ...
    Table of contents
    - [Synopsis](https://wezterm.org/cli/show-keys.html#synopsis)
...
# `wezterm show-keys`[¶](https://wezterm.org/cli/show-keys.html#wezterm-show-keys "Permanent link")
...
## Synopsis[¶](https://wezterm.org/cli/show-keys.html#synopsis "Permanent link")
...
Options:
      ...
      --key-table <KEY_TABLE>  In lua mode, show only the named key table
  -h, --help                   Print help
```
