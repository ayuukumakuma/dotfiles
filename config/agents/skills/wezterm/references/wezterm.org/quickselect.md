---
title: "Quick Select Mode - Wez's Terminal Emulator"
source_url: "https://wezterm.org/quickselect"
...
from the [quick\_select\_alphabet](https://wezterm.org/config/lua/config/quick_select_alphabet.html)
configuration. The [colors](https://wezterm.org/config/appearance.html#defining-your-own-colors)
...
![Screenshot demonstrating the quickselect text highlights](https://wezterm.org/screenshots/wezterm-quick-select.png)
...
A configuration option [quick\_select\_remove\_styling](https://wezterm.org/config/lua/config/quick_select_remove_styling.html)
