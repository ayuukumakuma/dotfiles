---
title: "Keyboard Concepts - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/keyboard-concepts"
...
* Configuration
  ...
  + Keyboard Concepts
    ...
    Table of contents
    - [Keyboard Processing Flow](https://wezterm.org/config/keyboard-concepts.html#keyboard-processing-flow)
    - [Alt / Option Key Behavior & Composed Keys](https://wezterm.org/config/keyboard-concepts.html#alt-option-key-behavior-composed-keys)

      * [Layouts with an AltGr key](https://wezterm.org/config/keyboard-concepts.html#layouts-with-an-altgr-key)
      * [Microsoft Windows and Ctrl-Alt <-> AltGr](https://wezterm.org/config/keyboard-concepts.html#microsoft-windows-and-ctrl-alt-altgr)
      * [macOS Left and Right Option Key](https://wezterm.org/config/keyboard-concepts.html#macos-left-and-right-option-key)
      * [Input Method Editor (IME)](https://wezterm.org/config/keyboard-concepts.html#input-method-editor-ime)
      * [Dead Keys](https://wezterm.org/config/keyboard-concepts.html#dead-keys)
      * [Defining Assignments for key combinations that may be composed](https://wezterm.org/config/keyboard-concepts.html#defining-assignments-for-key-combinations-that-may-be-composed)
...
## Keyboard Processing Flow[¶](https://wezterm.org/config/keyboard-concepts.html#keyboard-processing-flow "Permanent link")
...
## Alt / Option Key Behavior & Composed Keys[¶](https://wezterm.org/config/keyboard-concepts.html#alt-option-key-behavior-composed-keys "Permanent link")
...
### Layouts with an AltGr key[¶](https://wezterm.org/config/keyboard-concepts.html#layouts-with-an-altgr-key "Permanent link")
...
### Microsoft Windows and Ctrl-Alt <-> AltGr[¶](https://wezterm.org/config/keyboard-concepts.html#microsoft-windows-and-ctrl-alt-altgr "Permanent link")

If you are using VNC and a keyboard layout with dead keys, then you may wish to
enable
[treat\_left\_ctrlalt\_as\_altgr](https://wezterm.org/config/lua/config/treat_left_ctrlalt_as_altgr.html).

### macOS Left and Right Option Key[¶](https://wezterm.org/config/keyboard-concepts.html#macos-left-and-right-option-key "Permanent link")

*Since: Version 20200620-160318-e00b076c*

*The functionality described in this section requires version 20200620-160318-e00b076c of wezterm,
...
*The functionality described in this section requires version 20210203-095643-70a364eb of wezterm,
or a more recent version.*
...
### Input Method Editor (IME)[¶](https://wezterm.org/config/keyboard-concepts.html#input-method-editor-ime "Permanent link")

WezTerm has support for using the operating system Input Method Editor (IME) on
some operating systems.

[The `use_ime` docs have more information](https://wezterm.org/config/lua/config/use_ime.html).

### Dead Keys[¶](https://wezterm.org/config/keyboard-concepts.html#dead-keys "Permanent link")
...
### Defining Assignments for key combinations that may be composed[¶](https://wezterm.org/config/keyboard-concepts.html#defining-assignments-for-key-combinations-that-may-be-composed "Permanent link")
