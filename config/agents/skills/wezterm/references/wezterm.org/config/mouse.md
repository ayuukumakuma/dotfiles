---
title: "Mouse Binding - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/mouse"
...
* Configuration
  ...
  + Mouse Binding
    ...
    Table of contents
    - [Default Mouse Assignments](https://wezterm.org/config/mouse.html#default-mouse-assignments)
    - [Configuring Mouse Assignments](https://wezterm.org/config/mouse.html#configuring-mouse-assignments)
    - [Gotcha on binding an 'Up' event only](https://wezterm.org/config/mouse.html#gotcha-on-binding-an-up-event-only)
    - [Available Actions](https://wezterm.org/config/mouse.html#available-actions)
...
The [bypass\_mouse\_reporting\_modifiers](https://wezterm.org/config/lua/config/bypass_mouse_reporting_modifiers.html)
option allows you to specify an alternative set of modifiers to use for
bypassing mouse reporting capture.

## Default Mouse Assignments[¶](https://wezterm.org/config/mouse.html#default-mouse-assignments "Permanent link")
...
| Single Left Down | `ALT` | `act.SelectTextAtMouseCursor("Block")` (*Since: Version 20220624-141144-bd1b7c5d*) |
...
| Single Left Up | `ALT` | `act.CompleteSelection("ClipboardAndPrimarySelection")` (*Since: Version 20220624-141144-bd1b7c5d*) |
...
| Single Left Drag | `ALT` | `act.ExtendSelectionToMouseCursor("Block")` (*Since: Version 20220624-141144-bd1b7c5d*) |
| Single Left Down | `ALT+SHIFT` | `act.ExtendSelectionToMouseCursor("Block")` (*Since: Version 20220624-141144-bd1b7c5d*) |
| Single Left Up | `ALT+SHIFT` | `act.CompleteSelection("ClipboardAndPrimarySelection")` (*Since: Version 20220624-141144-bd1b7c5d*) |
...
## Configuring Mouse Assignments[¶](https://wezterm.org/config/mouse.html#configuring-mouse-assignments "Permanent link")
...
* `mods` - the keyboard modifier keys that must be active in order to match the event.
  ...
  in more detail in [Configuring Key Assignments](https://wezterm.org/config/keys.html#configuring-key-assignments).
...
* `mouse_reporting` - an optional boolean that defaults to `false`. This mouse binding
  ...
  key](https://wezterm.org/config/lua/config/bypass_mouse_reporting_modifiers.html). (*Since: Version 20220807-113146-c2fee766*)
* `alt_screen` - an optional field that defaults to `'Any'`, but that can also
  ...
  the terminal in alt screen mode. (*Since: Version 20220807-113146-c2fee766*).
...
[`window:current_event`](https://wezterm.org/config/lua/window/current_event.html), if to access the actual
...
# Gotcha on binding an 'Up' event only[¶](https://wezterm.org/config/mouse.html#gotcha-on-binding-an-up-event-only "Permanent link")
...
you may experience *unintuitive behavior* as the program receives the 'Down'
...
# Available Actions[¶](https://wezterm.org/config/mouse.html#available-actions "Permanent link")

See the [`KeyAssignment` reference](https://wezterm.org/config/lua/keyassignment/index.html) for information
