---
title: "Plugins - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/plugins"
...
* Configuration
  ...
  + Plugins
    ...
    Table of contents
    - [Introduction](https://wezterm.org/config/plugins.html#introduction)
    - [Installing a Plugin](https://wezterm.org/config/plugins.html#installing-a-plugin)
    - [Updating Plugins](https://wezterm.org/config/plugins.html#updating-plugins)
    - [Removing a Plugin](https://wezterm.org/config/plugins.html#removing-a-plugin)
    - [Developing a Plugin](https://wezterm.org/config/plugins.html#developing-a-plugin)

      * [Managing a Plugin with Multiple Lua Modules](https://wezterm.org/config/plugins.html#managing-a-plugin-with-multiple-lua-modules)
    - [Making changes to a Existing Plugin](https://wezterm.org/config/plugins.html#making-changes-to-a-existing-plugin)
...
## Introduction[¶](https://wezterm.org/config/plugins.html#introduction "Permanent link")
...
## Installing a Plugin[¶](https://wezterm.org/config/plugins.html#installing-a-plugin "Permanent link")
...
## Updating Plugins[¶](https://wezterm.org/config/plugins.html#updating-plugins "Permanent link")

When changes are published to a plugin repository they are not updated in the local Wezterm instance.

Run the command [`wezterm.plugin.update_all()`](https://wezterm.org/config/lua/wezterm.plugin/update_all.html) to update all local plugins.

Tip

This can be run using the Lua REPL in [DebugOverlay](https://wezterm.org/troubleshooting.html#debug-overlay).

## Removing a Plugin[¶](https://wezterm.org/config/plugins.html#removing-a-plugin "Permanent link")

When a plugin is first referenced, [`wezterm.plugin.require()`](https://wezterm.org/config/lua/wezterm.plugin/require.html) will clone the repo if it doesn't already
exist and store it in the runtime directory under `plugins/NAME` where
`NAME` is derived from the repo URL.

You can discover locations of the various plugins with [`wezterm.plugin.list()`](https://wezterm.org/config/lua/wezterm.plugin/list.html).

To remove the plugin simply delete the appropriate plugin directory.

## Developing a Plugin[¶](https://wezterm.org/config/plugins.html#developing-a-plugin "Permanent link")
...
When changes are made to the local project, [`wezterm.plugin.update_all()`](https://wezterm.org/config/lua/wezterm.plugin/update_all.html) must be run
...
### Managing a Plugin with Multiple Lua Modules[¶](https://wezterm.org/config/plugins.html#managing-a-plugin-with-multiple-lua-modules "Permanent link")
...
## Making changes to a Existing Plugin[¶](https://wezterm.org/config/plugins.html#making-changes-to-a-existing-plugin "Permanent link")
