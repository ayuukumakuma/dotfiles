---
title: "wezterm.strftime_utc - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/strftime_utc"
...
# `wezterm.strftime_utc(format)`[¶](https://wezterm.org/config/lua/wezterm/strftime_utc.html#weztermstrftime_utcformat "Permanent link")
...
See also [strftime](https://wezterm.org/config/lua/wezterm/strftime.html) and [wezterm.time](https://wezterm.org/config/lua/wezterm.time/index.html).
