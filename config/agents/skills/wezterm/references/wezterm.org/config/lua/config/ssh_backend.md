---
title: "ssh_backend - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/ssh_backend"
...
# `ssh_backend = "Libssh"`[¶](https://wezterm.org/config/lua/config/ssh_backend.html#ssh_backend-libssh "Permanent link")
