---
title: "tabs - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/tabs"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - tabs
      ...
      Table of contents
      * [window:tabs()](https://wezterm.org/config/lua/mux-window/tabs.html#windowtabs)
...
## window:tabs()[¶](https://wezterm.org/config/lua/mux-window/tabs.html#windowtabs "Permanent link")
...
Returns an array table holding each of the [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html) objects
