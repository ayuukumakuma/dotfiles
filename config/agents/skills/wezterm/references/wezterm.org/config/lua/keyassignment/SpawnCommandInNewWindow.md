---
title: "SpawnCommandInNewWindow - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SpawnCommandInNewWindow"
...
# `SpawnCommandInNewWindow`[¶](https://wezterm.org/config/lua/keyassignment/SpawnCommandInNewWindow.html#spawncommandinnewwindow "Permanent link")

Spawn a new tab into a brand new window.
The argument is a `SpawnCommand` struct that is discussed in more
detail in the [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) docs.
