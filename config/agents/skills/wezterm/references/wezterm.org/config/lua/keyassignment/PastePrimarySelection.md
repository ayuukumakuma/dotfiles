---
title: "PastePrimarySelection - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/PastePrimarySelection"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - PastePrimarySelection
      ...
      Table of contents
      * [Example](https://wezterm.org/config/lua/keyassignment/PastePrimarySelection.html#example)
...
# `PastePrimarySelection`[¶](https://wezterm.org/config/lua/keyassignment/PastePrimarySelection.html#pasteprimaryselection "Permanent link")

X11: Paste the Primary Selection to the current tab.
On other systems, this behaves identically to [Paste](https://wezterm.org/config/lua/keyassignment/Paste.html).
...
a future release; please use [PasteFrom](https://wezterm.org/config/lua/keyassignment/PasteFrom.html) instead.
...
This action has been removed. Please use [PasteFrom](https://wezterm.org/config/lua/keyassignment/PasteFrom.html) instead.

## Example[¶](https://wezterm.org/config/lua/keyassignment/PastePrimarySelection.html#example "Permanent link")
