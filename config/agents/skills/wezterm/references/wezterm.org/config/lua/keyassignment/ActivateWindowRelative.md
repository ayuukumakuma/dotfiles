---
title: "ActivateWindowRelative - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ActivateWindowRelative"
...
# `ActivateWindowRelative(delta)`[¶](https://wezterm.org/config/lua/keyassignment/ActivateWindowRelative.html#activatewindowrelativedelta "Permanent link")
...
See also [ActivateWindowRelativeNoWrap](https://wezterm.org/config/lua/keyassignment/ActivateWindowRelativeNoWrap.html),
[ActivateWindow](https://wezterm.org/config/lua/keyassignment/ActivateWindow.html).
