---
title: "get_lines_as_text - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_lines_as_text"
...
# `pane:get_lines_as_text([nlines])`[¶](https://wezterm.org/config/lua/pane/get_lines_as_text.html#paneget_lines_as_textnlines "Permanent link")
...
[pane:get\_logical\_lines\_as\_text](https://wezterm.org/config/lua/pane/get_logical_lines_as_text.html).
...
# Example: opening whole scrollback in vim[¶](https://wezterm.org/config/lua/pane/get_lines_as_text.html#example-opening-whole-scrollback-in-vim "Permanent link")
...
See also: [pane:get\_lines\_as\_escapes()](https://wezterm.org/config/lua/pane/get_lines_as_escapes.html).
