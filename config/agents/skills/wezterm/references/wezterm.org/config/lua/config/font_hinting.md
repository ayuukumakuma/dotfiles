---
title: "font_hinting - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/font_hinting"
...
# `font_hinting = "Full"`[¶](https://wezterm.org/config/lua/config/font_hinting.html#font_hinting-full "Permanent link")
