...
source_url: "https://wezterm.org/config/lua/mux-window/set_title"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - set\_title
      ...
      Table of contents
      * [window:set\_title(TITLE)](https://wezterm.org/config/lua/mux-window/set_title.html#windowset_titletitle)
...
## window:set\_title(TITLE)[¶](https://wezterm.org/config/lua/mux-window/set_title.html#windowset_titletitle "Permanent link")
