---
title: "window-resized - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/window-resized"
...
# `window-resized`[¶](https://wezterm.org/config/lua/window-events/window-resized.html#window-resized "Permanent link")
...
[window-config-reloaded](https://wezterm.org/config/lua/window-events/window-config-reloaded.html) events are connected to the
