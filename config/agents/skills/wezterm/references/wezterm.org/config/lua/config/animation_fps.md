---
title: "animation_fps - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/animation_fps"
...
# `animation_fps = 10`[¶](https://wezterm.org/config/lua/config/animation_fps.html#animation_fps-10 "Permanent link")
...
If you are running with a CPU renderer (eg: you have [front\_end](https://wezterm.org/config/lua/config/front_end.html)
