---
title: "enable_csi_u_key_encoding - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/enable_csi_u_key_encoding"
...
# `enable_csi_u_key_encoding = false`[¶](https://wezterm.org/config/lua/config/enable_csi_u_key_encoding.html#enable_csi_u_key_encoding-false "Permanent link")

When set to `true`, the [keyboard encoding](https://wezterm.org/config/key-encoding.html) will be
