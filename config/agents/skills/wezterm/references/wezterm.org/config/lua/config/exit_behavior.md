---
title: "exit_behavior - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/exit_behavior"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - exit\_behavior
      ...
      Table of contents
      * [exit\_behavior = "CloseOnCleanExit"](https://wezterm.org/config/lua/config/exit_behavior.html#exit_behavior-closeoncleanexit)
...
## `exit_behavior = "CloseOnCleanExit"`[¶](https://wezterm.org/config/lua/config/exit_behavior.html#exit_behavior-closeoncleanexit "Permanent link")
...
* `"Hold"` - keep the pane open after the program exits. The pane must be manually closed via [CloseCurrentPane](https://wezterm.org/config/lua/keyassignment/CloseCurrentPane.html), [CloseCurrentTab](https://wezterm.org/config/lua/keyassignment/CloseCurrentTab.html) or closing the window.
...
See also: [clean\_exit\_codes](https://wezterm.org/config/lua/config/clean_exit_codes.html) for fine tuning what is
