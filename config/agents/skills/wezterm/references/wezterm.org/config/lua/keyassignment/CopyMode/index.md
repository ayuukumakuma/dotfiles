---
title: "enum: CopyModeAssignment - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/CopyMode/index"
...
* [Available Key Assignments](https://wezterm.org/config/lua/keyassignment/CopyMode/index.html#available-key-assignments)

# `CopyModeAssignment` enumeration[¶](https://wezterm.org/config/lua/keyassignment/CopyMode/index.html#copymodeassignment-enumeration "Permanent link")

Represents a pre-defined function that can be applied
to control [CopyMode](https://wezterm.org/copymode.html) and [Search Mode](https://wezterm.org/scrollback.html#searching-the-scrollback).

## Available Key Assignments[¶](https://wezterm.org/config/lua/keyassignment/CopyMode/index.html#available-key-assignments "Permanent link")
