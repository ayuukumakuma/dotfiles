---
title: "disable_default_quick_select_patterns - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/disable_default_quick_select_patterns"
...
# `disable_default_quick_select_patterns = false`[¶](https://wezterm.org/config/lua/config/disable_default_quick_select_patterns.html#disable_default_quick_select_patterns-false "Permanent link")
...
are omitted, and your [quick\_select\_patterns](https://wezterm.org/config/lua/config/quick_select_patterns.html)
config specifies the total set of patterns used for [quick select mode](https://wezterm.org/quickselect.html).
