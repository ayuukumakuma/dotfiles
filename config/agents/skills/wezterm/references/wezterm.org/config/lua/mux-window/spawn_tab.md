---
title: "spawn_tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/spawn_tab"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - spawn\_tab
      ...
      Table of contents
      * [window:spawn\_tab{}](https://wezterm.org/config/lua/mux-window/spawn_tab.html#windowspawn_tab)

        + [args](https://wezterm.org/config/lua/mux-window/spawn_tab.html#args)
        + [cwd](https://wezterm.org/config/lua/mux-window/spawn_tab.html#cwd)
        + [set\_environment\_variables](https://wezterm.org/config/lua/mux-window/spawn_tab.html#set_environment_variables)
        + [domain](https://wezterm.org/config/lua/mux-window/spawn_tab.html#domain)
...
## `window:spawn_tab{}`[¶](https://wezterm.org/config/lua/mux-window/spawn_tab.html#windowspawn_tab "Permanent link")
...
[MuxTab](https://wezterm.org/config/lua/MuxTab/index.html), [Pane](https://wezterm.org/config/lua/pane/index.html) and
[MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) objects associated with it:
...
### args[¶](https://wezterm.org/config/lua/mux-window/spawn_tab.html#args "Permanent link")
...
### cwd[¶](https://wezterm.org/config/lua/mux-window/spawn_tab.html#cwd "Permanent link")
...
### set\_environment\_variables[¶](https://wezterm.org/config/lua/mux-window/spawn_tab.html#set_environment_variables "Permanent link")
...
### domain[¶](https://wezterm.org/config/lua/mux-window/spawn_tab.html#domain "Permanent link")
