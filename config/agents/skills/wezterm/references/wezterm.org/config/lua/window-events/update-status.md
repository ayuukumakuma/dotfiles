---
title: "update-status - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/update-status"
...
# `update-status`[¶](https://wezterm.org/config/lua/window-events/update-status.html#update-status "Permanent link")
...
[window:set\_right\_status](https://wezterm.org/config/lua/window/set_right_status.html) or [window:set\_left\_status](https://wezterm.org/config/lua/window/set_left_status.html).
