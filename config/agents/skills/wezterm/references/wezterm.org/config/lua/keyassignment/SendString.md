---
title: "SendString - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SendString"
...
# `SendString`[¶](https://wezterm.org/config/lua/keyassignment/SendString.html#sendstring "Permanent link")
...
See also [SendKey](https://wezterm.org/config/lua/keyassignment/SendKey.html) which makes the example above much more convenient,
and [Multiple](https://wezterm.org/config/lua/keyassignment/Multiple.html) for combining multiple actions in a single press.
