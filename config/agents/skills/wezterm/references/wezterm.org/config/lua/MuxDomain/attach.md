---
title: "attach - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/attach"
...
# `domain:attach()`[¶](https://wezterm.org/config/lua/MuxDomain/attach.html#domainattach "Permanent link")
...
Unlike the [AttachDomain](https://wezterm.org/config/lua/keyassignment/AttachDomain.html) key assignment,
...
used in the [gui-startup](https://wezterm.org/config/lua/gui-events/gui-startup.html) event.

If the domain is already attached, calling this method again has no effect.

See also: [domain:detach()](https://wezterm.org/config/lua/MuxDomain/detach.html) and [domain:state()](https://wezterm.org/config/lua/MuxDomain/state.html).
