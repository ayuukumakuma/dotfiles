---
title: "move_to_new_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/move_to_new_window"
...
# `pane:move_to_new_window([WORKSPACE])`[¶](https://wezterm.org/config/lua/pane/move_to_new_window.html#panemove_to_new_windowworkspace "Permanent link")
...
Returns the newly created [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html) object, and the
newly created [MuxWindow](https://wezterm.org/config/lua/mux-window/index.html) object.
...
[wezterm cli move-pane-to-new-tab](https://wezterm.org/cli/cli/move-pane-to-new-tab.html).
