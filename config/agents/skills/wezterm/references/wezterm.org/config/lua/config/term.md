---
title: "term - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/term"
...
# `term = "xterm-256color"`[¶](https://wezterm.org/config/lua/config/term.html#term-xterm-256color "Permanent link")
...
If you are using WSL, wezterm will automatically populate `WSLENV` to properly set TERM, COLORTERM, TERM\_PROGRAM and TERM\_PROGRAM\_VERSION in the environment when crossing between win32 and WSL environments.
