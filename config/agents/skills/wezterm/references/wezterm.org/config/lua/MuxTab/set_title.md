---
title: "set_title - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/set_title"
...
# `tab:set_title(TITLE)`[¶](https://wezterm.org/config/lua/MuxTab/set_title.html#tabset_titletitle "Permanent link")
...
title](https://wezterm.org/config/lua/keyassignment/PromptInputLine.html#example-of-interactively-renaming-the-current-tab)
