---
title: "from_hsla - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.color/from_hsla"
...
# `wezterm.color.from_hsla(h, s, l, a)`[¶](https://wezterm.org/config/lua/wezterm.color/from_hsla.html#weztermcolorfrom_hslah-s-l-a "Permanent link")
...
Constructs a new [color object](https://wezterm.org/config/lua/color/index.html) from values in the HSL
colorspace, plus alpha.

See also [wezterm.color.parse()](https://wezterm.org/config/lua/wezterm.color/parse.html)
