---
title: "InputSelector - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/InputSelector"
...
* Full Config & Lua Reference
  ...
  + [enum: KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html)
    ...
    - InputSelector
      ...
      Table of contents
      * [Key Assignments](https://wezterm.org/config/lua/keyassignment/InputSelector.html#key-assignments)
      * [Example of choosing some canned text to enter into the terminal](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-choosing-some-canned-text-to-enter-into-the-terminal)
      * [Example of dynamically constructing a list](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-dynamically-constructing-a-list)
      * [Example of switching between a list of workspaces with the InputSelector](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-switching-between-a-list-of-workspaces-with-the-inputselector)
...
# `InputSelector`[¶](https://wezterm.org/config/lua/keyassignment/InputSelector.html#inputselector "Permanent link")
...
* `choices` - a lua table consisting of the potential choices. Each entry
  ...
  with [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html) to produce styled text.
* `action` - and event callback registered via `wezterm.action_callback`. The
  ...
  `pane` are the [Window](https://wezterm.org/config/lua/window/index.html) and [Pane](https://wezterm.org/config/lua/pane/index.html)
...
### Key Assignments[¶](https://wezterm.org/config/lua/keyassignment/InputSelector.html#key-assignments "Permanent link")
...
## Example of choosing some canned text to enter into the terminal[¶](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-choosing-some-canned-text-to-enter-into-the-terminal "Permanent link")
...
## Example of dynamically constructing a list[¶](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-dynamically-constructing-a-list "Permanent link")
...
## Example of switching between a list of workspaces with the InputSelector[¶](https://wezterm.org/config/lua/keyassignment/InputSelector.html#example-of-switching-between-a-list-of-workspaces-with-the-inputselector "Permanent link")
