---
title: "ime_preedit_rendering - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/ime_preedit_rendering"
...
# `ime_preedit_rendering`[¶](https://wezterm.org/config/lua/config/ime_preedit_rendering.html#ime_preedit_rendering "Permanent link")
...
works in concert with features like [window:composition\_status()](https://wezterm.org/config/lua/window/composition_status.html).
