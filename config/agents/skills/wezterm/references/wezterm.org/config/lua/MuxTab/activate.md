---
title: "activate - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/activate"
...
# `tab:activate()`[¶](https://wezterm.org/config/lua/MuxTab/activate.html#tabactivate "Permanent link")
