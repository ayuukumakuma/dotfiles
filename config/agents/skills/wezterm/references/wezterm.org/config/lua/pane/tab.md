---
title: "tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/tab"
...
# `pane:tab()`[¶](https://wezterm.org/config/lua/pane/tab.html#panetab "Permanent link")
...
Returns the [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html) that contains this pane.
