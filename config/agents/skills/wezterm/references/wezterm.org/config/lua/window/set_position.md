---
title: "set_position - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/set_position"
...
# `window:set_position(x, y)`[¶](https://wezterm.org/config/lua/window/set_position.html#windowset_positionx-y "Permanent link")
