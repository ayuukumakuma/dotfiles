---
title: "win32_system_backdrop - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/win32_system_backdrop"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - win32\_system\_backdrop

      [win32\_system\_backdrop](https://wezterm.org/config/lua/config/win32_system_backdrop.html)

      Table of contents
      * [Acrylic](https://wezterm.org/config/lua/config/win32_system_backdrop.html#acrylic)
      * [Mica](https://wezterm.org/config/lua/config/win32_system_backdrop.html#mica)
      * [Tabbed](https://wezterm.org/config/lua/config/win32_system_backdrop.html#tabbed)
...
# `win32_system_backdrop = SETTING`[¶](https://wezterm.org/config/lua/config/win32_system_backdrop.html#win32_system_backdrop-setting "Permanent link")
...
adjusted using [win32\_acrylic\_accent\_color](https://wezterm.org/config/lua/config/win32_acrylic_accent_color.html).
...
See also [macos\_window\_background\_blur](https://wezterm.org/config/lua/config/macos_window_background_blur.html) for
a similar effect on macOS.

See also [kde\_window\_background\_blur](https://wezterm.org/config/lua/config/kde_window_background_blur.html) for a similar
effect on KDE Wayland.

## Acrylic[¶](https://wezterm.org/config/lua/config/win32_system_backdrop.html#acrylic "Permanent link")
...
![Acrylic Effect](https://wezterm.org/screenshots/wezterm-acrylic.png)

## Mica[¶](https://wezterm.org/config/lua/config/win32_system_backdrop.html#mica "Permanent link")
...
![Mica Effect](https://wezterm.org/screenshots/wezterm-mica.png)

## Tabbed[¶](https://wezterm.org/config/lua/config/win32_system_backdrop.html#tabbed "Permanent link")
...
![Tabbed Effect](https://wezterm.org/screenshots/wezterm-tabbed.png)
