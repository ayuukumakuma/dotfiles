---
title: "gui-attached - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/gui-events/gui-attached"
...
# `gui-attached`[¶](https://wezterm.org/config/lua/gui-events/gui-attached.html#gui-attached "Permanent link")
...
be triggered and passed the [MuxDomain](https://wezterm.org/config/lua/MuxDomain/index.html) object
associated with `DOMAIN`. In cases where you don't specify the domain, the
default domain will be passed instead.

This event fires after the [gui-startup](https://wezterm.org/config/lua/gui-events/gui-startup.html) event.
...
See also: [gui-startup](https://wezterm.org/config/lua/gui-events/gui-startup.html).
