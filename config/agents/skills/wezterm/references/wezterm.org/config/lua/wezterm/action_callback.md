---
title: "wezterm.action_callback - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/action_callback"
...
* Full Config & Lua Reference
  ...
  + [module: wezterm](https://wezterm.org/config/lua/wezterm/index.html)
    ...
    - action\_callback
      ...
      Table of contents
      * [Usage](https://wezterm.org/config/lua/wezterm/action_callback.html#usage)
...
# `wezterm.action_callback(callback)`[¶](https://wezterm.org/config/lua/wezterm/action_callback.html#weztermaction_callbackcallback "Permanent link")
...
See [wezterm.on](https://wezterm.org/config/lua/wezterm/on.html) and [wezterm.action](https://wezterm.org/config/lua/wezterm/action.html) for more info on what you can do with these.

## Usage[¶](https://wezterm.org/config/lua/wezterm/action_callback.html#usage "Permanent link")
