---
title: "open-uri - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/open-uri"
...
# `open-uri`[¶](https://wezterm.org/config/lua/window-events/open-uri.html#open-uri "Permanent link")
