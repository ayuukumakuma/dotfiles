---
title: "tab_bar_style - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/tab_bar_style"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - tab\_bar\_style
      ...
      Table of contents
      * [Retro Tab Bar with Integrated Window Management Buttons](https://wezterm.org/config/lua/config/tab_bar_style.html#retro-tab-bar-with-integrated-window-management-buttons)
...
# `tab_bar_style`[¶](https://wezterm.org/config/lua/config/tab_bar_style.html#tab_bar_style "Permanent link")
...
*The functionality described in this section requires version 20210502-154244-3f7122cb of wezterm,
or a more recent version.*
...
[format-tab-title](https://wezterm.org/config/lua/window-events/format-tab-title.html) event.
...
This configuration supplements the [tab bar color](https://wezterm.org/config/appearance.html#tab-bar-appearance-colors)
options.
...
by the [wezterm.format](https://wezterm.org/config/lua/wezterm/format.html) function.
...
![Demonstrating setting the styling of the left and right tab edges](https://wezterm.org/screenshots/wezterm-tab-edge-styled.png)
...
#### Retro Tab Bar with Integrated Window Management Buttons[¶](https://wezterm.org/config/lua/config/tab_bar_style.html#retro-tab-bar-with-integrated-window-management-buttons "Permanent link")
...
"INTEGRATED_BUTTONS|RESIZE"`](https://wezterm.org/config/lua/config/window_decorations.html), you can
