---
title: "dpi - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/dpi"
...
# `dpi`[¶](https://wezterm.org/config/lua/config/dpi.html#dpi "Permanent link")
