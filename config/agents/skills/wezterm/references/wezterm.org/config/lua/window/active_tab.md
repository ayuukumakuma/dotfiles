...
source_url: "https://wezterm.org/config/lua/window/active_tab"
...
# `window:active_tab()`[¶](https://wezterm.org/config/lua/window/active_tab.html#windowactive_tab "Permanent link")
