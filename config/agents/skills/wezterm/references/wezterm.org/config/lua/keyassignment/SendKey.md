---
title: "SendKey - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SendKey"
...
# `SendKey`[¶](https://wezterm.org/config/lua/keyassignment/SendKey.html#sendkey "Permanent link")
...
See also [Multiple](https://wezterm.org/config/lua/keyassignment/Multiple.html) for combining multiple actions in a single press.
