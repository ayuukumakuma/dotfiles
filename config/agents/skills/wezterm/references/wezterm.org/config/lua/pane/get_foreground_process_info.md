---
title: "get_foreground_process_info - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_foreground_process_info"
...
# `pane:get_foreground_process_info()`[¶](https://wezterm.org/config/lua/pane/get_foreground_process_info.html#paneget_foreground_process_info "Permanent link")
...
Returns a [LocalProcessInfo](https://wezterm.org/config/lua/LocalProcessInfo.html) object corresponding to the current foreground process that is running in the pane.
