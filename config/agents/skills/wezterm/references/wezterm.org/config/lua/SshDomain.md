---
title: "object: SshDomain - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/SshDomain"
...
# SshDomain[¶](https://wezterm.org/config/lua/SshDomain.html#sshdomain "Permanent link")

The `SshDomain` struct specifies information about an individual
[SSH Domain](https://wezterm.org/multiplexing.html#ssh-domains).
...
* `"None"` - don't use any multiplexing. The connection is an ssh connection
  ...
  with the [default\_domain](https://wezterm.org/config/lua/config/default_domain.html) option.
...
Integration](https://wezterm.org/shell-integration.html) on the remote host when spawning new
...
*The functionality described in this section requires version 20221119-145034-49b9839f of wezterm,
or a more recent version.*

The lag indicator now defaults to disabled. It is recommended to display
the lag information in your status bar using [this
example](https://wezterm.org/config/lua/pane/get_metadata.html).
