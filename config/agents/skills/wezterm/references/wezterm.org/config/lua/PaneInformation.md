---
title: "object: PaneInformation - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/PaneInformation"
...
# PaneInformation[¶](https://wezterm.org/config/lua/PaneInformation.html#paneinformation "Permanent link")

The `PaneInformation` struct describes a pane. Unlike [the Pane
object](https://wezterm.org/config/lua/pane/index.html), `PaneInformation` is a snapshot of some of
...
* `title` - the title of the pane, per [pane:get\_title()](https://wezterm.org/config/lua/pane/get_title.html) at the time the pane information was captured
* `user_vars` - the user variables defined for the pane, per [pane:get\_user\_vars()](https://wezterm.org/config/lua/pane/get_user_vars.html) at the time the pane information was captured.
* `progress` - the progress state, per [pane:get\_progress()](https://wezterm.org/config/lua/pane/get_progress.html) at the time the pane information was captured. (*Since: Nightly Builds Only*)
...
* `foreground_process_name` - the path to the executable image per [pane:get\_foreground\_process\_name()](https://wezterm.org/config/lua/pane/get_foreground_process_name.html), or an empty string if unavailable.
* `current_working_dir` - the current working directory, per [pane:get\_current\_working\_dir()](https://wezterm.org/config/lua/pane/get_current_working_dir.html).
...
in [pane:get\_tty\_name()](https://wezterm.org/config/lua/pane/get_tty_name.html).
