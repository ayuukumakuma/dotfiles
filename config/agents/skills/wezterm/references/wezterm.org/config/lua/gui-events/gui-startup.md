---
title: "gui-startup - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/gui-events/gui-startup"
...
# `gui-startup`[¶](https://wezterm.org/config/lua/gui-events/gui-startup.html#gui-startup "Permanent link")
...
This event fires before [gui-attached](https://wezterm.org/config/lua/gui-events/gui-attached.html).
...
The event receives an optional [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) argument that
