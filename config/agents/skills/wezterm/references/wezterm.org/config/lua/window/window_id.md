...
source_url: "https://wezterm.org/config/lua/window/window_id"
...
# `window:window_id()`[¶](https://wezterm.org/config/lua/window/window_id.html#windowwindow_id "Permanent link")
