---
title: "format - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.time/Time/format"
...
# `Time:format(format)`[¶](https://wezterm.org/config/lua/wezterm.time/Time/format.html#timeformatformat "Permanent link")
...
See also [Time:format\_utc()](https://wezterm.org/config/lua/wezterm.time/Time/format_utc.html).
