---
title: "get_lines_as_escapes - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_lines_as_escapes"
...
* Full Config & Lua Reference
  ...
  + [object: Pane](https://wezterm.org/config/lua/pane/index.html)
    ...
    - get\_lines\_as\_escapes

      [get\_lines\_as\_escapes](https://wezterm.org/config/lua/pane/get_lines_as_escapes.html)

      Table of contents
      * [Example: opening scrollback in a pager](https://wezterm.org/config/lua/pane/get_lines_as_escapes.html#example-opening-scrollback-in-a-pager)
...
# `pane:get_lines_as_escapes([nlines])`[¶](https://wezterm.org/config/lua/pane/get_lines_as_escapes.html#paneget_lines_as_escapesnlines "Permanent link")
...
## Example: opening scrollback in a pager[¶](https://wezterm.org/config/lua/pane/get_lines_as_escapes.html#example-opening-scrollback-in-a-pager "Permanent link")
...
See also: [pane:get\_lines\_as\_text()](https://wezterm.org/config/lua/pane/get_lines_as_text.html).
