---
title: "get_config_overrides - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/get_config_overrides"
...
# `window:get_config_overrides()`[¶](https://wezterm.org/config/lua/window/get_config_overrides.html#windowget_config_overrides "Permanent link")
...
See [set\_config\_overrides](https://wezterm.org/config/lua/window/set_config_overrides.html) for examples!
