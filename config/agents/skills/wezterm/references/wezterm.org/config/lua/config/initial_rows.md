---
title: "initial_rows - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/initial_rows"
...
# `initial_rows = 24`[¶](https://wezterm.org/config/lua/config/initial_rows.html#initial_rows-24 "Permanent link")

Together with [initial\_cols](https://wezterm.org/config/lua/config/initial_cols.html), configures the window size
