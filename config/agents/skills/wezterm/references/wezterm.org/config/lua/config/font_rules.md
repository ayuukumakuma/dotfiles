---
title: "font_rules - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/font_rules"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - font\_rules
      ...
      Table of contents
      * [Debugging Font Rules](https://wezterm.org/config/lua/config/font_rules.html#debugging-font-rules)
...
# `font_rules`[¶](https://wezterm.org/config/lua/config/font_rules.html#font_rules "Permanent link")
...
By default, unstyled text will use the font specified by the [font](https://wezterm.org/config/lua/config/font.html)
...
5. The `font` *action* field, if specified, will override the base `font` configuration
...
## Debugging Font Rules[¶](https://wezterm.org/config/lua/config/font_rules.html#debugging-font-rules "Permanent link")
