---
title: "CharSelect - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/CharSelect"
...
# `CharSelect`[¶](https://wezterm.org/config/lua/keyassignment/CharSelect.html#charselect "Permanent link")
...
* `copy_to` - allows you to control where the item will be copied to. Accepts
  the same values as [CopyTo](https://wezterm.org/config/lua/keyassignment/CopyTo.html). The default is
