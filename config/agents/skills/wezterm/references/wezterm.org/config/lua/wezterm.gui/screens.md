---
title: "screens - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.gui/screens"
...
# `wezterm.gui.screens()`[¶](https://wezterm.org/config/lua/wezterm.gui/screens.html#weztermguiscreens "Permanent link")
...
Overlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) (by default: press
...
* `max_fps` - the maximum refresh rate supported by the screen, if known, or `nil` otherwise. (*Since: Version 20220903-194523-3bb1ed61*)
