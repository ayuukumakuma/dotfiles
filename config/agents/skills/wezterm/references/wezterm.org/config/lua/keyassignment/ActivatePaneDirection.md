---
title: "ActivatePaneDirection - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/ActivatePaneDirection"
...
# `ActivatePaneDirection`[¶](https://wezterm.org/config/lua/keyassignment/ActivatePaneDirection.html#activatepanedirection "Permanent link")
...
If the active pane is [zoomed](https://wezterm.org/config/lua/keyassignment/TogglePaneZoomState.html), behavior is determined
by the [`unzoom_on_switch_pane`](https://wezterm.org/config/lua/config/unzoom_on_switch_pane.html) flag.
