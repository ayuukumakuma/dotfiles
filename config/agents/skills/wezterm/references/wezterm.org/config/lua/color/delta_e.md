---
title: "delta_e - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/delta_e"
...
# `color:delta_e(color)`[¶](https://wezterm.org/config/lua/color/delta_e.html#colordelta_ecolor "Permanent link")
