...
source_url: "https://wezterm.org/config/lua/pane/get_dimensions"
...
# `pane:get_dimensions()`[¶](https://wezterm.org/config/lua/pane/get_dimensions.html#paneget_dimensions "Permanent link")
