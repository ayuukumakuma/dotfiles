---
title: "freetype_pcf_long_family_names - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/freetype_pcf_long_family_names"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - freetype\_pcf\_long\_family\_names

      [freetype\_pcf\_long\_family\_names](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html)

      Table of contents
      * [When should you set this option to true?](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html#when-should-you-set-this-option-to-true)
      * [Why doesn't wezterm use the distro FreeType or match its configuration?](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html#why-doesnt-wezterm-use-the-distro-freetype-or-match-its-configuration)
...
# `freetype_pcf_long_family_names = false`[¶](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html#freetype_pcf_long_family_names-false "Permanent link")
...
## When should you set this option to true?[¶](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html#when-should-you-set-this-option-to-true "Permanent link")
...
## Why doesn't wezterm use the distro FreeType or match its configuration?[¶](https://wezterm.org/config/lua/config/freetype_pcf_long_family_names.html#why-doesnt-wezterm-use-the-distro-freetype-or-match-its-configuration "Permanent link")
