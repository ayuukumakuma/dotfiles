---
title: "set_environment_variables - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/set_environment_variables"
...
# `set_environment_variables`[¶](https://wezterm.org/config/lua/config/set_environment_variables.html#set_environment_variables "Permanent link")
...
See also: [Launching Programs](https://wezterm.org/config/launch.html#passing-environment-variables-to-the-spawned-program)
