---
title: "wezterm.default_hyperlink_rules - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/default_hyperlink_rules"
...
# `wezterm.default_hyperlink_rules()`[¶](https://wezterm.org/config/lua/wezterm/default_hyperlink_rules.html#weztermdefault_hyperlink_rules "Permanent link")
...
Returns the compiled-in default values for [hyperlink\_rules](https://wezterm.org/config/lua/config/hyperlink_rules.html).
