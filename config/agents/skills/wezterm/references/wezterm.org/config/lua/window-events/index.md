---
title: "events: Window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/index"
...
# Events emitted by the `Window` object[¶](https://wezterm.org/config/lua/window-events/index.html#events-emitted-by-the-window-object "Permanent link")

The following events can be handled using [wezterm.on](https://wezterm.org/config/lua/wezterm/on.html):
