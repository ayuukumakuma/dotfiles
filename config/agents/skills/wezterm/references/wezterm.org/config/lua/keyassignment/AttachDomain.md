---
title: "AttachDomain - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/AttachDomain"
...
# `AttachDomain(domain_name)`[¶](https://wezterm.org/config/lua/keyassignment/AttachDomain.html#attachdomaindomain_name "Permanent link")
...
This action is not bound to any keys by default. The [Launcher Menu](https://wezterm.org/config/launch.html#the-launcher-menu)
...
See also: [DetachDomain](https://wezterm.org/config/lua/keyassignment/DetachDomain.html)
