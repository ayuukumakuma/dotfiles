---
title: "new-tab-button-click - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/new-tab-button-click"
...
# `new-tab-button-click`[¶](https://wezterm.org/config/lua/window-events/new-tab-button-click.html#new-tab-button-click "Permanent link")

*Since: Version 20230326-111934-3666303c*

*The functionality described in this section requires version 20230326-111934-3666303c of wezterm,
...
The last event parameter is a [KeyAssignment](https://wezterm.org/config/lua/keyassignment/index.html) which
...
See also [window:perform\_action()](https://wezterm.org/config/lua/window/perform_action.html).
