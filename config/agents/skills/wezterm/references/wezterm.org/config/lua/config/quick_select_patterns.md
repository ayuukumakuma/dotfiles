---
title: "quick_select_patterns - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/quick_select_patterns"
...
# `quick_select_patterns`[¶](https://wezterm.org/config/lua/config/quick_select_patterns.html#quick_select_patterns "Permanent link")
...
Specify additional patterns to match when in [quick select mode](https://wezterm.org/quickselect.html).
