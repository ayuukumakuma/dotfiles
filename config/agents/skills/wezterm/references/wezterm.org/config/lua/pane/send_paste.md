---
title: "send_paste - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/send_paste"
...
# `pane:send_paste(text)`[¶](https://wezterm.org/config/lua/pane/send_paste.html#panesend_pastetext "Permanent link")
...
[`canonicalize_pasted_newlines`](https://wezterm.org/config/lua/config/canonicalize_pasted_newlines.html) setting.
