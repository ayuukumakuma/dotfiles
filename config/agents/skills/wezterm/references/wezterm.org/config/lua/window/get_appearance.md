---
title: "get_appearance - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/get_appearance"
...
* Full Config & Lua Reference
  ...
  + [object: Window](https://wezterm.org/config/lua/window/index.html)
    ...
    - get\_appearance
      ...
      Table of contents
      * [Wayland GNOME Appearance](https://wezterm.org/config/lua/window/get_appearance.html#wayland-gnome-appearance)
...
# window:get\_appearance()[¶](https://wezterm.org/config/lua/window/get_appearance.html#windowget_appearance "Permanent link")

**NOTE: You probably want to use [wezterm.gui.get\_appearance()](https://wezterm.org/config/lua/wezterm.gui/get_appearance.html) instead, as it is easier to use!**
...
[window-config-reloaded](https://wezterm.org/config/lua/window-events/window-config-reloaded.html) event for
each window.
...
### Wayland GNOME Appearance[¶](https://wezterm.org/config/lua/window/get_appearance.html#wayland-gnome-appearance "Permanent link")
...
[update-right-status](https://wezterm.org/config/lua/window-events/update-right-status.html) event, which
