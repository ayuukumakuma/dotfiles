---
title: "hide_tab_bar_if_only_one_tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/hide_tab_bar_if_only_one_tab"
...
# `hide_tab_bar_if_only_one_tab = false`[¶](https://wezterm.org/config/lua/config/hide_tab_bar_if_only_one_tab.html#hide_tab_bar_if_only_one_tab-false "Permanent link")

If set to true, when there is only a single tab, the tab bar is
hidden from the display. If a second tab is created, the tab
will be shown.

See also [enable\_tab\_bar](https://wezterm.org/config/lua/config/enable_tab_bar.html)
