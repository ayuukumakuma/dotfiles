---
title: "check_for_updates - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/check_for_updates"
...
# `check_for_updates` & `check_for_updates_interval_seconds`[¶](https://wezterm.org/config/lua/config/check_for_updates.html#check_for_updates-check_for_updates_interval_seconds "Permanent link")
...
(See [show\_update\_window](https://wezterm.org/config/lua/config/show_update_window.html) to control this UI).
