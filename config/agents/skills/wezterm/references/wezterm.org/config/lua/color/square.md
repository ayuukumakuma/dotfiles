---
title: "square - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/square"
...
# `color:square()`[¶](https://wezterm.org/config/lua/color/square.html#colorsquare "Permanent link")
