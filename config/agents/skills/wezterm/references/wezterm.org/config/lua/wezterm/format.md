---
title: "wezterm.format - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/format"
...
# `wezterm.format({})`[¶](https://wezterm.org/config/lua/wezterm/format.html#weztermformat "Permanent link")
