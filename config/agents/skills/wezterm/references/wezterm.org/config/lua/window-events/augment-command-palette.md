---
title: "augment-command-palette - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/augment-command-palette"
...
* Full Config & Lua Reference
  ...
  + [events: Window](https://wezterm.org/config/lua/window-events/index.html)
    ...
    - augment-command-palette
      ...
      Table of contents
      * [Adding a Rename Tab entry to the palette](https://wezterm.org/config/lua/window-events/augment-command-palette.html#adding-a-rename-tab-entry-to-the-palette)
...
# `augment-command-palette`[¶](https://wezterm.org/config/lua/window-events/augment-command-palette.html#augment-command-palette "Permanent link")
...
This event is emitted when the [Command Palette](https://wezterm.org/config/lua/keyassignment/ActivateCommandPalette.html) is shown.
...
* `icon` - optional Nerd Fonts glyph name to use for the icon for the entry. See
  [wezterm.nerdfonts](https://wezterm.org/config/lua/wezterm/nerdfonts.html) for a list of icon names.

## Adding a Rename Tab entry to the palette[¶](https://wezterm.org/config/lua/window-events/augment-command-palette.html#adding-a-rename-tab-entry-to-the-palette "Permanent link")
