---
title: "clean_exit_codes - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/clean_exit_codes"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - clean\_exit\_codes
      ...
      Table of contents
      * [clean\_exit\_codes = { 0 }](https://wezterm.org/config/lua/config/clean_exit_codes.html#clean_exit_codes-0)
...
## `clean_exit_codes = { 0 }`[¶](https://wezterm.org/config/lua/config/clean_exit_codes.html#clean_exit_codes-0 "Permanent link")
...
[exit\_behavior](https://wezterm.org/config/lua/config/exit_behavior.html) when the program running in the terminal
completes.
