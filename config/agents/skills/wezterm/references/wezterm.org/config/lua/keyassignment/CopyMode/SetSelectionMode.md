---
title: "SetSelectionMode - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/CopyMode/SetSelectionMode"
...
# CopyMode `{ SetSelectionMode = MODE }`[¶](https://wezterm.org/config/lua/keyassignment/CopyMode/SetSelectionMode.html#copymode-setselectionmode-mode "Permanent link")
...
* `"SemanticZone"` - selection expands to the current semantic zone. See [Shell Integration](https://wezterm.org/shell-integration.html). (*Since: Version 20220903-194523-3bb1ed61*).
...
See also: [ClearSelectionMode](https://wezterm.org/config/lua/keyassignment/CopyMode/ClearSelectionMode.html).
