---
title: "macos_window_background_blur - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/macos_window_background_blur"
...
# `macos_window_background_blur = 0`[¶](https://wezterm.org/config/lua/config/macos_window_background_blur.html#macos_window_background_blur-0 "Permanent link")
...
![Screenshot](https://wezterm.org/screenshots/wezterm-macos-background-blur.png)

The default value for `macos_window_background_blur` is `0`.

See also [win32\_system\_backdrop](https://wezterm.org/config/lua/config/win32_system_backdrop.html) for a similar
effect on Windows.
