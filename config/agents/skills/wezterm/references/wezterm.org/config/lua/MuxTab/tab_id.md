---
title: "tab_id - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/tab_id"
...
# `tab:tab_id()`[¶](https://wezterm.org/config/lua/MuxTab/tab_id.html#tabtab_id "Permanent link")
