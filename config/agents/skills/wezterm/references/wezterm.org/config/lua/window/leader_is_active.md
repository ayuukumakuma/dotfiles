---
title: "leader_is_active - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/leader_is_active"
...
# window:leader\_is\_active()[¶](https://wezterm.org/config/lua/window/leader_is_active.html#windowleader_is_active "Permanent link")
...
Returns `true` if the [Leader Key](https://wezterm.org/config/keys.html) is active in the window, or false otherwise.
...
See also: [window:composition\_status()](https://wezterm.org/config/lua/window/composition_status.html).
