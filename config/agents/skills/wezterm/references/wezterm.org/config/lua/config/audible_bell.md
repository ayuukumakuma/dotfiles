---
title: "audible_bell - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/audible_bell"
...
# `audible_bell`[¶](https://wezterm.org/config/lua/config/audible_bell.html#audible_bell "Permanent link")
...
See also [visual\_bell](https://wezterm.org/config/lua/config/visual_bell.html) and [bell event](https://wezterm.org/config/lua/window-events/bell.html)
