---
title: "module: wezterm.color - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.color/index"
...
* [Available functions, constants](https://wezterm.org/config/lua/wezterm.color/index.html#available-functions-constants)

# `wezterm.color` module[¶](https://wezterm.org/config/lua/wezterm.color/index.html#weztermcolor-module "Permanent link")
...
## Available functions, constants[¶](https://wezterm.org/config/lua/wezterm.color/index.html#available-functions-constants "Permanent link")
