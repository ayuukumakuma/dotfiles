---
title: "current_event - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/current_event"
...
# `window:current_event()`[¶](https://wezterm.org/config/lua/window/current_event.html#windowcurrent_event "Permanent link")
