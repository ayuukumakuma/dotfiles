---
title: "get_workspace - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/get_workspace"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - get\_workspace
      ...
      Table of contents
      * [window:get\_workspace()](https://wezterm.org/config/lua/mux-window/get_workspace.html#windowget_workspace)
...
## `window:get_workspace()`[¶](https://wezterm.org/config/lua/mux-window/get_workspace.html#windowget_workspace "Permanent link")
