---
title: "harfbuzz_features - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/harfbuzz_features"
...
# `harfbuzz_features`[¶](https://wezterm.org/config/lua/config/harfbuzz_features.html#harfbuzz_features "Permanent link")

When `font_shaper = "Harfbuzz"`, this setting affects how font shaping
takes place.

See [Font Shaping](https://wezterm.org/config/font-shaping.html) for more information
and examples.
