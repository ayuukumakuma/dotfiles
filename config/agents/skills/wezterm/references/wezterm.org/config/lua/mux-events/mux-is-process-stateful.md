---
title: "mux-is-process-stateful - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-events/mux-is-process-stateful"
...
* Full Config & Lua Reference
  ...
  + [events: Multiplexer](https://wezterm.org/config/lua/mux-events/index.html)
    ...
    - mux-is-process-stateful
      ...
      Table of contents
      * [Example](https://wezterm.org/config/lua/mux-events/mux-is-process-stateful.html#example)
...
# `mux-is-process-stateful`[¶](https://wezterm.org/config/lua/mux-events/mux-is-process-stateful.html#mux-is-process-stateful "Permanent link")
...
The event is passed a [LocalProcessInfo](https://wezterm.org/config/lua/LocalProcessInfo.html) object
...
* `nil` - to use the default behavior, which is to consider the [skip\_close\_confirmation\_for\_processes\_named](https://wezterm.org/config/lua/config/skip_close_confirmation_for_processes_named.html) configuration option
* any other value, or an error, will be treated as equivalent to returning `nil`

## Example[¶](https://wezterm.org/config/lua/mux-events/mux-is-process-stateful.html#example "Permanent link")
