---
title: "wezterm.log_info - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/log_info"
...
# `wezterm.log_info(arg, ..)`[¶](https://wezterm.org/config/lua/wezterm/log_info.html#weztermlog_infoarg "Permanent link")
...
at 'INFO' level, which can be displayed via [ShowDebugOverlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) action. If you started wezterm from a terminal that text will print
...
See also [log\_error](https://wezterm.org/config/lua/wezterm/log_error.html) and [log\_warn](https://wezterm.org/config/lua/wezterm/log_warn.html).
