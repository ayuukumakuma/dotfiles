---
title: "active_tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/active_tab"
...
# `window:active_tab()`[¶](https://wezterm.org/config/lua/mux-window/active_tab.html#windowactive_tab "Permanent link")
