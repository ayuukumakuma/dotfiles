---
title: "adjust_hue_fixed_ryb - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/color/adjust_hue_fixed_ryb"
...
# `color:adjust_hue_fixed_ryb(degrees)`[¶](https://wezterm.org/config/lua/color/adjust_hue_fixed_ryb.html#coloradjust_hue_fixed_rybdegrees "Permanent link")
...
See also [color:adjust\_hue\_fixed()](https://wezterm.org/config/lua/color/adjust_hue_fixed.html).
