---
title: "set_zoomed - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxTab/set_zoomed"
...
# `tab:set_zoomed(bool)`[¶](https://wezterm.org/config/lua/MuxTab/set_zoomed.html#tabset_zoomedbool "Permanent link")
