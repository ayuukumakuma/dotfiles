---
title: "SplitVertical - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/keyassignment/SplitVertical"
...
# `SplitVertical`[¶](https://wezterm.org/config/lua/keyassignment/SplitVertical.html#splitvertical "Permanent link")
...
`SplitVertical` requires a [SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) parameter to
