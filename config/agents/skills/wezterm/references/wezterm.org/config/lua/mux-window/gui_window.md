---
title: "gui_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/gui_window"
...
# `window:gui_window()`[¶](https://wezterm.org/config/lua/mux-window/gui_window.html#windowgui_window "Permanent link")
...
Attempts to resolve this mux window to its corresponding [Gui Window](https://wezterm.org/config/lua/window/index.html).
...
This method is the inverse of [window:mux\_window](https://wezterm.org/config/lua/window/mux_window.html).
