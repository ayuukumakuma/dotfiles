---
title: "ssh_domains - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/ssh_domains"
...
# `ssh_domains`[¶](https://wezterm.org/config/lua/config/ssh_domains.html#ssh_domains "Permanent link")

Configures SSH multiplexing domains. [Read more about SSH Domains](https://wezterm.org/multiplexing.html#ssh-domains).

This option accepts a list of [SshDomain](https://wezterm.org/config/lua/SshDomain.html) objects.
...
See also [wezterm.default\_ssh\_domains()](https://wezterm.org/config/lua/wezterm/default_ssh_domains.html).
