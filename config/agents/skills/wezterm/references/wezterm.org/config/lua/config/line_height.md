---
title: "line_height - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/line_height"
...
# `line_height = 1.0`[¶](https://wezterm.org/config/lua/config/line_height.html#line_height-10 "Permanent link")
...
[font\_size](https://wezterm.org/config/lua/config/font_size.html) configuration option. If you feel that your chosen
...
See also: [cell\_width](https://wezterm.org/config/lua/config/cell_width.html)
