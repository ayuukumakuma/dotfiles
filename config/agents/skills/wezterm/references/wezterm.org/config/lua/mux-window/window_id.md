---
title: "window_id - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/mux-window/window_id"
...
* Full Config & Lua Reference
  ...
  + [object: MuxWindow](https://wezterm.org/config/lua/mux-window/index.html)
    ...
    - window\_id
      ...
      Table of contents
      * [window:window\_id()](https://wezterm.org/config/lua/mux-window/window_id.html#windowwindow_id)
...
## `window:window_id()`[¶](https://wezterm.org/config/lua/mux-window/window_id.html#windowwindow_id "Permanent link")
