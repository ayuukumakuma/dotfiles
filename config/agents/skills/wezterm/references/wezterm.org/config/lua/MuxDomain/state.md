---
title: "state - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/MuxDomain/state"
...
# `domain:state()`[¶](https://wezterm.org/config/lua/MuxDomain/state.html#domainstate "Permanent link")
...
See also: [domain:detach()](https://wezterm.org/config/lua/MuxDomain/detach.html) and [domain:detach()](https://wezterm.org/config/lua/MuxDomain/detach.html).
