...
source_url: "https://wezterm.org/config/lua/pane/paste"
...
# `pane:paste(text)`[¶](https://wezterm.org/config/lua/pane/paste.html#panepastetext "Permanent link")
...
Alias of [`send_paste`](https://wezterm.org/config/lua/pane/send_paste.html) for backwards compatibility with prior releases.
