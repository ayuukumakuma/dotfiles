---
title: "now - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.time/now"
...
# `wezterm.time.now()`[¶](https://wezterm.org/config/lua/wezterm.time/now.html#weztermtimenow "Permanent link")
...
Returns a [Time](https://wezterm.org/config/lua/wezterm.time/Time/index.html) object representing the time at which
