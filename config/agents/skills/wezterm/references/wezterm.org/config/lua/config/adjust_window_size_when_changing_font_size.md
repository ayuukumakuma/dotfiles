---
title: "adjust_window_size_when_changing_font_size - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/adjust_window_size_when_changing_font_size"
...
# `adjust_window_size_when_changing_font_size = true`[¶](https://wezterm.org/config/lua/config/adjust_window_size_when_changing_font_size.html#adjust_window_size_when_changing_font_size-true "Permanent link")
...
See also [IncreaseFontSize](https://wezterm.org/config/lua/keyassignment/IncreaseFontSize.html),
[DecreaseFontSize](https://wezterm.org/config/lua/keyassignment/DecreaseFontSize.html).
...
[tiling\_desktop\_environments](https://wezterm.org/config/lua/config/tiling_desktop_environments.html). If the
