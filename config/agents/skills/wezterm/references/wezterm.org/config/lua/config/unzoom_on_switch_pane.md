---
title: "unzoom_on_switch_pane - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/unzoom_on_switch_pane"
...
# `unzoom_on_switch_pane = true`[¶](https://wezterm.org/config/lua/config/unzoom_on_switch_pane.html#unzoom_on_switch_pane-true "Permanent link")
...
If set to `false`, the
[`ActivatePaneDirection`](https://wezterm.org/config/lua/keyassignment/ActivatePaneDirection.html) command
