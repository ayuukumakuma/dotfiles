---
title: "wezterm.has_action - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/has_action"
...
# wezterm.has\_action(NAME)[¶](https://wezterm.org/config/lua/wezterm/has_action.html#weztermhas_actionname "Permanent link")
...
that can be used with [wezterm.action](https://wezterm.org/config/lua/wezterm/action.html).
