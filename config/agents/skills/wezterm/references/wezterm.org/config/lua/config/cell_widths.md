---
title: "cell_widths - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/cell_widths"
...
# `cell_widths = {}`[¶](https://wezterm.org/config/lua/config/cell_widths.html#cell_widths "Permanent link")
...
See also: [treat\_east\_asian\_ambiguous\_width\_as\_wide](https://wezterm.org/config/lua/config/treat_east_asian_ambiguous_width_as_wide.html)
