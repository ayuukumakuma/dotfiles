---
title: "window_frame - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/window_frame"
...
# `window_frame`[¶](https://wezterm.org/config/lua/config/window_frame.html#window_frame "Permanent link")
...
The default font is `Roboto`. The default font\_size is `10pt` on Windows and `12pt` on other systems.
