---
title: "split - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/split"
...
* Full Config & Lua Reference
  ...
  + [object: Pane](https://wezterm.org/config/lua/pane/index.html)
    ...
    - split
      ...
      Table of contents
      * [args](https://wezterm.org/config/lua/pane/split.html#args)
      * [cwd](https://wezterm.org/config/lua/pane/split.html#cwd)
      * [set\_environment\_variables](https://wezterm.org/config/lua/pane/split.html#set_environment_variables)
      * [domain](https://wezterm.org/config/lua/pane/split.html#domain)
      * [direction](https://wezterm.org/config/lua/pane/split.html#direction)
      * [top\_level](https://wezterm.org/config/lua/pane/split.html#top_level)
      * [size](https://wezterm.org/config/lua/pane/split.html#size)
...
# `pane:split{}`[¶](https://wezterm.org/config/lua/pane/split.html#panesplit "Permanent link")
...
### args[¶](https://wezterm.org/config/lua/pane/split.html#args "Permanent link")
...
### cwd[¶](https://wezterm.org/config/lua/pane/split.html#cwd "Permanent link")
...
### set\_environment\_variables[¶](https://wezterm.org/config/lua/pane/split.html#set_environment_variables "Permanent link")
...
### domain[¶](https://wezterm.org/config/lua/pane/split.html#domain "Permanent link")
...
### direction[¶](https://wezterm.org/config/lua/pane/split.html#direction "Permanent link")
...
### top\_level[¶](https://wezterm.org/config/lua/pane/split.html#top_level "Permanent link")
...
### size[¶](https://wezterm.org/config/lua/pane/split.html#size "Permanent link")
