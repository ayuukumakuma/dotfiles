---
title: "update_all - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.plugin/update_all"
...
# update\_all function[¶](https://wezterm.org/config/lua/wezterm.plugin/update_all.html#update_all-function "Permanent link")
...
Run the [`wezterm.reload_configuration()`](https://wezterm.org/config/lua/wezterm/reload_configuration.html) function to reload the configuration.
