---
title: "get_user_vars - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/get_user_vars"
...
# `pane:get_user_vars()`[¶](https://wezterm.org/config/lua/pane/get_user_vars.html#paneget_user_vars "Permanent link")
