---
title: "gradient - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.color/gradient"
...
# `wezterm.color.gradient(gradient, num_colors)`[¶](https://wezterm.org/config/lua/wezterm.color/gradient.html#weztermcolorgradientgradient-num_colors "Permanent link")
...
object](https://wezterm.org/config/lua/color/index.html).
