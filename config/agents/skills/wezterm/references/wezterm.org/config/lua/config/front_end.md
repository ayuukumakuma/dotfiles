---
title: "front_end - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/front_end"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - front\_end
      ...
      Table of contents
      * [WebGpu](https://wezterm.org/config/lua/config/front_end.html#webgpu)
...
# `front_end = "OpenGL"`[¶](https://wezterm.org/config/lua/config/front_end.html#front_end-opengl "Permanent link")
...
## WebGpu[¶](https://wezterm.org/config/lua/config/front_end.html#webgpu "Permanent link")
