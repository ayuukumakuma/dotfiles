---
title: "font_antialias - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/font_antialias"
...
# `font_antialias = "Greyscale"`[¶](https://wezterm.org/config/lua/config/font_antialias.html#font_antialias-greyscale "Permanent link")

*Deprecated starting in version 20210314-114017-04b7cedd; this option no longer does anything and will be removed in a future release. Use [freetype\_load\_target](https://wezterm.org/config/lua/config/freetype_load_target.html) instead*
