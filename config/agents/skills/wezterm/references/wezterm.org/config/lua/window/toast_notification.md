---
title: "toast_notification - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/toast_notification"
...
# `window:toast_notification(title, message, [url, [timeout_milliseconds]])`[¶](https://wezterm.org/config/lua/window/toast_notification.html#windowtoast_notificationtitle-message-url-timeout_milliseconds "Permanent link")
