---
title: "get_tab - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.mux/get_tab"
...
# `wezterm.mux.get_tab(TAB_ID)`[¶](https://wezterm.org/config/lua/wezterm.mux/get_tab.html#weztermmuxget_tabtab_id "Permanent link")
...
and returns a [MuxTab](https://wezterm.org/config/lua/MuxTab/index.html) object that can be used to
operate on the tab.
