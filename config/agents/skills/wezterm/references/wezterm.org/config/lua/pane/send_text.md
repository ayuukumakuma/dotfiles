---
title: "send_text - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/pane/send_text"
...
# `pane:send_text(text)`[¶](https://wezterm.org/config/lua/pane/send_text.html#panesend_texttext "Permanent link")
