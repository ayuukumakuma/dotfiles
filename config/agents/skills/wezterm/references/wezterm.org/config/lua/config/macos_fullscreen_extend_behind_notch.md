---
title: "macos_fullscreen_extend_behind_notch - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/macos_fullscreen_extend_behind_notch"
...
# `macos_fullscreen_extend_behind_notch = false`[¶](https://wezterm.org/config/lua/config/macos_fullscreen_extend_behind_notch.html#macos_fullscreen_extend_behind_notch-false "Permanent link")
...
or configure your own key, see [ToggleFullScreen](https://wezterm.org/config/lua/keyassignment/ToggleFullScreen.html).
...
See [native\_macos\_fullscreen\_mode](https://wezterm.org/config/lua/config/native_macos_fullscreen_mode.html) on how to
