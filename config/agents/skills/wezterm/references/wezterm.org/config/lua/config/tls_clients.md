---
title: "tls_clients - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/tls_clients"
...
# `tls_clients`[¶](https://wezterm.org/config/lua/config/tls_clients.html#tls_clients "Permanent link")

Configures TLS multiplexing domains. [Read more about TLS Domains](https://wezterm.org/multiplexing.html#tls-domains).

This option accepts a list of [TlsDomainClient](https://wezterm.org/config/lua/TlsDomainClient.html) objects.
