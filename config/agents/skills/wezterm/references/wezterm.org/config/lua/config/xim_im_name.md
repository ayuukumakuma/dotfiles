---
title: "xim_im_name - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/xim_im_name"
...
# `xim_im_name`[¶](https://wezterm.org/config/lua/config/xim_im_name.html#xim_im_name "Permanent link")
...
via the XIM protocol when using X11 and [use\_ime](https://wezterm.org/config/lua/config/use_ime.html) is `true`.
