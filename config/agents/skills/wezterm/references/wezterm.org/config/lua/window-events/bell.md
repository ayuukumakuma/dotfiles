---
title: "bell - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window-events/bell"
...
# `bell`[¶](https://wezterm.org/config/lua/window-events/bell.html#bell "Permanent link")
...
See also [audible\_bell](https://wezterm.org/config/lua/config/audible_bell.html) and [visual\_bell](https://wezterm.org/config/lua/config/visual_bell.html).
