...
source_url: "https://wezterm.org/config/lua/wezterm.color/parse"
...
# `wezterm.color.parse(string)`[¶](https://wezterm.org/config/lua/wezterm.color/parse.html#weztermcolorparsestring "Permanent link")
...
object](https://wezterm.org/config/lua/color/index.html). `Color` objects evaluate as strings but
