---
title: "get_dimensions - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/window/get_dimensions"
...
# `window:get_dimensions()`[¶](https://wezterm.org/config/lua/window/get_dimensions.html#windowget_dimensions "Permanent link")
