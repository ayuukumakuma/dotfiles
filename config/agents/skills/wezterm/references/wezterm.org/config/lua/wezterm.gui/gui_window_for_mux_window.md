---
title: "gui_window_for_mux_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.gui/gui_window_for_mux_window"
...
# `wezterm.gui.gui_window_for_mux_window(window_id)`[¶](https://wezterm.org/config/lua/wezterm.gui/gui_window_for_mux_window.html#weztermguigui_window_for_mux_windowwindow_id "Permanent link")
...
Attempts to resolve a mux window to its corresponding [Gui Window](https://wezterm.org/config/lua/window/index.html).
