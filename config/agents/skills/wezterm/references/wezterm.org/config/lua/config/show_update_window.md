---
title: "show_update_window - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/show_update_window"
...
# `show_update_window`[¶](https://wezterm.org/config/lua/config/show_update_window.html#show_update_window "Permanent link")
...
See [check\_for\_updates](https://wezterm.org/config/lua/config/check_for_updates.html) for more information on
