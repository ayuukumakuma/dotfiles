---
title: "module: wezterm.time - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm.time/index"
...
* [Available functions](https://wezterm.org/config/lua/wezterm.time/index.html#available-functions)

# `wezterm.time` module[¶](https://wezterm.org/config/lua/wezterm.time/index.html#weztermtime-module "Permanent link")
...
## Available functions[¶](https://wezterm.org/config/lua/wezterm.time/index.html#available-functions "Permanent link")
