---
title: "window_background_gradient - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/config/window_background_gradient"
...
* Full Config & Lua Reference
  ...
  + [Config Options](https://wezterm.org/config/lua/config/index.html)
    ...
    - window\_background\_gradient
      ...
      Table of contents
      * [Linear gradient:](https://wezterm.org/config/lua/config/window_background_gradient.html#linear-gradient)
      * [Radial gradient:](https://wezterm.org/config/lua/config/window_background_gradient.html#radial-gradient)
      * [Presets](https://wezterm.org/config/lua/config/window_background_gradient.html#presets)
...
# `window_background_gradient`[¶](https://wezterm.org/config/lua/config/window_background_gradient.html#window_background_gradient "Permanent link")
...
![Vertical Gradient](https://wezterm.org/screenshots/vertical-gradient.png)
...
## Linear gradient:[¶](https://wezterm.org/config/lua/config/window_background_gradient.html#linear-gradient "Permanent link")
...
![Linear Gradient](https://wezterm.org/screenshots/linear-gradient.png)

## Radial gradient:[¶](https://wezterm.org/config/lua/config/window_background_gradient.html#radial-gradient "Permanent link")
...
![Radial Gradient](https://wezterm.org/screenshots/radial-gradient.png)

## Presets[¶](https://wezterm.org/config/lua/config/window_background_gradient.html#presets "Permanent link")
