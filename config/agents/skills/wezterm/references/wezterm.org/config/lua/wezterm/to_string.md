---
title: "wezterm.to_string - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/lua/wezterm/to_string"
...
# `wezterm.to_string(arg)`[¶](https://wezterm.org/config/lua/wezterm/to_string.html#weztermto_stringarg "Permanent link")
...
This same representation is used in the [debug overlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html)
when printing the result of an expression from the Lua REPL and for the implicit string
conversions of the parameters passed to [wezterm.log\_info](https://wezterm.org/config/lua/wezterm/log_info.html).
