---
title: "Configuration - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/files"
...
* Configuration
  ...
  + Configuration
    ...
    Table of contents
    - [Quick Start](https://wezterm.org/config/files.html#quick-start)
    - [Configuration Files](https://wezterm.org/config/files.html#configuration-files)

      * [Configuration Overrides](https://wezterm.org/config/files.html#configuration-overrides)
    - [Configuration File Structure](https://wezterm.org/config/files.html#configuration-file-structure)
    - [Making your own Lua Modules](https://wezterm.org/config/files.html#making-your-own-lua-modules)
    - [Configuration Reference](https://wezterm.org/config/files.html#configuration-reference)
...
## Quick Start[¶](https://wezterm.org/config/files.html#quick-start "Permanent link")
...
* [wezterm.config\_builder](https://wezterm.org/config/lua/wezterm/config_builder.html)
* [initial\_cols](https://wezterm.org/config/lua/config/initial_cols.html)
* [initial\_rows](https://wezterm.org/config/lua/config/initial_rows.html)
* [font\_size](https://wezterm.org/config/lua/config/font_size.html)
* [color\_scheme](https://wezterm.org/config/lua/config/color_schemes.html)

## Configuration Files[¶](https://wezterm.org/config/files.html#configuration-files "Permanent link")
...
### Configuration Overrides[¶](https://wezterm.org/config/files.html#configuration-overrides "Permanent link")

*Since: Version 20210314-114017-04b7cedd*

*The functionality described in this section requires version 20210314-114017-04b7cedd of wezterm,
...
[window:set\_config\_overrides](https://wezterm.org/config/lua/window/set_config_overrides.html) documentation
for more information and examples of how to use that functionality.

## Configuration File Structure[¶](https://wezterm.org/config/files.html#configuration-file-structure "Permanent link")
...
## Making your own Lua Modules[¶](https://wezterm.org/config/files.html#making-your-own-lua-modules "Permanent link")
...
## Configuration Reference[¶](https://wezterm.org/config/files.html#configuration-reference "Permanent link")

Continue browsing this section of the docs for an overview of the commonly
adjusted settings, or visit the [Lua Config Reference](https://wezterm.org/config/lua/config/index.html) for a more detailed list of possibilities.
