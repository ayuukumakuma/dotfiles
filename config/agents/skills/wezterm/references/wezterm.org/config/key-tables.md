---
title: "Key Tables - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/key-tables"
...
* Configuration
  ...
  + Key Tables
    ...
    Table of contents
    - [Key Table Activation Stack](https://wezterm.org/config/key-tables.html#key-table-activation-stack)
...
### Key Table Activation Stack[¶](https://wezterm.org/config/key-tables.html#key-table-activation-stack "Permanent link")
...
The [ActivateKeyTable](https://wezterm.org/config/lua/keyassignment/ActivateKeyTable.html) action will push
...
The [PopKeyTable](https://wezterm.org/config/lua/keyassignment/PopKeyTable.html) action will explicitly pop
an entry from the stack.

The [ClearKeyTableStack](https://wezterm.org/config/lua/keyassignment/ClearKeyTableStack.html) action will
