---
title: "Launching Programs - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/launch"
...
* Configuration
  ...
  + Launching Programs
    ...
    Table of contents
    - [Launching Programs](https://wezterm.org/config/launch.html#launching-programs)
    - [Changing the default program](https://wezterm.org/config/launch.html#changing-the-default-program)
    ...
    - [Specifying the current working directory](https://wezterm.org/config/launch.html#specifying-the-current-working-directory)
    - [Passing Environment variables to the spawned program](https://wezterm.org/config/launch.html#passing-environment-variables-to-the-spawned-program)
    - [The Launcher Menu](https://wezterm.org/config/launch.html#the-launcher-menu)
...
## Launching Programs[¶](https://wezterm.org/config/launch.html#launching-programs "Permanent link")

By default, when opening new tabs or windows, your shell will be spawned.

Your shell is determined by the following rules:

On Posix SystemsOn Windows Systems

The shell configured for the current user in the password database will be
used. The value of the `$SHELL` environment variable is ***deliberately
ignored*** in order for wezterm to continue to be functional without
...
[set\_environment\_variables](https://wezterm.org/config/lua/config/set_environment_variables.html) to
...
## Changing the default program[¶](https://wezterm.org/config/launch.html#changing-the-default-program "Permanent link")
...
## Launching a different program as a one off via the CLI[¶](https://wezterm.org/config/launch.html#launching-a-different-program-as-a-one-off-via-the-cli "Permanent link")
...
## Specifying the current working directory[¶](https://wezterm.org/config/launch.html#specifying-the-current-working-directory "Permanent link")
...
* Setting the [`default_cwd`](https://wezterm.org/config/lua/config/default_cwd.html) via the config:
...
* The [`SpawnCommandInNewTab`](https://wezterm.org/config/lua/keyassignment/SpawnCommandInNewTab.html),
  and [`SpawnCommandInNewWindow`](https://wezterm.org/config/lua/keyassignment/SpawnCommandInNewWindow.html)
  key assignments, and the [Launcher Menu](https://wezterm.org/config/launch.html#the-launcher-menu) described below
  all accept a [`SpawnCommand`](https://wezterm.org/config/lua/SpawnCommand.html) object that accepts an
  optional `cwd` field:
...
[a value set by OSC 7](https://wezterm.org/shell-integration.html) and falling back to
...
[See `default_cwd` for an easier to understand visualization](https://wezterm.org/config/lua/config/default_cwd.html).

## Passing Environment variables to the spawned program[¶](https://wezterm.org/config/launch.html#passing-environment-variables-to-the-spawned-program "Permanent link")

The [set\_environment\_variables](https://wezterm.org/config/lua/config/set_environment_variables.html)
...
# The Launcher Menu[¶](https://wezterm.org/config/launch.html#the-launcher-menu "Permanent link")
...
bind a key to the [ShowLauncher](https://wezterm.org/config/lua/keyassignment/ShowLauncher.html) or
[ShowLauncherArgs](https://wezterm.org/config/lua/keyassignment/ShowLauncherArgs.html) action to trigger the
menu.
...
[launch\_menu](https://wezterm.org/config/lua/config/launch_menu.html) configuration setting. The snippet
...
[SpawnCommand](https://wezterm.org/config/lua/SpawnCommand.html) object.
...
![Launch Menu](https://wezterm.org/screenshots/launch-menu.png)
