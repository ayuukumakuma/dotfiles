---
title: "Fonts - Wez's Terminal Emulator"
source_url: "https://wezterm.org/config/fonts"
...
* Configuration
  ...
  + Fonts
    ...
    Table of contents
    - [Font Related Configuration](https://wezterm.org/config/fonts.html#font-related-configuration)

      * [Fallback](https://wezterm.org/config/fonts.html#fallback)
    - [Font Related Options](https://wezterm.org/config/fonts.html#font-related-options)
    - [Troubleshooting Fonts](https://wezterm.org/config/fonts.html#troubleshooting-fonts)
...
### Font Related Configuration[¶](https://wezterm.org/config/fonts.html#font-related-configuration "Permanent link")
...
the [wezterm.font](https://wezterm.org/config/lua/wezterm/font.html) function to specify it:
...
#### Fallback[¶](https://wezterm.org/config/fonts.html#fallback "Permanent link")
...
### Font Related Options[¶](https://wezterm.org/config/fonts.html#font-related-options "Permanent link")

Additional options for configuring fonts can be found elsewhere in the docs:

* [bold\_brightens\_ansi\_colors](https://wezterm.org/config/lua/config/bold_brightens_ansi_colors.html) - whether bold text uses the bright ansi palette
* [dpi](https://wezterm.org/config/lua/config/dpi.html) - override the DPI; potentially useful for X11 users with high-density displays if experiencing tiny or blurry fonts
* [font\_dirs](https://wezterm.org/config/lua/config/font_dirs.html) - look for fonts in a set of directories
* [font\_locator](https://wezterm.org/config/lua/config/font_locator.html) - override the system font resolver
* [font\_rules](https://wezterm.org/config/lua/config/font_rules.html) - advanced control over which fonts are used for italic, bold and other textual styles
* [font\_shaper](https://wezterm.org/config/lua/config/font_shaper.html) - affects kerning and ligatures
* [font\_size](https://wezterm.org/config/lua/config/font_size.html) - change the size of the text
* [freetype\_load\_flags](https://wezterm.org/config/lua/config/freetype_load_flags.html) - advanced hinting configuration
* [freetype\_load\_target](https://wezterm.org/config/lua/config/freetype_load_target.html) - configure hinting and anti-aliasing
* [freetype\_render\_target](https://wezterm.org/config/lua/config/freetype_render_target.html) - configure anti-aliasing
* [cell\_width](https://wezterm.org/config/lua/config/cell_width.html) - scale the font-specified cell width
* [line\_height](https://wezterm.org/config/lua/config/line_height.html) - scale the font-specified line height
* [wezterm.font](https://wezterm.org/config/lua/wezterm/font.html) - select a font based on family and style attributes
* [wezterm.font\_with\_fallback](https://wezterm.org/config/lua/wezterm/font_with_fallback.html) - select a font from a list of candidates

## Troubleshooting Fonts[¶](https://wezterm.org/config/fonts.html#troubleshooting-fonts "Permanent link")
