---
title: "Troubleshooting - Wez's Terminal Emulator"
source_url: "https://wezterm.org/troubleshooting"
...
* Get Help
  ...
  + Troubleshooting
    ...
    Table of contents
    - [Review logs/error messages](https://wezterm.org/troubleshooting.html#review-logserror-messages)

      * [Debug Overlay](https://wezterm.org/troubleshooting.html#debug-overlay)
      * [Log Files](https://wezterm.org/troubleshooting.html#log-files)
      * [Increasing Log Verbosity](https://wezterm.org/troubleshooting.html#increasing-log-verbosity)
    - [Debugging Keyboard Related issues](https://wezterm.org/troubleshooting.html#debugging-keyboard-related-issues)
    - [Debugging Font Display](https://wezterm.org/troubleshooting.html#debugging-font-display)
...
# Troubleshooting[¶](https://wezterm.org/troubleshooting.html#troubleshooting "Permanent link")

## Review logs/error messages[¶](https://wezterm.org/troubleshooting.html#review-logserror-messages "Permanent link")

If things aren't working out, there may be an issue printed in the logs.
Read on to learn more about how to see those logs.

### Debug Overlay[¶](https://wezterm.org/troubleshooting.html#debug-overlay "Permanent link")

By default, pressing `Ctrl` + `Shift` + `L` will activate
...
See [ShowDebugOverlay](https://wezterm.org/config/lua/keyassignment/ShowDebugOverlay.html) for more
information on this key assignment.

### Log Files[¶](https://wezterm.org/troubleshooting.html#log-files "Permanent link")
...
### Increasing Log Verbosity[¶](https://wezterm.org/troubleshooting.html#increasing-log-verbosity "Permanent link")
...
See Rust's [env\_logger
documentation](https://docs.rs/env_logger/latest/env_logger/#enabling-logging)
for more details on the syntax/possibilities.

## Debugging Keyboard Related issues[¶](https://wezterm.org/troubleshooting.html#debugging-keyboard-related-issues "Permanent link")

Turn on [debug\_key\_events](https://wezterm.org/config/lua/config/debug_key_events.html) to log
information about key presses.

Use [wezterm show-keys](https://wezterm.org/cli/show-keys.html) or `wezterm show-keys --lua` to show
the effective set of key and mouse assignments defined by your config.

Consider changing [use\_ime](https://wezterm.org/config/lua/config/use_ime.html) to see that is
...
## Debugging Font Display[¶](https://wezterm.org/troubleshooting.html#debugging-font-display "Permanent link")
