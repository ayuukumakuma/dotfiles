---
title: "Multiplexing - Wez's Terminal Emulator"
source_url: "https://wezterm.org/multiplexing"
...
* [WezTerm](https://wezterm.org/index.html)
  ...
  + Multiplexing
    ...
    Table of contents
    - [Multiplexing](https://wezterm.org/multiplexing.html#multiplexing)
    - [SSH Domains](https://wezterm.org/multiplexing.html#ssh-domains)
    - [Unix Domains](https://wezterm.org/multiplexing.html#unix-domains)

      * [Connecting into Windows Subsystem for Linux](https://wezterm.org/multiplexing.html#connecting-into-windows-subsystem-for-linux)
    - [TLS Domains](https://wezterm.org/multiplexing.html#tls-domains)

      * [Configuring the client](https://wezterm.org/multiplexing.html#configuring-the-client)
      * [Configuring the server](https://wezterm.org/multiplexing.html#configuring-the-server)
      * [Connecting](https://wezterm.org/multiplexing.html#connecting)
* Download
...
## Multiplexing[¶](https://wezterm.org/multiplexing.html#multiplexing "Permanent link")
...
## SSH Domains[¶](https://wezterm.org/multiplexing.html#ssh-domains "Permanent link")

*wezterm also supports [regular ad-hoc ssh connections](https://wezterm.org/ssh.html).
...
[See SshDomain](https://wezterm.org/config/lua/SshDomain.html) for more information on possible
...
Ssh\_domains now auto-populate from your `~/.ssh/config` file. Each populated host will have both a plain SSH and a multiplexing SSH domain. Plain SSH hosts are defined with a `SSH:` prefix to their name and multiplexing hosts are defined with a prefix `SSHMUX:`. For example, to connect to a host named `my.server` in your `~/.ssh/config` using a multiplexing domain, run:
...
To customize this functionality, see the example for [wezterm.default\_ssh\_domains()](https://wezterm.org/config/lua/wezterm/default_ssh_domains.html)

## Unix Domains[¶](https://wezterm.org/multiplexing.html#unix-domains "Permanent link")
...
### Connecting into Windows Subsystem for Linux[¶](https://wezterm.org/multiplexing.html#connecting-into-windows-subsystem-for-linux "Permanent link")

*Note: this only works with WSL 1. [WSL 2 doesn't support AF\_UNIX interop](https://github.com/microsoft/WSL/issues/5961)*
...
## TLS Domains[¶](https://wezterm.org/multiplexing.html#tls-domains "Permanent link")
...
### Configuring the client[¶](https://wezterm.org/multiplexing.html#configuring-the-client "Permanent link")
...
[See TlsDomainClient](https://wezterm.org/config/lua/TlsDomainClient.html) for more information on possible
settings.

### Configuring the server[¶](https://wezterm.org/multiplexing.html#configuring-the-server "Permanent link")
...
[See TlsDomainServer](https://wezterm.org/config/lua/TlsDomainServer.html) for more information on possible
settings.

### Connecting[¶](https://wezterm.org/multiplexing.html#connecting "Permanent link")
