---
title: "SSH - Wez's Terminal Emulator"
source_url: "https://wezterm.org/ssh"
...
* [WezTerm](https://wezterm.org/index.html)
  ...
  + SSH
    ...
    Table of contents
    - [CLI Overrides](https://wezterm.org/ssh.html#cli-overrides)
...
Take a look at [the multiplexing section](https://wezterm.org/multiplexing.html) for an
alternative configuration that connects to a remote wezterm instance
and preserves your tabs.

The [ssh\_backend](https://wezterm.org/config/lua/config/ssh_backend.html) configuration can
be used to specify which ssh library is used.

*Since: Version 20210404-112810-b63a949d*

*The functionality described in this section requires version 20210404-112810-b63a949d of wezterm,
...
### CLI Overrides[¶](https://wezterm.org/ssh.html#cli-overrides "Permanent link")
