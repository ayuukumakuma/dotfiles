...
source_url: "https://ghostty.org/docs/install/release-notes/1-0-1"
...
* [1.0.1](https://ghostty.org/docs/install/release-notes/1-0-1.html)
...
period of development towards the next significant release[1](https://ghostty.org/docs/install/release-notes/1-0-1.html#user-content-fn-1). This pattern
...
1. Barring any critical issues or security advisories that require
   immediate attention. [↩](https://ghostty.org/docs/install/release-notes/1-0-1.html#user-content-fnref-1)



[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/install/release-notes/1-0-1.mdx)

* [Security](https://ghostty.org/docs/install/release-notes/1-0-1.html#security)
* [Highlights](https://ghostty.org/docs/install/release-notes/1-0-1.html#highlights)
* [Default Configuration File](https://ghostty.org/docs/install/release-notes/1-0-1.html#default-configuration-file)
* [Bitmap Font Support](https://ghostty.org/docs/install/release-notes/1-0-1.html#bitmap-font-support)
* [macOS: "Settings" Improvements](https://ghostty.org/docs/install/release-notes/1-0-1.html#macos:-"settings"-improvements)
* [Improvements](https://ghostty.org/docs/install/release-notes/1-0-1.html#improvements)
* [Bug Fixes](https://ghostty.org/docs/install/release-notes/1-0-1.html#bug-fixes)
* [macOS](https://ghostty.org/docs/install/release-notes/1-0-1.html#macos)
* [Linux (GTK)](https://ghostty.org/docs/install/release-notes/1-0-1.html#linux-(gtk))
* [Changes for Package Maintainers](https://ghostty.org/docs/install/release-notes/1-0-1.html#changes-for-package-maintainers)
* [Known Issues](https://ghostty.org/docs/install/release-notes/1-0-1.html#known-issues)
* [Roadmap](https://ghostty.org/docs/install/release-notes/1-0-1.html#roadmap)
