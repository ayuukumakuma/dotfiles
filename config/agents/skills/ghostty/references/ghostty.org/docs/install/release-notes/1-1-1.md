...
source_url: "https://ghostty.org/docs/install/release-notes/1-1-1"
...
* [1.1.1](https://ghostty.org/docs/install/release-notes/1-1-1.html)
...
[server-side decorations (SSD) on Linux for Wayland compositors](https://ghostty.org/docs/install/release-notes/1-1-0.html#server-side-decorations-(ssd)-on-linux).
...
please
[carefully read the details about this change](https://ghostty.org/docs/install/release-notes/1-1-0.html#gtk:-forcing-a-dependency-on-libadwaita).



[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/install/release-notes/1-1-1.mdx)

* [Highlights](https://ghostty.org/docs/install/release-notes/1-1-1.html#highlights)
* [Server Side Decorations (SSD) on Linux X11](https://ghostty.org/docs/install/release-notes/1-1-1.html#server-side-decorations-(ssd)-on-linux-x11)
* [Continued Input Method Editor (IME) Improvements](https://ghostty.org/docs/install/release-notes/1-1-1.html#continued-input-method-editor-(ime)-improvements)
* [macOS: Renderer Improvements for Intel GPUs](https://ghostty.org/docs/install/release-notes/1-1-1.html#macos:-renderer-improvements-for-intel-gpus)
* [Full List](https://ghostty.org/docs/install/release-notes/1-1-1.html#full-list)
* [macOS](https://ghostty.org/docs/install/release-notes/1-1-1.html#macos)
* [Linux (GTK)](https://ghostty.org/docs/install/release-notes/1-1-1.html#linux-(gtk))
* [Changes for Package Maintainers](https://ghostty.org/docs/install/release-notes/1-1-1.html#changes-for-package-maintainers)
* [Roadmap](https://ghostty.org/docs/install/release-notes/1-1-1.html#roadmap)
