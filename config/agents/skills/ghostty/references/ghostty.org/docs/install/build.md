---
title: "Build from Source - Install"
source_url: "https://ghostty.org/docs/install/build"
...
> instead. See [the binaries and packages page](https://ghostty.org/docs/install/binary.html) to
...
reliable way to build Ghostty. See the [Building with Nix](https://ghostty.org/docs/install/build.html#building-with-nix)
section to see how to set up the Nix environment.

Depending on your platform, you may also need to install additional
dependencies to build Ghostty. For Linux, see [Linux](https://ghostty.org/docs/install/build.html#linux). For macOS,
see [macOS](https://ghostty.org/docs/install/build.html#macos).
...
> [Installation Directory](https://ghostty.org/docs/install/build.html#installation-directory).
...
ensure that `~/.local/bin` is on your *system* `PATH`. The desktop environment
...
The above can happen if you install the Xcode Command Line Tools *after* Xcode
is installed.
...
[use the official binary build](https://ghostty.org/download.html).



[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/install/build.mdx)

* [Getting the source code](https://ghostty.org/docs/install/build.html#getting-the-source-code)
* [Linux](https://ghostty.org/docs/install/build.html#linux)
* [Dependencies](https://ghostty.org/docs/install/build.html#dependencies)
* [Alpine](https://ghostty.org/docs/install/build.html#alpine)
* [Arch Linux](https://ghostty.org/docs/install/build.html#arch-linux)
* [Debian and Ubuntu](https://ghostty.org/docs/install/build.html#debian-and-ubuntu)
* [Fedora](https://ghostty.org/docs/install/build.html#fedora)
* [Gentoo](https://ghostty.org/docs/install/build.html#gentoo)
* [openSUSE Tumbleweed](https://ghostty.org/docs/install/build.html#opensuse-tumbleweed)
* [openSUSE Leap](https://ghostty.org/docs/install/build.html#opensuse-leap)
* [Solus](https://ghostty.org/docs/install/build.html#solus)
* [Void](https://ghostty.org/docs/install/build.html#void)
* [Installation Directory](https://ghostty.org/docs/install/build.html#installation-directory)
* [Building with Nix](https://ghostty.org/docs/install/build.html#building-with-nix)
* [macOS](https://ghostty.org/docs/install/build.html#macos)
* [Dependencies](https://ghostty.org/docs/install/build.html#dependencies-2)
* [Xcode](https://ghostty.org/docs/install/build.html#xcode)
* [Other Dependencies](https://ghostty.org/docs/install/build.html#other-dependencies)
* [Mac .app](https://ghostty.org/docs/install/build.html#mac-.app)
