...
source_url: "https://ghostty.org/docs/help/gtk-opengl-context"
...
* [GTK OpenGL Context](https://ghostty.org/docs/help/gtk-opengl-context.html)
...
1. **Install a [binary package](https://ghostty.org/docs/install/binary.html).** If you're building
...
3. **Build Ghostty from source using only system packages.** If you're using
   ...
   [build from source](https://ghostty.org/docs/install/build.html) instructions to do this
...
You can follow the [build from source](https://ghostty.org/docs/install/build.html) instructions
...
* [Quick Fixes](https://ghostty.org/docs/help/gtk-opengl-context.html#quick-fixes)
* [Mismatched Library Versions](https://ghostty.org/docs/help/gtk-opengl-context.html#mismatched-library-versions)
* [Known Historical Causes](https://ghostty.org/docs/help/gtk-opengl-context.html#known-historical-causes)
