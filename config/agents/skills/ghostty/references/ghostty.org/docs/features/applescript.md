---
title: "AppleScript (macOS) - Features"
...
* [AppleScript (macOS)](https://ghostty.org/docs/features/applescript.html)
...
configuration. See [Keybind Action Reference](https://ghostty.org/docs/config/keybind/reference.html).
...
[Edit on GitHub](https://github.com/ghostty-org/website/edit/main/docs/features/applescript.mdx)

* [Overview](https://ghostty.org/docs/features/applescript.html#overview)
* [Scripting Dictionary](https://ghostty.org/docs/features/applescript.html#scripting-dictionary)
* [Object Model](https://ghostty.org/docs/features/applescript.html#object-model)
* [Object Query Examples](https://ghostty.org/docs/features/applescript.html#object-query-examples)
* [Commands](https://ghostty.org/docs/features/applescript.html#commands)
* [Creation and Layout](https://ghostty.org/docs/features/applescript.html#creation-and-layout)
* [Focus, Selection, and Lifecycle](https://ghostty.org/docs/features/applescript.html#focus-selection-and-lifecycle)
* [Input and Actions](https://ghostty.org/docs/features/applescript.html#input-and-actions)
* [Surface Configuration Records](https://ghostty.org/docs/features/applescript.html#surface-configuration-records)
* [Security](https://ghostty.org/docs/features/applescript.html#security)
* [Examples](https://ghostty.org/docs/features/applescript.html#examples)
* [Build a Tmux-style Layout](https://ghostty.org/docs/features/applescript.html#build-a-tmux-style-layout)
* [Broadcast a Command to Every Terminal](https://ghostty.org/docs/features/applescript.html#broadcast-a-command-to-every-terminal)
* [Jump to a Terminal by Working Directory](https://ghostty.org/docs/features/applescript.html#jump-to-a-terminal-by-working-directory)
