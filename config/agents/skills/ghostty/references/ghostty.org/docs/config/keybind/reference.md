...
* [Keybindings](https://ghostty.org/docs/config/keybind.html)
* [Action Reference](https://ghostty.org/docs/config/keybind/reference.html)
...
elements showing search. For that, the explicit end\_search binding
should be used.
...
[Edit on GitHub](https://github.com/ghostty-org/ghostty/edit/main/src/input/Binding.zig)

* [ignore](https://ghostty.org/docs/config/keybind/reference.html#ignore)
* [unbind](https://ghostty.org/docs/config/keybind/reference.html#unbind)
* [csi](https://ghostty.org/docs/config/keybind/reference.html#csi)
* [esc](https://ghostty.org/docs/config/keybind/reference.html#esc)
* [text](https://ghostty.org/docs/config/keybind/reference.html#text)
* [cursor\_key](https://ghostty.org/docs/config/keybind/reference.html#cursor_key)
* [reset](https://ghostty.org/docs/config/keybind/reference.html#reset)
* [copy\_to\_clipboard](https://ghostty.org/docs/config/keybind/reference.html#copy_to_clipboard)
* [paste\_from\_clipboard](https://ghostty.org/docs/config/keybind/reference.html#paste_from_clipboard)
* [paste\_from\_selection](https://ghostty.org/docs/config/keybind/reference.html#paste_from_selection)
* [copy\_url\_to\_clipboard](https://ghostty.org/docs/config/keybind/reference.html#copy_url_to_clipboard)
* [copy\_title\_to\_clipboard](https://ghostty.org/docs/config/keybind/reference.html#copy_title_to_clipboard)
* [increase\_font\_size](https://ghostty.org/docs/config/keybind/reference.html#increase_font_size)
* [decrease\_font\_size](https://ghostty.org/docs/config/keybind/reference.html#decrease_font_size)
* [reset\_font\_size](https://ghostty.org/docs/config/keybind/reference.html#reset_font_size)
* [set\_font\_size](https://ghostty.org/docs/config/keybind/reference.html#set_font_size)
* [search](https://ghostty.org/docs/config/keybind/reference.html#search)
* [search\_selection](https://ghostty.org/docs/config/keybind/reference.html#search_selection)
* [navigate\_search](https://ghostty.org/docs/config/keybind/reference.html#navigate_search)
* [start\_search](https://ghostty.org/docs/config/keybind/reference.html#start_search)
* [end\_search](https://ghostty.org/docs/config/keybind/reference.html#end_search)
* [clear\_screen](https://ghostty.org/docs/config/keybind/reference.html#clear_screen)
* [select\_all](https://ghostty.org/docs/config/keybind/reference.html#select_all)
* [scroll\_to\_top](https://ghostty.org/docs/config/keybind/reference.html#scroll_to_top)
* [scroll\_to\_bottom](https://ghostty.org/docs/config/keybind/reference.html#scroll_to_bottom)
* [scroll\_to\_selection](https://ghostty.org/docs/config/keybind/reference.html#scroll_to_selection)
* [scroll\_to\_row](https://ghostty.org/docs/config/keybind/reference.html#scroll_to_row)
* [scroll\_page\_up](https://ghostty.org/docs/config/keybind/reference.html#scroll_page_up)
* [scroll\_page\_down](https://ghostty.org/docs/config/keybind/reference.html#scroll_page_down)
* [scroll\_page\_fractional](https://ghostty.org/docs/config/keybind/reference.html#scroll_page_fractional)
* [scroll\_page\_lines](https://ghostty.org/docs/config/keybind/reference.html#scroll_page_lines)
* [adjust\_selection](https://ghostty.org/docs/config/keybind/reference.html#adjust_selection)
* [jump\_to\_prompt](https://ghostty.org/docs/config/keybind/reference.html#jump_to_prompt)
* [write\_scrollback\_file](https://ghostty.org/docs/config/keybind/reference.html#write_scrollback_file)
* [write\_screen\_file](https://ghostty.org/docs/config/keybind/reference.html#write_screen_file)
* [write\_selection\_file](https://ghostty.org/docs/config/keybind/reference.html#write_selection_file)
* [new\_window](https://ghostty.org/docs/config/keybind/reference.html#new_window)
* [new\_tab](https://ghostty.org/docs/config/keybind/reference.html#new_tab)
* [previous\_tab](https://ghostty.org/docs/config/keybind/reference.html#previous_tab)
* [next\_tab](https://ghostty.org/docs/config/keybind/reference.html#next_tab)
* [last\_tab](https://ghostty.org/docs/config/keybind/reference.html#last_tab)
* [goto\_tab](https://ghostty.org/docs/config/keybind/reference.html#goto_tab)
* [move\_tab](https://ghostty.org/docs/config/keybind/reference.html#move_tab)
* [toggle\_tab\_overview](https://ghostty.org/docs/config/keybind/reference.html#toggle_tab_overview)
* [prompt\_surface\_title](https://ghostty.org/docs/config/keybind/reference.html#prompt_surface_title)
* [prompt\_tab\_title](https://ghostty.org/docs/config/keybind/reference.html#prompt_tab_title)
* [set\_surface\_title](https://ghostty.org/docs/config/keybind/reference.html#set_surface_title)
* [set\_tab\_title](https://ghostty.org/docs/config/keybind/reference.html#set_tab_title)
* [new\_split](https://ghostty.org/docs/config/keybind/reference.html#new_split)
* [goto\_split](https://ghostty.org/docs/config/keybind/reference.html#goto_split)
* [goto\_window](https://ghostty.org/docs/config/keybind/reference.html#goto_window)
* [toggle\_split\_zoom](https://ghostty.org/docs/config/keybind/reference.html#toggle_split_zoom)
* [toggle\_readonly](https://ghostty.org/docs/config/keybind/reference.html#toggle_readonly)
* [resize\_split](https://ghostty.org/docs/config/keybind/reference.html#resize_split)
* [equalize\_splits](https://ghostty.org/docs/config/keybind/reference.html#equalize_splits)
* [reset\_window\_size](https://ghostty.org/docs/config/keybind/reference.html#reset_window_size)
* [inspector](https://ghostty.org/docs/config/keybind/reference.html#inspector)
* [show\_gtk\_inspector](https://ghostty.org/docs/config/keybind/reference.html#show_gtk_inspector)
* [show\_on\_screen\_keyboard](https://ghostty.org/docs/config/keybind/reference.html#show_on_screen_keyboard)
* [open\_config](https://ghostty.org/docs/config/keybind/reference.html#open_config)
* [reload\_config](https://ghostty.org/docs/config/keybind/reference.html#reload_config)
* [close\_surface](https://ghostty.org/docs/config/keybind/reference.html#close_surface)
* [close\_tab](https://ghostty.org/docs/config/keybind/reference.html#close_tab)
* [close\_window](https://ghostty.org/docs/config/keybind/reference.html#close_window)
* [close\_all\_windows](https://ghostty.org/docs/config/keybind/reference.html#close_all_windows)
* [toggle\_maximize](https://ghostty.org/docs/config/keybind/reference.html#toggle_maximize)
* [toggle\_fullscreen](https://ghostty.org/docs/config/keybind/reference.html#toggle_fullscreen)
* [toggle\_window\_decorations](https://ghostty.org/docs/config/keybind/reference.html#toggle_window_decorations)
* [toggle\_window\_float\_on\_top](https://ghostty.org/docs/config/keybind/reference.html#toggle_window_float_on_top)
* [toggle\_secure\_input](https://ghostty.org/docs/config/keybind/reference.html#toggle_secure_input)
* [toggle\_mouse\_reporting](https://ghostty.org/docs/config/keybind/reference.html#toggle_mouse_reporting)
* [toggle\_command\_palette](https://ghostty.org/docs/config/keybind/reference.html#toggle_command_palette)
* [toggle\_quick\_terminal](https://ghostty.org/docs/config/keybind/reference.html#toggle_quick_terminal)
* [toggle\_visibility](https://ghostty.org/docs/config/keybind/reference.html#toggle_visibility)
* [toggle\_background\_opacity](https://ghostty.org/docs/config/keybind/reference.html#toggle_background_opacity)
* [check\_for\_updates](https://ghostty.org/docs/config/keybind/reference.html#check_for_updates)
* [undo](https://ghostty.org/docs/config/keybind/reference.html#undo)
* [redo](https://ghostty.org/docs/config/keybind/reference.html#redo)
* [end\_key\_sequence](https://ghostty.org/docs/config/keybind/reference.html#end_key_sequence)
