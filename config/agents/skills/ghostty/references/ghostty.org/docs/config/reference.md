---
title: "Option Reference - Configuration"
...
* [Configuration](https://ghostty.org/docs/config.html)
* [Option Reference](https://ghostty.org/docs/config/reference.html)
...
This will not affect the language used by programs run *within* Ghostty.
...
> Warning
>
> This setting cannot be reloaded at runtime. To change the language
...
> Warning
>
> the exact blur intensity is *ignored* under KDE Plasma, and setting
...
config path ($XDG\_CONFIG\_HOME/ghostty/config.ghostty).
...
* `ssh-env` - Enable SSH environment variable compatibility. Automatically
  ...
  remote hosts and propagates COLORTERM, TERM\_PROGRAM, and TERM\_PROGRAM\_VERSION.
  Whether or not these variables will be accepted by the remote host(s) will
  depend on whether or not the variables are allowed in their sshd\_config.
  (Available since: 1.2.0)
...
> Warning
>
> The `custom-style` option is *experimental*. We may change
...
1. TERM\_PROGRAM environment variable is a non-empty value. In this
...
* [language](https://ghostty.org/docs/config/reference.html#language)
* [font-family](https://ghostty.org/docs/config/reference.html#font-family)
* [font-family-bold](https://ghostty.org/docs/config/reference.html#font-family-bold)
* [font-family-italic](https://ghostty.org/docs/config/reference.html#font-family-italic)
* [font-family-bold-italic](https://ghostty.org/docs/config/reference.html#font-family-bold-italic)
* [font-style](https://ghostty.org/docs/config/reference.html#font-style)
* [font-style-bold](https://ghostty.org/docs/config/reference.html#font-style-bold)
* [font-style-italic](https://ghostty.org/docs/config/reference.html#font-style-italic)
* [font-style-bold-italic](https://ghostty.org/docs/config/reference.html#font-style-bold-italic)
* [font-synthetic-style](https://ghostty.org/docs/config/reference.html#font-synthetic-style)
* [font-feature](https://ghostty.org/docs/config/reference.html#font-feature)
* [font-size](https://ghostty.org/docs/config/reference.html#font-size)
* [font-variation](https://ghostty.org/docs/config/reference.html#font-variation)
* [font-variation-bold](https://ghostty.org/docs/config/reference.html#font-variation-bold)
* [font-variation-italic](https://ghostty.org/docs/config/reference.html#font-variation-italic)
* [font-variation-bold-italic](https://ghostty.org/docs/config/reference.html#font-variation-bold-italic)
* [font-codepoint-map](https://ghostty.org/docs/config/reference.html#font-codepoint-map)
* [clipboard-codepoint-map](https://ghostty.org/docs/config/reference.html#clipboard-codepoint-map)
* [font-thicken](https://ghostty.org/docs/config/reference.html#font-thicken)
* [font-thicken-strength](https://ghostty.org/docs/config/reference.html#font-thicken-strength)
* [font-shaping-break](https://ghostty.org/docs/config/reference.html#font-shaping-break)
* [alpha-blending](https://ghostty.org/docs/config/reference.html#alpha-blending)
* [adjust-cell-width](https://ghostty.org/docs/config/reference.html#adjust-cell-width)
* [adjust-cell-height](https://ghostty.org/docs/config/reference.html#adjust-cell-height)
* [adjust-font-baseline](https://ghostty.org/docs/config/reference.html#adjust-font-baseline)
* [adjust-underline-position](https://ghostty.org/docs/config/reference.html#adjust-underline-position)
* [adjust-underline-thickness](https://ghostty.org/docs/config/reference.html#adjust-underline-thickness)
* [adjust-strikethrough-position](https://ghostty.org/docs/config/reference.html#adjust-strikethrough-position)
* [adjust-strikethrough-thickness](https://ghostty.org/docs/config/reference.html#adjust-strikethrough-thickness)
* [adjust-overline-position](https://ghostty.org/docs/config/reference.html#adjust-overline-position)
* [adjust-overline-thickness](https://ghostty.org/docs/config/reference.html#adjust-overline-thickness)
* [adjust-cursor-thickness](https://ghostty.org/docs/config/reference.html#adjust-cursor-thickness)
* [adjust-cursor-height](https://ghostty.org/docs/config/reference.html#adjust-cursor-height)
* [adjust-box-thickness](https://ghostty.org/docs/config/reference.html#adjust-box-thickness)
* [adjust-icon-height](https://ghostty.org/docs/config/reference.html#adjust-icon-height)
* [grapheme-width-method](https://ghostty.org/docs/config/reference.html#grapheme-width-method)
* [freetype-load-flags](https://ghostty.org/docs/config/reference.html#freetype-load-flags)
* [theme](https://ghostty.org/docs/config/reference.html#theme)
...
* [background-image](https://ghostty.org/docs/config/reference.html#background-image)
* [background-image-opacity](https://ghostty.org/docs/config/reference.html#background-image-opacity)
* [background-image-position](https://ghostty.org/docs/config/reference.html#background-image-position)
* [background-image-fit](https://ghostty.org/docs/config/reference.html#background-image-fit)
* [background-image-repeat](https://ghostty.org/docs/config/reference.html#background-image-repeat)
...
* [selection-clear-on-typing](https://ghostty.org/docs/config/reference.html#selection-clear-on-typing)
* [selection-clear-on-copy](https://ghostty.org/docs/config/reference.html#selection-clear-on-copy)
* [selection-word-chars](https://ghostty.org/docs/config/reference.html#selection-word-chars)
* [minimum-contrast](https://ghostty.org/docs/config/reference.html#minimum-contrast)
* [palette](https://ghostty.org/docs/config/reference.html#palette)
* [palette-generate](https://ghostty.org/docs/config/reference.html#palette-generate)
* [palette-harmonious](https://ghostty.org/docs/config/reference.html#palette-harmonious)
* [cursor-color](https://ghostty.org/docs/config/reference.html#cursor-color)
* [cursor-opacity](https://ghostty.org/docs/config/reference.html#cursor-opacity)
* [cursor-style](https://ghostty.org/docs/config/reference.html#cursor-style)
* [cursor-style-blink](https://ghostty.org/docs/config/reference.html#cursor-style-blink)
* [cursor-text](https://ghostty.org/docs/config/reference.html#cursor-text)
* [cursor-click-to-move](https://ghostty.org/docs/config/reference.html#cursor-click-to-move)
* [mouse-hide-while-typing](https://ghostty.org/docs/config/reference.html#mouse-hide-while-typing)
* [scroll-to-bottom](https://ghostty.org/docs/config/reference.html#scroll-to-bottom)
* [mouse-shift-capture](https://ghostty.org/docs/config/reference.html#mouse-shift-capture)
* [mouse-reporting](https://ghostty.org/docs/config/reference.html#mouse-reporting)
* [mouse-scroll-multiplier](https://ghostty.org/docs/config/reference.html#mouse-scroll-multiplier)
* [background-opacity](https://ghostty.org/docs/config/reference.html#background-opacity)
* [background-opacity-cells](https://ghostty.org/docs/config/reference.html#background-opacity-cells)
* [background-blur](https://ghostty.org/docs/config/reference.html#background-blur)
* [unfocused-split-opacity](https://ghostty.org/docs/config/reference.html#unfocused-split-opacity)
* [unfocused-split-fill](https://ghostty.org/docs/config/reference.html#unfocused-split-fill)
* [split-divider-color](https://ghostty.org/docs/config/reference.html#split-divider-color)
* [split-preserve-zoom](https://ghostty.org/docs/config/reference.html#split-preserve-zoom)
* [search-foreground](https://ghostty.org/docs/config/reference.html#search-foreground)
* [search-background](https://ghostty.org/docs/config/reference.html#search-background)
* [search-selected-foreground](https://ghostty.org/docs/config/reference.html#search-selected-foreground)
* [search-selected-background](https://ghostty.org/docs/config/reference.html#search-selected-background)
* [command](https://ghostty.org/docs/config/reference.html#command)
* [initial-command](https://ghostty.org/docs/config/reference.html#initial-command)
* [notify-on-command-finish](https://ghostty.org/docs/config/reference.html#notify-on-command-finish)
* [notify-on-command-finish-action](https://ghostty.org/docs/config/reference.html#notify-on-command-finish-action)
* [notify-on-command-finish-after](https://ghostty.org/docs/config/reference.html#notify-on-command-finish-after)
* [env](https://ghostty.org/docs/config/reference.html#env)
* [input](https://ghostty.org/docs/config/reference.html#input)
* [wait-after-command](https://ghostty.org/docs/config/reference.html#wait-after-command)
* [abnormal-command-exit-runtime](https://ghostty.org/docs/config/reference.html#abnormal-command-exit-runtime)
* [scrollback-limit](https://ghostty.org/docs/config/reference.html#scrollback-limit)
* [scrollbar](https://ghostty.org/docs/config/reference.html#scrollbar)
* [link](https://ghostty.org/docs/config/reference.html#link)
* [link-url](https://ghostty.org/docs/config/reference.html#link-url)
* [link-previews](https://ghostty.org/docs/config/reference.html#link-previews)
* [maximize](https://ghostty.org/docs/config/reference.html#maximize)
* [fullscreen](https://ghostty.org/docs/config/reference.html#fullscreen)
* [title](https://ghostty.org/docs/config/reference.html#title)
* [class](https://ghostty.org/docs/config/reference.html#class)
* [x11-instance-name](https://ghostty.org/docs/config/reference.html#x11-instance-name)
* [working-directory](https://ghostty.org/docs/config/reference.html#working-directory)
* [keybind](https://ghostty.org/docs/config/reference.html#keybind)
* [Chained Actions](https://ghostty.org/docs/config/reference.html#chained-actions)
* [Key Tables](https://ghostty.org/docs/config/reference.html#key-tables)
* [key-remap](https://ghostty.org/docs/config/reference.html#key-remap)
* [window-padding-x](https://ghostty.org/docs/config/reference.html#window-padding-x)
* [window-padding-y](https://ghostty.org/docs/config/reference.html#window-padding-y)
* [window-padding-balance](https://ghostty.org/docs/config/reference.html#window-padding-balance)
* [window-padding-color](https://ghostty.org/docs/config/reference.html#window-padding-color)
* [window-vsync](https://ghostty.org/docs/config/reference.html#window-vsync)
* [window-inherit-working-directory](https://ghostty.org/docs/config/reference.html#window-inherit-working-directory)
* [tab-inherit-working-directory](https://ghostty.org/docs/config/reference.html#tab-inherit-working-directory)
* [split-inherit-working-directory](https://ghostty.org/docs/config/reference.html#split-inherit-working-directory)
* [window-inherit-font-size](https://ghostty.org/docs/config/reference.html#window-inherit-font-size)
* [window-decoration](https://ghostty.org/docs/config/reference.html#window-decoration)
* [window-title-font-family](https://ghostty.org/docs/config/reference.html#window-title-font-family)
* [window-subtitle](https://ghostty.org/docs/config/reference.html#window-subtitle)
* [window-theme](https://ghostty.org/docs/config/reference.html#window-theme)
* [window-colorspace](https://ghostty.org/docs/config/reference.html#window-colorspace)
* [window-height](https://ghostty.org/docs/config/reference.html#window-height)
* [window-width](https://ghostty.org/docs/config/reference.html#window-width)
* [window-position-x](https://ghostty.org/docs/config/reference.html#window-position-x)
* [window-position-y](https://ghostty.org/docs/config/reference.html#window-position-y)
* [window-save-state](https://ghostty.org/docs/config/reference.html#window-save-state)
* [window-step-resize](https://ghostty.org/docs/config/reference.html#window-step-resize)
* [window-new-tab-position](https://ghostty.org/docs/config/reference.html#window-new-tab-position)
* [window-show-tab-bar](https://ghostty.org/docs/config/reference.html#window-show-tab-bar)
* [window-titlebar-background](https://ghostty.org/docs/config/reference.html#window-titlebar-background)
* [window-titlebar-foreground](https://ghostty.org/docs/config/reference.html#window-titlebar-foreground)
* [resize-overlay](https://ghostty.org/docs/config/reference.html#resize-overlay)
* [resize-overlay-position](https://ghostty.org/docs/config/reference.html#resize-overlay-position)
* [resize-overlay-duration](https://ghostty.org/docs/config/reference.html#resize-overlay-duration)
* [focus-follows-mouse](https://ghostty.org/docs/config/reference.html#focus-follows-mouse)
* [clipboard-read](https://ghostty.org/docs/config/reference.html#clipboard-read)
* [clipboard-write](https://ghostty.org/docs/config/reference.html#clipboard-write)
* [clipboard-trim-trailing-spaces](https://ghostty.org/docs/config/reference.html#clipboard-trim-trailing-spaces)
* [clipboard-paste-protection](https://ghostty.org/docs/config/reference.html#clipboard-paste-protection)
* [clipboard-paste-bracketed-safe](https://ghostty.org/docs/config/reference.html#clipboard-paste-bracketed-safe)
* [title-report](https://ghostty.org/docs/config/reference.html#title-report)
* [image-storage-limit](https://ghostty.org/docs/config/reference.html#image-storage-limit)
* [copy-on-select](https://ghostty.org/docs/config/reference.html#copy-on-select)
* [right-click-action](https://ghostty.org/docs/config/reference.html#right-click-action)
* [click-repeat-interval](https://ghostty.org/docs/config/reference.html#click-repeat-interval)
* [config-file](https://ghostty.org/docs/config/reference.html#config-file)
* [config-default-files](https://ghostty.org/docs/config/reference.html#config-default-files)
* [confirm-close-surface](https://ghostty.org/docs/config/reference.html#confirm-close-surface)
* [quit-after-last-window-closed](https://ghostty.org/docs/config/reference.html#quit-after-last-window-closed)
* [quit-after-last-window-closed-delay](https://ghostty.org/docs/config/reference.html#quit-after-last-window-closed-delay)
* [initial-window](https://ghostty.org/docs/config/reference.html#initial-window)
* [undo-timeout](https://ghostty.org/docs/config/reference.html#undo-timeout)
* [quick-terminal-position](https://ghostty.org/docs/config/reference.html#quick-terminal-position)
* [quick-terminal-size](https://ghostty.org/docs/config/reference.html#quick-terminal-size)
* [gtk-quick-terminal-layer](https://ghostty.org/docs/config/reference.html#gtk-quick-terminal-layer)
* [gtk-quick-terminal-namespace](https://ghostty.org/docs/config/reference.html#gtk-quick-terminal-namespace)
* [quick-terminal-screen](https://ghostty.org/docs/config/reference.html#quick-terminal-screen)
* [quick-terminal-animation-duration](https://ghostty.org/docs/config/reference.html#quick-terminal-animation-duration)
* [quick-terminal-autohide](https://ghostty.org/docs/config/reference.html#quick-terminal-autohide)
* [quick-terminal-space-behavior](https://ghostty.org/docs/config/reference.html#quick-terminal-space-behavior)
* [quick-terminal-keyboard-interactivity](https://ghostty.org/docs/config/reference.html#quick-terminal-keyboard-interactivity)
* [shell-integration](https://ghostty.org/docs/config/reference.html#shell-integration)
* [shell-integration-features](https://ghostty.org/docs/config/reference.html#shell-integration-features)
* [command-palette-entry](https://ghostty.org/docs/config/reference.html#command-palette-entry)
* [osc-color-report-format](https://ghostty.org/docs/config/reference.html#osc-color-report-format)
* [vt-kam-allowed](https://ghostty.org/docs/config/reference.html#vt-kam-allowed)
* [custom-shader](https://ghostty.org/docs/config/reference.html#custom-shader)
* [custom-shader-animation](https://ghostty.org/docs/config/reference.html#custom-shader-animation)
* [bell-features](https://ghostty.org/docs/config/reference.html#bell-features)
* [bell-audio-path](https://ghostty.org/docs/config/reference.html#bell-audio-path)
* [bell-audio-volume](https://ghostty.org/docs/config/reference.html#bell-audio-volume)
* [app-notifications](https://ghostty.org/docs/config/reference.html#app-notifications)
* [macos-non-native-fullscreen](https://ghostty.org/docs/config/reference.html#macos-non-native-fullscreen)
* [macos-window-buttons](https://ghostty.org/docs/config/reference.html#macos-window-buttons)
* [macos-titlebar-style](https://ghostty.org/docs/config/reference.html#macos-titlebar-style)
* [macos-titlebar-proxy-icon](https://ghostty.org/docs/config/reference.html#macos-titlebar-proxy-icon)
* [macos-dock-drop-behavior](https://ghostty.org/docs/config/reference.html#macos-dock-drop-behavior)
* [macos-option-as-alt](https://ghostty.org/docs/config/reference.html#macos-option-as-alt)
* [macos-window-shadow](https://ghostty.org/docs/config/reference.html#macos-window-shadow)
* [macos-hidden](https://ghostty.org/docs/config/reference.html#macos-hidden)
* [macos-auto-secure-input](https://ghostty.org/docs/config/reference.html#macos-auto-secure-input)
* [macos-secure-input-indication](https://ghostty.org/docs/config/reference.html#macos-secure-input-indication)
* [macos-applescript](https://ghostty.org/docs/config/reference.html#macos-applescript)
* [macos-icon](https://ghostty.org/docs/config/reference.html#macos-icon)
* [macos-custom-icon](https://ghostty.org/docs/config/reference.html#macos-custom-icon)
* [macos-icon-frame](https://ghostty.org/docs/config/reference.html#macos-icon-frame)
* [macos-icon-ghost-color](https://ghostty.org/docs/config/reference.html#macos-icon-ghost-color)
* [macos-icon-screen-color](https://ghostty.org/docs/config/reference.html#macos-icon-screen-color)
* [macos-shortcuts](https://ghostty.org/docs/config/reference.html#macos-shortcuts)
* [linux-cgroup](https://ghostty.org/docs/config/reference.html#linux-cgroup)
* [linux-cgroup-memory-limit](https://ghostty.org/docs/config/reference.html#linux-cgroup-memory-limit)
* [linux-cgroup-processes-limit](https://ghostty.org/docs/config/reference.html#linux-cgroup-processes-limit)
* [linux-cgroup-hard-fail](https://ghostty.org/docs/config/reference.html#linux-cgroup-hard-fail)
* [gtk-opengl-debug](https://ghostty.org/docs/config/reference.html#gtk-opengl-debug)
* [gtk-single-instance](https://ghostty.org/docs/config/reference.html#gtk-single-instance)
* [gtk-titlebar](https://ghostty.org/docs/config/reference.html#gtk-titlebar)
* [gtk-tabs-location](https://ghostty.org/docs/config/reference.html#gtk-tabs-location)
* [gtk-titlebar-hide-when-maximized](https://ghostty.org/docs/config/reference.html#gtk-titlebar-hide-when-maximized)
* [gtk-toolbar-style](https://ghostty.org/docs/config/reference.html#gtk-toolbar-style)
* [gtk-titlebar-style](https://ghostty.org/docs/config/reference.html#gtk-titlebar-style)
* [gtk-wide-tabs](https://ghostty.org/docs/config/reference.html#gtk-wide-tabs)
* [gtk-custom-css](https://ghostty.org/docs/config/reference.html#gtk-custom-css)
* [desktop-notifications](https://ghostty.org/docs/config/reference.html#desktop-notifications)
* [progress-style](https://ghostty.org/docs/config/reference.html#progress-style)
* [bold-color](https://ghostty.org/docs/config/reference.html#bold-color)
* [faint-opacity](https://ghostty.org/docs/config/reference.html#faint-opacity)
* [term](https://ghostty.org/docs/config/reference.html#term)
* [enquiry-response](https://ghostty.org/docs/config/reference.html#enquiry-response)
* [async-backend](https://ghostty.org/docs/config/reference.html#async-backend)
* [auto-update](https://ghostty.org/docs/config/reference.html#auto-update)
* [auto-update-channel](https://ghostty.org/docs/config/reference.html#auto-update-channel)
