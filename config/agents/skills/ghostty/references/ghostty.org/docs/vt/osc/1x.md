...
source_url: "https://ghostty.org/docs/vt/osc/1x"
...
* OSC
* [Query or Change Dynamic Colors (OSC 10–19)](https://ghostty.org/docs/vt/osc/1x.html)
...
[dynamic color](https://ghostty.org/docs/vt/concepts/colors.html#dynamic-colors) corresponding to `n` depending on the value of `c`.
...
the [color specification](https://ghostty.org/docs/vt/concepts/colors.html#color-specifications) of the dynamic color at index `n`. If `c` is a valid
