...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/time/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/time/index.html#description)

The Time widget shows the current time with optional seconds and day‑progress indicator.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/time/index.html#available-settings)

* `Show icon`: Show or hide the time icon. **Default is true**.
* `12‑hour format`: Use 12‑hour time. **Default is false**.
* `Show seconds`: Display seconds. **Default is false**.
* `Show day progress`: Display day progress indicator. **Default is false**.
* `Background color`: Theme color for the widget background. **Default is "yellow"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 1**.
...
[DatePrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/date/index.html)[Wi‑FiNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index.html)
