...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/cpu/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/cpu/index.html#description)

The CPU widget displays usage with a small graph and percentage.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/cpu/index.html#interactions)

* Click to open Activity Monitor.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/cpu/index.html#available-settings)

* `Show icon`: Show or hide the CPU icon. **Default is true**.
* `Monitor app`: App opened on click (None, Activity Monitor, Top). **Default is "Activity Monitor"**.
* `Graph color`: Theme color used for the graph. **Default is "yellow"**.
...
[Hacker NewsPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/hacker-news/index.html)[MemoryNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/memory/index.html)
