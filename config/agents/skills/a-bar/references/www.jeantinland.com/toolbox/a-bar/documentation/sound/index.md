...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/sound/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/sound/index.html#description)

The Sound widget shows the current system volume and provides a quick volume popover.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/sound/index.html#interactions)

* Click to open the volume popover.
* Right‑click to refresh the widget.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/sound/index.html#available-settings)

* `Show icon`: Show or hide the sound icon. **Default is true**.
* `Background color`: Theme color for the widget background. **Default is "blue"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 2**.
...
[Wi‑FiPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/wifi/index.html)[MicrophoneNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/microphone/index.html)
