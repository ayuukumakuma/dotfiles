...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index"
...
## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index.html#description)

The Weather widget fetches current conditions using Open‑Meteo, using IP geolocation by default or a custom location.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index.html#interactions)

* Right‑click to refresh instantly.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/weather/index.html#available-settings)

* `Show icon`: Show or hide the weather icon. **Default is true**.
* `Hide location`: Hide location label. **Default is true**.
* `Custom location`: City or ZIP code. **Default is ""** (auto).
* `Temperature unit`: Celsius or Fahrenheit. **Default is "C"**.
* `Refresh interval`: Refresh cadence in seconds. **Default is 1800**.
...
[BatteryPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/battery/index.html)[DateNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/date/index.html)
