...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/features/index"
...
* **yabai integration**: show spaces and windows, switch spaces, manage spaces from the bar.
* **AeroSpace integration**: show workspaces and windows, switch workspaces from the bar.
* **System information widgets**: battery, weather, time, date, Wi‑Fi, sound, microphone, keyboard, GitHub notifications.
* **Performance graphs**: CPU, memory, GPU, network stats, disk activity, storage usage.
* **Themes**: built-in Day Shift and Night Shift themes with color overrides.
* **Custom widgets**: run shell commands, click actions, custom icons, optional background color.
* **Multiple profiles**: save and switch layouts for different workflows.
* **Layout builder**: configure multiple displays and top/bottom bars with drag-and-drop widgets.
* **Automation** with AppleScript:
  + switch profile, list profiles or show current profile.
  + refresh, toggle, show/hide specific custom widgets.
  + refresh yabai spaces and processes widgets.
  + refresh AeroSpace workspaces and windows.
...
[IntroductionPrevious article](https://www.jeantinland.com/toolbox/a-bar/documentation/introduction/index.html)[InstallationNext article](https://www.jeantinland.com/toolbox/a-bar/documentation/installation/index.html)
