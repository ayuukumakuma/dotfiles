...
source_url: "https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-spaces/index"
...
> Published on Mon, Feb 9, 2026> Updated on Mon, Feb 9, 2026

## Description [#](https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-spaces/index.html#description)

The Spaces (AeroSpace) widget displays your AeroSpace workspaces and the apps running in each workspace. Workspaces are grouped by monitor.

**Note:** This widget requires **AeroSpace** as the active window manager. If you use yabai, see [Spaces (yabai)](https://www.jeantinland.com/toolbox/a-bar/documentation/spaces/index.html) instead.

## Interactions [#](https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-spaces/index.html#interactions)

* Click a workspace to focus it.

## Available settings [#](https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-spaces/index.html#available-settings)

* `Hide empty spaces`: Hide empty, non-visible workspaces. **Default is false**.
* `Hide duplicate apps`: Hide duplicate app icons within a workspace. **Default is true**.
* `Excluded spaces`: Comma-separated workspace names to hide. **Default is ""**.
* `Title exclusions`: Comma-separated window title patterns to ignore. **Default is ""**.
* `Use regex for exclusions`: Interpret exclusions as regex patterns. **Default is false**.
...
[Process (yabai)Previous article](https://www.jeantinland.com/toolbox/a-bar/documentation/process/index.html)[Process (AeroSpace)Next article](https://www.jeantinland.com/toolbox/a-bar/documentation/aerospace-process/index.html)
