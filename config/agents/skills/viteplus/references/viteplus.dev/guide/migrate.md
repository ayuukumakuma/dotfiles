---
title: "Migrate to Vite+ | The Unified Toolchain for the Web"
source_url: "https://viteplus.dev/guide/migrate"
fetched_at: "2026-03-31T02:50:28.336963+00:00"
---



# Migrate to Vite+ [​](https://viteplus.dev/guide/migrate.html#migrate-to-vite)

`vp migrate` helps move existing projects onto Vite+.

## Overview [​](https://viteplus.dev/guide/migrate.html#overview)
...
## Usage [​](https://viteplus.dev/guide/migrate.html#usage)
...
## Target Path [​](https://viteplus.dev/guide/migrate.html#target-path)
...
## Options [​](https://viteplus.dev/guide/migrate.html#options)
...
## Migration Flow [​](https://viteplus.dev/guide/migrate.html#migration-flow)
...
## Recommended Workflow [​](https://viteplus.dev/guide/migrate.html#recommended-workflow)
...
## Migration Prompt [​](https://viteplus.dev/guide/migrate.html#migration-prompt)
...
## Tool-Specific Migrations [​](https://viteplus.dev/guide/migrate.html#tool-specific-migrations)

### Vitest [​](https://viteplus.dev/guide/migrate.html#vitest)
...
### tsdown [​](https://viteplus.dev/guide/migrate.html#tsdown)
...
After merging, delete `tsdown.config.ts`. See the [Pack guide](https://viteplus.dev/guide/pack.html) for the full configuration reference.

### lint-staged [​](https://viteplus.dev/guide/migrate.html#lint-staged)
...
After migrating, remove lint-staged from your dependencies and delete any lint-staged config files. See the [Commit hooks guide](https://viteplus.dev/guide/commit-hooks.html) and [Staged config reference](https://viteplus.dev/config/staged.html) for details.

## Examples [​](https://viteplus.dev/guide/migrate.html#examples)
