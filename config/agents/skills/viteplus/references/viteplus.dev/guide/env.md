---
title: "Environment | The Unified Toolchain for the Web"
source_url: "https://viteplus.dev/guide/env"
fetched_at: "2026-03-31T02:50:28.336963+00:00"
---



# Environment [​](https://viteplus.dev/guide/env.html#environment)

`vp env` manages Node.js versions globally and per project.

## Overview [​](https://viteplus.dev/guide/env.html#overview)
...
## Commands [​](https://viteplus.dev/guide/env.html#commands)

### Setup [​](https://viteplus.dev/guide/env.html#setup)
...
### Manage [​](https://viteplus.dev/guide/env.html#manage)
...
### Inspect [​](https://viteplus.dev/guide/env.html#inspect)
...
## Project Setup [​](https://viteplus.dev/guide/env.html#project-setup)
...
## Examples [​](https://viteplus.dev/guide/env.html#examples)
