---
title: "📂 Structuring Your Plugins | lazy.nvim"
source_url: "https://lazy.folke.io/usage/structuring"
...
### ↩️ Importing Specs, `config` & `opts`[​](https://lazy.folke.io/usage/structuring.html#️-importing-specs-config--opts "Direct link to ️-importing-specs-config--opts")
...
⚡ Profiling & Debug](https://lazy.folke.io/usage/profiling.html)[Next

🔥 Developers](https://lazy.folke.io/developers.html)

* [↩️ Importing Specs, `config` & `opts`](https://lazy.folke.io/usage/structuring.html#️-importing-specs-config--opts)
