---
title: "Models | AI Models and Pricing - Zed"
source_url: "https://zed.dev/docs/ai/models"
...
Zed's plans offer hosted versions of major LLMs with higher rate limits than direct API access. Model availability is updated regularly. To use your own API keys instead, see [LLM Providers](https://zed.dev/docs/ai/llm-providers.html). For general setup, see [Configuration](https://zed.dev/docs/ai/configuration.html).
...
## [Recent Model Retirements](https://zed.dev/docs/ai/models.html#recent-model-retirements)
...
## [Usage](https://zed.dev/docs/ai/models.html#usage)

Any usage of a Zed-hosted model will be billed at the Zed Price (rightmost column above). See [Plans and Usage](https://zed.dev/docs/ai/plans-and-usage.html) for details on Zed's plans and limits for use of hosted models.

> LLMs can enter unproductive loops that require user intervention. Monitor longer-running tasks and interrupt if needed.

## [Context Windows](https://zed.dev/docs/ai/models.html#context-windows)
...
## [Tool Calls](https://zed.dev/docs/ai/models.html#tool-calls)

Models can use [tools](https://zed.dev/docs/ai/tools.html) to interface with your code, search the web, and perform other useful functions.
