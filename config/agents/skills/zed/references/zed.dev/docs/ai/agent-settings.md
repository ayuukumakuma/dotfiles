---
title: "Agent Settings | AI Agent Settings - Zed"
source_url: "https://zed.dev/docs/ai/agent-settings"
...
## [Model Settings](https://zed.dev/docs/ai/agent-settings.html#model-settings)

### [Default Model](https://zed.dev/docs/ai/agent-settings.html#default-model)

If you're using [Zed's hosted LLM service](https://zed.dev/docs/ai/subscription.html), it sets `claude-sonnet-4-5` as the default model for agentic work (agent panel, inline assistant) and `gpt-5-nano` as the default "fast" model (thread summarization, git commit messages). If you're not subscribed or want to change these defaults, you can manually edit the `default_model` object in your settings:
...
### [Feature-specific Models](https://zed.dev/docs/ai/agent-settings.html#feature-specific-models)
...
### [Alternative Models for Inline Assists](https://zed.dev/docs/ai/agent-settings.html#alternative-assists)
...
The models you specify here are always used in *addition* to your [default model](https://zed.dev/docs/ai/agent-settings.html#default-model).
...
### [Model Temperature](https://zed.dev/docs/ai/agent-settings.html#model-temperature)
...
## [Agent Panel Settings](https://zed.dev/docs/ai/agent-settings.html#agent-panel-settings)
...
### [Default View](https://zed.dev/docs/ai/agent-settings.html#default-view)
...
### [Font Size](https://zed.dev/docs/ai/agent-settings.html#font-size)
...
### [Default Tool Permissions](https://zed.dev/docs/ai/agent-settings.html#default-tool-permissions)
...
### [Per-tool Permission Rules](https://zed.dev/docs/ai/agent-settings.html#per-tool-permission-rules)
...
#### [Pattern Precedence](https://zed.dev/docs/ai/agent-settings.html#pattern-precedence)
...
#### [Case Sensitivity](https://zed.dev/docs/ai/agent-settings.html#case-sensitivity)
...
#### [`copy_path` and `move_path` Patterns](https://zed.dev/docs/ai/agent-settings.html#copy_path-and-move_path-patterns)
...
#### [MCP Tool Permissions](https://zed.dev/docs/ai/agent-settings.html#mcp-tool-permissions)
...
See the [Tool Permissions](https://zed.dev/docs/ai/tool-permissions.html) documentation for more examples and complete details.
...
### [Edit Display Mode](https://zed.dev/docs/ai/agent-settings.html#edit-display-mode)
...
### [Sound Notification](https://zed.dev/docs/ai/agent-settings.html#sound-notification)
...
### [Message Editor Size](https://zed.dev/docs/ai/agent-settings.html#message-editor-size)
...
### [Modifier to Send](https://zed.dev/docs/ai/agent-settings.html#modifier-to-send)
...
### [Edit Card](https://zed.dev/docs/ai/agent-settings.html#edit-card)
...
### [Terminal Card](https://zed.dev/docs/ai/agent-settings.html#terminal-card)
...
### [Feedback Controls](https://zed.dev/docs/ai/agent-settings.html#feedback-controls)
