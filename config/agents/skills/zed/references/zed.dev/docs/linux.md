---
title: "Linux | Zed on Linux"
source_url: "https://zed.dev/docs/linux"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Zed on Linux](https://zed.dev/docs/linux.html#zed-on-linux)

## [Standard Installation](https://zed.dev/docs/linux.html#standard-installation)
...
* have a system-wide glibc (NixOS and Alpine do not by default)
  + x86\_64 (Intel/AMD): glibc version >= 2.31 (Ubuntu 20 and newer)
...
* Redhat Enterprise Linux 9.x, Rocky Linux 9.3, AlmaLinux 8, Amazon Linux 2023 on aarch64 (x86\_x64 OK)

## [Other ways to install Zed on Linux](https://zed.dev/docs/linux.html#other-ways-to-install-zed-on-linux)

Zed is open source, and [you can install from source](https://zed.dev/docs/development/linux.html).

### [Installing via a package manager](https://zed.dev/docs/linux.html#installing-via-a-package-manager)
...
* Alpine: `zed` ([aarch64](https://pkgs.alpinelinux.org/package/edge/testing/aarch64/zed)) ([x86\_64](https://pkgs.alpinelinux.org/package/edge/testing/x86_64/zed))
...
### [Community](https://zed.dev/docs/linux.html#community)
...
#### [Debian and Ubuntu](https://zed.dev/docs/linux.html#debian-and-ubuntu)
...
### [Downloading manually](https://zed.dev/docs/linux.html#downloading-manually)
...
* [zed-linux-x86\_64.tar.gz](https://cloud.zed.dev/releases/stable/latest/download?asset=zed&arch=x86_64&os=linux&source=docs)
...
## [Uninstalling Zed](https://zed.dev/docs/linux.html#uninstalling-zed)

### [Standard Uninstall](https://zed.dev/docs/linux.html#standard-uninstall)
...
### [Package Manager](https://zed.dev/docs/linux.html#package-manager)
...
## [Troubleshooting](https://zed.dev/docs/linux.html#troubleshooting)
...
### [Zed fails to start](https://zed.dev/docs/linux.html#zed-fails-to-start)

If you see an error like "/lib64/libc.so.6: version 'GLIBC\_2.29' not found" it means that your distribution's version of glibc is too old. You can either upgrade your system, or [install Zed from source](https://zed.dev/docs/development/linux.html).

### [Graphics issues](https://zed.dev/docs/linux.html#graphics-issues)

#### [Zed fails to open windows](https://zed.dev/docs/linux.html#zed-fails-to-open-windows)
...
#### [Forcing Zed to use a specific GPU](https://zed.dev/docs/linux.html#forcing-zed-to-use-a-specific-gpu)

There are a few different ways to force Zed to use a specific GPU:

##### [Option A](https://zed.dev/docs/linux.html#option-a)
...
##### [Option B](https://zed.dev/docs/linux.html#option-b)
...
##### [Option C](https://zed.dev/docs/linux.html#option-c)

Using [vkdevicechooser](https://github.com/jiriks74/vkdevicechooser).

#### [Reporting graphics issues](https://zed.dev/docs/linux.html#reporting-graphics-issues)
...
### [I can't open any files](https://zed.dev/docs/linux.html#i-cant-open-any-files)

### [Clicking links isn't working](https://zed.dev/docs/linux.html#clicking-links-isnt-working)
...
### [Zed isn't remembering my API keys](https://zed.dev/docs/linux.html#zed-isnt-remembering-my-api-keys)

### [Zed isn't remembering my login](https://zed.dev/docs/linux.html#zed-isnt-remembering-my-login)
...
### [Could not start inotify](https://zed.dev/docs/linux.html#could-not-start-inotify)
...
* You should see that max\_user\_instances is 128 or higher (you can change the limit with `sudo sysctl fs.inotify.max_user_instances=1024`). Zed needs only 1 inotify instance.
...
### [No sound or wrong output device](https://zed.dev/docs/linux.html#no-sound-or-wrong-output-device)
...
### [Forcing X11 scale factor](https://zed.dev/docs/linux.html#forcing-x11-scale-factor)
...
#### [Check your current scale factor](https://zed.dev/docs/linux.html#check-your-current-scale-factor)
...
#### [Option 1: Set Xft.dpi (X Resources Database)](https://zed.dev/docs/linux.html#option-1-set-xftdpi-x-resources-database)
...
#### [Option 2: Use the GPUI\_X11\_SCALE\_FACTOR environment variable](https://zed.dev/docs/linux.html#option-2-use-the-gpui_x11_scale_factor-environment-variable)
...
#### [Option 3: Adjust system-wide RandR DPI](https://zed.dev/docs/linux.html#option-3-adjust-system-wide-randr-dpi)
...
### [Font rendering parameters](https://zed.dev/docs/linux.html#font-rendering-parameters)
