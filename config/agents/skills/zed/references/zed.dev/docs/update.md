---
title: "Update | Update Zed"
source_url: "https://zed.dev/docs/update"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Update Zed](https://zed.dev/docs/update.html#update-zed)

Zed is designed to keep itself up to date automatically. You can always update this behavior in your settings.

## [Auto-updates](https://zed.dev/docs/update.html#auto-updates)
...
## [How to check your current version](https://zed.dev/docs/update.html#how-to-check-your-current-version)
...
## [How to control update behavior](https://zed.dev/docs/update.html#how-to-control-update-behavior)
