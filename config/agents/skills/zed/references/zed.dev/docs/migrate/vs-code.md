...
source_url: "https://zed.dev/docs/migrate/vs-code"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [How to Migrate from VS Code to Zed](https://zed.dev/docs/migrate/vs-code.html#how-to-migrate-from-vs-code-to-zed)
...
## [Install Zed](https://zed.dev/docs/migrate/vs-code.html#install-zed)
...
## [Import Settings from VS Code](https://zed.dev/docs/migrate/vs-code.html#import-settings-from-vs-code)

During setup, you have the option to import key settings from VS Code. Zed imports the following settings:

### [Settings Imported from VS Code](https://zed.dev/docs/migrate/vs-code.html#settings-imported-from-vs-code)
...
## [Set Up Editor Preferences](https://zed.dev/docs/migrate/vs-code.html#set-up-editor-preferences)
...
| VS Code | Zed | Notes |
| --- | --- | --- |
| editor.fontFamily | buffer\_font\_family | Zed uses Zed Mono by default |
| editor.fontSize | buffer\_font\_size | Set in pixels |
| editor.tabSize | tab\_size | Can override per language |
| editor.insertSpaces | insert\_spaces | Boolean |
| editor.formatOnSave | format\_on\_save | Works with formatter enabled |
| editor.wordWrap | soft\_wrap | Supports optional wrap column |

Zed also supports per-project settings. You can find these in the Settings Editor as well.

## [Open or Create a Project](https://zed.dev/docs/migrate/vs-code.html#open-or-create-a-project)
...
## [Differences in Keybindings](https://zed.dev/docs/migrate/vs-code.html#differences-in-keybindings)
...
### [Common Shared Keybindings (Zed <> VS Code)](https://zed.dev/docs/migrate/vs-code.html#common-shared-keybindings-zed--vs-code)
...
### [Different Keybindings (Zed <> VS Code)](https://zed.dev/docs/migrate/vs-code.html#different-keybindings-zed--vs-code)
...
### [Unique to Zed](https://zed.dev/docs/migrate/vs-code.html#unique-to-zed)
...
### [How to Customize Keybindings](https://zed.dev/docs/migrate/vs-code.html#how-to-customize-keybindings)
...
## [Differences in User Interfaces](https://zed.dev/docs/migrate/vs-code.html#differences-in-user-interfaces)

### [No Workspace](https://zed.dev/docs/migrate/vs-code.html#no-workspace)
...
### [Navigating in a Project](https://zed.dev/docs/migrate/vs-code.html#navigating-in-a-project)
...
### [Extensions vs. Marketplace](https://zed.dev/docs/migrate/vs-code.html#extensions-vs-marketplace)
...
### [Collaboration in Zed vs. VS Code](https://zed.dev/docs/migrate/vs-code.html#collaboration-in-zed-vs-vs-code)
...
### [Using AI in Zed](https://zed.dev/docs/migrate/vs-code.html#using-ai-in-zed)
...
#### [Configuring GitHub Copilot](https://zed.dev/docs/migrate/vs-code.html#configuring-github-copilot)
...
#### [Additional AI Options](https://zed.dev/docs/migrate/vs-code.html#additional-ai-options)
...
### [Advanced Config and Productivity Tweaks](https://zed.dev/docs/migrate/vs-code.html#advanced-config-and-productivity-tweaks)
