---
title: "IntelliJ IDEA | How to Migrate from IntelliJ IDEA to Zed"
source_url: "https://zed.dev/docs/migrate/intellij"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [How to Migrate from IntelliJ IDEA to Zed](https://zed.dev/docs/migrate/intellij.html#how-to-migrate-from-intellij-idea-to-zed)
...
## [Install Zed](https://zed.dev/docs/migrate/intellij.html#install-zed)
...
## [Set Up the JetBrains Keymap](https://zed.dev/docs/migrate/intellij.html#set-up-the-jetbrains-keymap)
...
## [Set Up Editor Preferences](https://zed.dev/docs/migrate/intellij.html#set-up-editor-preferences)
...
## [Open or Create a Project](https://zed.dev/docs/migrate/intellij.html#open-or-create-a-project)
...
## [Differences in Keybindings](https://zed.dev/docs/migrate/intellij.html#differences-in-keybindings)
...
### [Common Shared Keybindings (Zed with JetBrains keymap ↔ IntelliJ)](https://zed.dev/docs/migrate/intellij.html#common-shared-keybindings-zed-with-jetbrains-keymap--intellij)
...
### [Different Keybindings (IntelliJ → Zed)](https://zed.dev/docs/migrate/intellij.html#different-keybindings-intellij--zed)
...
### [Unique to Zed](https://zed.dev/docs/migrate/intellij.html#unique-to-zed)
...
### [How to Customize Keybindings](https://zed.dev/docs/migrate/intellij.html#how-to-customize-keybindings)
...
## [Differences in User Interfaces](https://zed.dev/docs/migrate/intellij.html#differences-in-user-interfaces)

### [No Indexing](https://zed.dev/docs/migrate/intellij.html#no-indexing)
...
### [LSP vs. Native Language Intelligence](https://zed.dev/docs/migrate/intellij.html#lsp-vs-native-language-intelligence)
...
### [No Project Model](https://zed.dev/docs/migrate/intellij.html#no-project-model)
...
### [No Framework Integration](https://zed.dev/docs/migrate/intellij.html#no-framework-integration)
...
### [Tool Windows vs. Docks](https://zed.dev/docs/migrate/intellij.html#tool-windows-vs-docks)
...
### [Debugging](https://zed.dev/docs/migrate/intellij.html#debugging)
...
### [Extensions vs. Plugins](https://zed.dev/docs/migrate/intellij.html#extensions-vs-plugins)
...
## [Collaboration in Zed vs. IntelliJ](https://zed.dev/docs/migrate/intellij.html#collaboration-in-zed-vs-intellij)
...
## [Using AI in Zed](https://zed.dev/docs/migrate/intellij.html#using-ai-in-zed)
...
### [Configuring GitHub Copilot](https://zed.dev/docs/migrate/intellij.html#configuring-github-copilot)
...
### [Additional AI Options](https://zed.dev/docs/migrate/intellij.html#additional-ai-options)
...
## [Advanced Config and Productivity Tweaks](https://zed.dev/docs/migrate/intellij.html#advanced-config-and-productivity-tweaks)
...
## [Next Steps](https://zed.dev/docs/migrate/intellij.html#next-steps)
...
* [Languages](https://zed.dev/docs/languages.html) — Language-specific setup guides, including Java and Kotlin
