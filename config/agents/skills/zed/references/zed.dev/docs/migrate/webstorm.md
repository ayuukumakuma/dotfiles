---
title: "WebStorm | How to Migrate from WebStorm to Zed"
source_url: "https://zed.dev/docs/migrate/webstorm"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [How to Migrate from WebStorm to Zed](https://zed.dev/docs/migrate/webstorm.html#how-to-migrate-from-webstorm-to-zed)
...
## [Install Zed](https://zed.dev/docs/migrate/webstorm.html#install-zed)
...
## [Set Up the JetBrains Keymap](https://zed.dev/docs/migrate/webstorm.html#set-up-the-jetbrains-keymap)
...
## [Set Up Editor Preferences](https://zed.dev/docs/migrate/webstorm.html#set-up-editor-preferences)
...
## [Open or Create a Project](https://zed.dev/docs/migrate/webstorm.html#open-or-create-a-project)
...
## [Differences in Keybindings](https://zed.dev/docs/migrate/webstorm.html#differences-in-keybindings)
...
### [Common Shared Keybindings](https://zed.dev/docs/migrate/webstorm.html#common-shared-keybindings)
...
### [Different Keybindings (WebStorm → Zed)](https://zed.dev/docs/migrate/webstorm.html#different-keybindings-webstorm--zed)
...
### [Unique to Zed](https://zed.dev/docs/migrate/webstorm.html#unique-to-zed)
...
### [How to Customize Keybindings](https://zed.dev/docs/migrate/webstorm.html#how-to-customize-keybindings)
...
## [Differences in User Interfaces](https://zed.dev/docs/migrate/webstorm.html#differences-in-user-interfaces)

### [No Indexing](https://zed.dev/docs/migrate/webstorm.html#no-indexing)
...
### [LSP vs. Native Language Intelligence](https://zed.dev/docs/migrate/webstorm.html#lsp-vs-native-language-intelligence)
...
### [No Project Model](https://zed.dev/docs/migrate/webstorm.html#no-project-model)
...
### [No Framework Integration](https://zed.dev/docs/migrate/webstorm.html#no-framework-integration)
...
### [Tool Windows vs. Docks](https://zed.dev/docs/migrate/webstorm.html#tool-windows-vs-docks)
...
### [Debugging](https://zed.dev/docs/migrate/webstorm.html#debugging)
...
### [Running Tests](https://zed.dev/docs/migrate/webstorm.html#running-tests)
...
### [Extensions vs. Plugins](https://zed.dev/docs/migrate/webstorm.html#extensions-vs-plugins)
...
### [What's Not in Zed](https://zed.dev/docs/migrate/webstorm.html#whats-not-in-zed)
...
## [Collaboration in Zed vs. WebStorm](https://zed.dev/docs/migrate/webstorm.html#collaboration-in-zed-vs-webstorm)
...
## [Using AI in Zed](https://zed.dev/docs/migrate/webstorm.html#using-ai-in-zed)
...
### [Configuring GitHub Copilot](https://zed.dev/docs/migrate/webstorm.html#configuring-github-copilot)
...
### [Additional AI Options](https://zed.dev/docs/migrate/webstorm.html#additional-ai-options)
...
## [Advanced Config and Productivity Tweaks](https://zed.dev/docs/migrate/webstorm.html#advanced-config-and-productivity-tweaks)
...
## [Next Steps](https://zed.dev/docs/migrate/webstorm.html#next-steps)
...
* [JavaScript in Zed](https://zed.dev/docs/languages/javascript.html) — JavaScript-specific setup and configuration
* [TypeScript in Zed](https://zed.dev/docs/languages/typescript.html) — TypeScript-specific setup and configuration

[PyCharm](https://zed.dev/docs/migrate/pycharm.html "PyCharm")
