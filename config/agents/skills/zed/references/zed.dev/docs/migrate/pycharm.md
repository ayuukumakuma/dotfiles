---
title: "PyCharm | How to Migrate from PyCharm to Zed"
source_url: "https://zed.dev/docs/migrate/pycharm"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [How to Migrate from PyCharm to Zed](https://zed.dev/docs/migrate/pycharm.html#how-to-migrate-from-pycharm-to-zed)
...
## [Install Zed](https://zed.dev/docs/migrate/pycharm.html#install-zed)
...
## [Set Up the JetBrains Keymap](https://zed.dev/docs/migrate/pycharm.html#set-up-the-jetbrains-keymap)
...
## [Set Up Editor Preferences](https://zed.dev/docs/migrate/pycharm.html#set-up-editor-preferences)
...
## [Open or Create a Project](https://zed.dev/docs/migrate/pycharm.html#open-or-create-a-project)
...
## [Differences in Keybindings](https://zed.dev/docs/migrate/pycharm.html#differences-in-keybindings)
...
### [Common Shared Keybindings](https://zed.dev/docs/migrate/pycharm.html#common-shared-keybindings)
...
### [Different Keybindings (PyCharm → Zed)](https://zed.dev/docs/migrate/pycharm.html#different-keybindings-pycharm--zed)
...
### [Unique to Zed](https://zed.dev/docs/migrate/pycharm.html#unique-to-zed)
...
### [How to Customize Keybindings](https://zed.dev/docs/migrate/pycharm.html#how-to-customize-keybindings)
...
## [Differences in User Interfaces](https://zed.dev/docs/migrate/pycharm.html#differences-in-user-interfaces)

### [No Indexing](https://zed.dev/docs/migrate/pycharm.html#no-indexing)
...
### [LSP vs. Native Language Intelligence](https://zed.dev/docs/migrate/pycharm.html#lsp-vs-native-language-intelligence)
...
### [Virtual Environments and Interpreters](https://zed.dev/docs/migrate/pycharm.html#virtual-environments-and-interpreters)
...
### [No Project Model](https://zed.dev/docs/migrate/pycharm.html#no-project-model)
...
### [No Framework Integration](https://zed.dev/docs/migrate/pycharm.html#no-framework-integration)
...
### [Tool Windows vs. Docks](https://zed.dev/docs/migrate/pycharm.html#tool-windows-vs-docks)
...
### [Debugging](https://zed.dev/docs/migrate/pycharm.html#debugging)
...
### [Running Tests](https://zed.dev/docs/migrate/pycharm.html#running-tests)
...
### [Extensions vs. Plugins](https://zed.dev/docs/migrate/pycharm.html#extensions-vs-plugins)
...
### [What's Not in Zed](https://zed.dev/docs/migrate/pycharm.html#whats-not-in-zed)
...
## [Collaboration in Zed vs. PyCharm](https://zed.dev/docs/migrate/pycharm.html#collaboration-in-zed-vs-pycharm)
...
## [Using AI in Zed](https://zed.dev/docs/migrate/pycharm.html#using-ai-in-zed)
...
### [Configuring GitHub Copilot](https://zed.dev/docs/migrate/pycharm.html#configuring-github-copilot)
...
### [Additional AI Options](https://zed.dev/docs/migrate/pycharm.html#additional-ai-options)
...
## [Advanced Config and Productivity Tweaks](https://zed.dev/docs/migrate/pycharm.html#advanced-config-and-productivity-tweaks)
...
## [Next Steps](https://zed.dev/docs/migrate/pycharm.html#next-steps)
...
* [Python in Zed](https://zed.dev/docs/languages/python.html) — Python-specific setup and configuration

[IntelliJ IDEA](https://zed.dev/docs/migrate/intellij.html "IntelliJ IDEA")
