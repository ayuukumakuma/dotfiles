---
title: "Fonts & Visual Tweaks | Visual Customization"
source_url: "https://zed.dev/docs/visual-customization"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Visual Customization](https://zed.dev/docs/visual-customization.html#visual-customization)

Various aspects of Zed's visual layout can be configured in the Settings Editor (`cmd-,|ctrl-,`) or in your settings file (`cmd-alt-,|ctrl-alt-,`).

See [All Settings](https://zed.dev/docs/reference/all-settings.html) for additional information and other non-visual settings.

## [Themes](https://zed.dev/docs/visual-customization.html#themes)

You can install many [themes](https://zed.dev/docs/themes.html) and [icon themes](https://zed.dev/docs/icon-themes.html) in form of extensions by running `zed: extensions` from the command palette.
...
## [Fonts](https://zed.dev/docs/visual-customization.html#fonts)
...
### [Font ligatures](https://zed.dev/docs/visual-customization.html#font-ligatures)
...
### [Status Bar](https://zed.dev/docs/visual-customization.html#status-bar)
...
### [Titlebar](https://zed.dev/docs/visual-customization.html#titlebar)
...
## [Workspace](https://zed.dev/docs/visual-customization.html#workspace)
...
## [Editor](https://zed.dev/docs/visual-customization.html#editor)
...
### [Git Blame](https://zed.dev/docs/visual-customization.html#editor-blame)
...
### [Editor Toolbar](https://zed.dev/docs/visual-customization.html#editor-toolbar)
...
### [Editor Scrollbar and Minimap](https://zed.dev/docs/visual-customization.html#editor-scrollbar)
...
### [Editor Tabs](https://zed.dev/docs/visual-customization.html#editor-tabs)
...
### [Status Bar](https://zed.dev/docs/visual-customization.html#status-bar-1)
...
### [Multibuffer](https://zed.dev/docs/visual-customization.html#multibuffer)
...
### [Editor Completions, Snippets, Actions, Diagnostics](https://zed.dev/docs/visual-customization.html#editor-lsp)
...
### [Edit Predictions](https://zed.dev/docs/visual-customization.html#editor-ai)
...
### [Editor Inlay Hints](https://zed.dev/docs/visual-customization.html#editor-inlay-hints)
...
## [File Finder](https://zed.dev/docs/visual-customization.html#file-finder)
...
## [Project Panel](https://zed.dev/docs/visual-customization.html#project-panel)
...
## [Agent Panel](https://zed.dev/docs/visual-customization.html#agent-panel)
...
See [Zed AI Documentation](https://zed.dev/docs/ai/overview.html) for additional non-visual AI settings.

## [Terminal Panel](https://zed.dev/docs/visual-customization.html#terminal-panel)
...
See [Terminal settings](https://zed.dev/docs/reference/all-settings.html#terminal) for additional non-visual customization options.

### [Other Panels](https://zed.dev/docs/visual-customization.html#other-panels)
...
## [Collaboration Panels](https://zed.dev/docs/visual-customization.html#collaboration-panels)
