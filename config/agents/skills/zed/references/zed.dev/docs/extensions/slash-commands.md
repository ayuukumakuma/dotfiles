---
title: "Slash Command Extensions | Slash Commands"
source_url: "https://zed.dev/docs/extensions/slash-commands"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Slash Commands](https://zed.dev/docs/extensions/slash-commands.html#slash-commands)

Extensions may provide slash commands for use in the Assistant.

## [Example extension](https://zed.dev/docs/extensions/slash-commands.html#example-extension)
...
This extension can be [installed as a dev extension](https://zed.dev/docs/extensions/developing-extensions.html#developing-an-extension-locally) if you want to try it out for yourself.

## [Defining slash commands](https://zed.dev/docs/extensions/slash-commands.html#defining-slash-commands)
...
## [Implementing slash command behavior](https://zed.dev/docs/extensions/slash-commands.html#implementing-slash-command-behavior)
...
## [Auto-completing slash command arguments](https://zed.dev/docs/extensions/slash-commands.html#auto-completing-slash-command-arguments)
