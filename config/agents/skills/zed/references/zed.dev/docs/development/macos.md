---
title: "macOS | Building Zed for macOS"
source_url: "https://zed.dev/docs/development/macos"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Building Zed for macOS](https://zed.dev/docs/development/macos.html#building-zed-for-macos)

## [Repository](https://zed.dev/docs/development/macos.html#repository)

Clone the [Zed repository](https://github.com/zed-industries/zed).

## [Dependencies](https://zed.dev/docs/development/macos.html#dependencies)
...
## [Building Zed from Source](https://zed.dev/docs/development/macos.html#building-zed-from-source)
...
## [Visual Regression Tests](https://zed.dev/docs/development/macos.html#visual-regression-tests)
...
### [Prerequisites](https://zed.dev/docs/development/macos.html#prerequisites)
...
### [Running Visual Tests](https://zed.dev/docs/development/macos.html#running-visual-tests)

```
cargo run -p zed --bin zed_visual_test_runner --features visual-tests
```

### [Baseline Images](https://zed.dev/docs/development/macos.html#baseline-images)
...
#### [Initial Setup](https://zed.dev/docs/development/macos.html#initial-setup)
...
#### [Updating Baselines](https://zed.dev/docs/development/macos.html#updating-baselines)
...
## [Troubleshooting](https://zed.dev/docs/development/macos.html#troubleshooting)

### [Error compiling metal shaders](https://zed.dev/docs/development/macos.html#error-compiling-metal-shaders)
...
### [Cargo errors claiming that a dependency is using unstable features](https://zed.dev/docs/development/macos.html#cargo-errors-claiming-that-a-dependency-is-using-unstable-features)

Try `cargo clean` and `cargo build`.

### [Error: 'dispatch/dispatch.h' file not found](https://zed.dev/docs/development/macos.html#error-dispatchdispatchh-file-not-found)
...
### [Tests failing due to `Too many open files (os error 24)`](https://zed.dev/docs/development/macos.html#tests-failing-due-to-too-many-open-files-os-error-24)
...
## [Tips & Tricks](https://zed.dev/docs/development/macos.html#tips--tricks)

### [Avoiding continual rebuilds](https://zed.dev/docs/development/macos.html#avoiding-continual-rebuilds)
...
### [Speeding up verification](https://zed.dev/docs/development/macos.html#speeding-up-verification)
...
[Linux](https://zed.dev/docs/development/linux.html "Linux")
