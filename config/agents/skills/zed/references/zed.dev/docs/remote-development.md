---
title: "Overview | Remote Development in Zed - SSH Workflows"
source_url: "https://zed.dev/docs/remote-development"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Remote Development](https://zed.dev/docs/remote-development.html#remote-development)
...
For day-to-day workflows, pair remote development with [Tasks](https://zed.dev/docs/tasks.html),
[Terminal](https://zed.dev/docs/terminal.html), and [Debugger](https://zed.dev/docs/debugger.html).
...
## [Setup](https://zed.dev/docs/remote-development.html#setup)

1. Download and install the latest [Zed](https://zed.dev/releases). You need at least Zed v0.159.
2. Use `ctrl-cmd-shift-o|alt-ctrl-shift-o` to open the "Remote Projects" dialog.
3. Click "Connect New Server" and enter the command you use to SSH into the server. See [Supported SSH options](https://zed.dev/docs/remote-development.html#supported-ssh-options) for options you can pass.
...
## [Supported platforms](https://zed.dev/docs/remote-development.html#supported-platforms)
...
* Linux (x86\_64 or arm64, we do not yet support 32-bit platforms)
* Windows is not yet supported as a remote server, but Windows can be used as a local machine to connect to remote servers.

## [Configuration](https://zed.dev/docs/remote-development.html#configuration)
...
## [Remote Development on Windows (SSH)](https://zed.dev/docs/remote-development.html#remote-development-on-windows-ssh)
...
### [Troubleshooting SSH on Windows](https://zed.dev/docs/remote-development.html#troubleshooting-ssh-on-windows)
...
## [WSL Support](https://zed.dev/docs/remote-development.html#wsl-support)

Zed supports opening folders inside of WSL natively on Windows.

### [Opening a local folder in WSL](https://zed.dev/docs/remote-development.html#opening-a-local-folder-in-wsl)
...
### [Opening a folder already in WSL](https://zed.dev/docs/remote-development.html#opening-a-folder-already-in-wsl)
...
## [Port forwarding](https://zed.dev/docs/remote-development.html#port-forwarding)
...
By default these ports are bound to localhost, so other computers in the same network as your development machine cannot access them. You can set the local\_host to bind to a different interface, for example, 0.0.0.0 will bind to all local interfaces.
...
## [Zed settings](https://zed.dev/docs/remote-development.html#zed-settings)
...
## [Proxy Configuration](https://zed.dev/docs/remote-development.html#proxy-configuration)
...
See the [proxy documentation](https://zed.dev/docs/reference/all-settings.html#network-proxy) for supported proxy types and additional configuration options.

## [Initializing the remote server](https://zed.dev/docs/remote-development.html#initializing-the-remote-server)
...
If you'd like to maintain the server binary yourself you can. You can either download our prebuilt versions from [GitHub](https://github.com/zed-industries/zed/releases), or [build your own](https://zed.dev/docs/development.html) with `cargo build -p remote_server --release`. If you do this, you must upload it to `~/.zed_server/zed-remote-server-{RELEASE_CHANNEL}-{VERSION}` on the server, for example `~/.zed_server/zed-remote-server-stable-0.217.3+stable.105.80433cb239e868271457ac376673a5f75bc4adb1`. The version must exactly match the version of Zed itself you are using.

## [Maintaining the SSH connection](https://zed.dev/docs/remote-development.html#maintaining-the-ssh-connection)
...
## [Supported SSH Options](https://zed.dev/docs/remote-development.html#supported-ssh-options)
...
## [Known Limitations](https://zed.dev/docs/remote-development.html#known-limitations)

* You can't open files from the remote Terminal by typing the `zed` command.

## [Feedback](https://zed.dev/docs/remote-development.html#feedback)

Please join the #remoting-feedback channel in the [Zed Discord](https://zed.dev/community-links).

## [See also](https://zed.dev/docs/remote-development.html#see-also)

* [Running & Testing](https://zed.dev/docs/running-testing.html): Run tasks, terminal commands, and
  debugger sessions while you work remotely.
* [Configuring Zed](https://zed.dev/docs/configuring-zed.html): Manage shared and project settings,
  including `.zed/settings.json`.
* [Agent Panel](https://zed.dev/docs/ai/agent-panel.html): Use AI workflows in remote projects.
* [Remote Development on zed.dev](https://zed.dev/remote-development): Product
  overview and release updates.

[Contacts and Private Calls](https://zed.dev/docs/collaboration/contacts-and-private-calls.html "Contacts and Private Calls")
