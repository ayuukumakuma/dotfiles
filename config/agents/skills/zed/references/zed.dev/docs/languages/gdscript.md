...
source_url: "https://zed.dev/docs/languages/gdscript"
...
Report issues to: <https://github.com/GDQuest/zed-gdscript/issues>
...
## [Pre-requisites](https://zed.dev/docs/languages/gdscript.html#pre-requisites)
...
## [Setup](https://zed.dev/docs/languages/gdscript.html#setup)
...
## [Usage](https://zed.dev/docs/languages/gdscript.html#usage)
...
[Gleam](https://zed.dev/docs/languages/gleam.html "Gleam")
