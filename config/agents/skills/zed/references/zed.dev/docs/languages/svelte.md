---
title: "Svelte | Svelte"
source_url: "https://zed.dev/docs/languages/svelte"
...
## [Extra theme styling configuration](https://zed.dev/docs/languages/svelte.html#extra-theme-styling-configuration)
...
## [Inlay Hints](https://zed.dev/docs/languages/svelte.html#inlay-hints)
...
## [Using the Tailwind CSS Language Server with Svelte](https://zed.dev/docs/languages/svelte.html#using-the-tailwind-css-language-server-with-svelte)
