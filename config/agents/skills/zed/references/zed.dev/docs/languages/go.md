---
title: "Go | Go"
source_url: "https://zed.dev/docs/languages/go"
fetched_at: "2026-03-05T02:24:06.365855+00:00"
---



# [Go](https://zed.dev/docs/languages/go.html#go)
...
## [Setup](https://zed.dev/docs/languages/go.html#setup)
...
## [Inlay Hints](https://zed.dev/docs/languages/go.html#inlay-hints)
...
## [Debugging](https://zed.dev/docs/languages/go.html#debugging)

Zed supports zero-configuration debugging of Go tests and entry points (`func main`) using Delve. Run `debugger: start` (`f4|f4`) to see a contextual list of these preconfigured debug tasks.
...
### [Debug Go Packages](https://zed.dev/docs/languages/go.html#debug-go-packages)
...
### [Debug Go Tests](https://zed.dev/docs/languages/go.html#debug-go-tests)
...
### [Build and debug separately](https://zed.dev/docs/languages/go.html#build-and-debug-separately)
...
### [Attaching to an existing instance of Delve](https://zed.dev/docs/languages/go.html#attaching-to-an-existing-instance-of-delve)
