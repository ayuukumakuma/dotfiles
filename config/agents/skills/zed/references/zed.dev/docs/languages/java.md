---
title: "Java | Java"
source_url: "https://zed.dev/docs/languages/java"
...
## [Install OpenJDK](https://zed.dev/docs/languages/java.html#install-openjdk)
...
## [Extension Install](https://zed.dev/docs/languages/java.html#extension-install)

You can install by opening `zed: extensions`(`cmd-shift-x|ctrl-shift-x`) and searching for `java`.

## [Quick start and configuration](https://zed.dev/docs/languages/java.html#quick-start-and-configuration)
...
## [Debugging](https://zed.dev/docs/languages/java.html#debugging)

Debug support is enabled via our [Fork of Java Debug](https://github.com/zed-industries/java-debug), which the extension will automatically download and start for you. Please refer to the [Debugger Documentation](https://zed.dev/docs/debugger.html#getting-started) for general information about how debugging works in Zed.
...
## [Launch Scripts (aka Tasks) in Windows](https://zed.dev/docs/languages/java.html#launch-scripts-aka-tasks-in-windows)
...
There is a fairly straightforward fix that you can apply to make it work on Windows by supplying your own task scripts. Please see [this Issue](https://github.com/zed-extensions/java/issues/94) for information on how to do that and read the [Tasks section in Zeds documentation](https://zed.dev/docs/tasks.html) for more information.

## [Advanced Configuration/JDTLS initialization Options](https://zed.dev/docs/languages/java.html#advanced-configurationjdtls-initialization-options)
...
## [See also](https://zed.dev/docs/languages/java.html#see-also)
